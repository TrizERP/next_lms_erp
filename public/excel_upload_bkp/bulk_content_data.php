        ...
        foreach ($dataArr as $key => $value) {
            ...
            if ($chapter_id == '') {
                ...
                if ( $find_chapter_id ) {
                    ...
                    $query = "INSERT INTO chapter_master (syear, sub_institute_id, grade_id, standard_id, subject_id, chapter_name, availability, show_hide, created_by) 
                    VALUES ( '" . $_REQUEST['syear'] . "', '" . $_REQUEST['sub_institute_id'] . "', '" . mysqli_real_escape_string($cn, $value['grade_id']) . "', '" . $value['standard_id'] . "', '" . mysqli_real_escape_string($cn, $value['subject_id']) . "', '" . mysqli_real_escape_string($cn, $value['chapter']) . "','1','1','" . $_REQUEST['user_id'] . "' );";
            ...
            $contentQuery = "INSERT INTO content_master ( grade_id, standard_id, subject_id, chapter_id, title, file_folder, filename, file_type, file_size, url,content_category,show_hide,syear,sub_institute_id,created_by) VALUES ( '" . mysqli_real_escape_string($cn, $value['grade_id']) . "', '" . mysqli_real_escape_string($cn, $value['standard_id']) . "', '" . mysqli_real_escape_string($cn, $value['subject_id']) . "', '" . $chapter_id . "', '" . mysqli_real_escape_string($cn, $value['title']) . "', '" . mysqli_real_escape_string($cn, $value['file_folder']) . "', '" . mysqli_real_escape_string($cn, $value['filename']) . "', '" . mysqli_real_escape_string($cn, $value['file_type']) . "', '" . mysqli_real_escape_string($cn, $value['file_size']) . "', '" . mysqli_real_escape_string($cn, $value['url']) . "', '" . mysqli_real_escape_string($cn, $value['content_category']) . "','1','" . $_REQUEST['syear'] . "', '" . $_REQUEST['sub_institute_id'] . "','" . $_REQUEST['user_id'] . "')";
            ...
            if ( $contentInsert ) {
                ...
                $problematic_reocords .= "title -  " . $value['title'] . "<br><br>";
            }
        }
