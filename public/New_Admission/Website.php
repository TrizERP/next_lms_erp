    ...
    $table = "<CENTER>
        <table width='80%'>
            <tr>
                ...
                <td>
            <center><span style='font-size: 50px;font-weight: bold;'>Muljibhai Mehta International School</br></span>
                <span>Gokul Township, Agashi Road, Bolinj, Virar (W)</br></span>
                <span style='font-size: 20px;font-weight: bold;'>(ONLINE ADMISSION FOR A.Y. 2021-2022)</span></center>
            </td>
            </tr>
        </table>
    </CENTER>";
    ...
    $table .= "<center>
        <table width='80%'>
            <tr>
                <td>
                    <br>
                      <span style='font-size: 16px;font-weight: bold;border-bottom: 1px solid;'>Age Criteria: as on 31st December 2021</span><br>   <br><br>
...
<ul style='padding-left:15px;'>             
                  ...
                  <li>Selected aspirants will be provided with the further details of Online Admission Procedure through Email.<br> </li>
                  <li> <b>Right to admission is reserved with the school management.</b></li>
                  </ul>
                       </table>";
    $table .= "</center>";
    echo $table;
