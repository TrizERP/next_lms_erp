...
?>
                    ...
                    <div class="contact100-form" style="padding-top: 0px !important;">
                        <table style="border-collapse: collapse;" width="100%" border="1"> 
                            <tbody>
                                ...
                                <tr>     
                                    <td>Token No.</td>     
                                    <td><?php echo $_REQUEST['token_no']; ?></td> 
                                </tr> 
                                <tr>     
                                    <td>Standard</td>     
                                    <td><?php echo $std; ?></td> 
            ...
            ?>    
                 <center>
                    <button style='background:#2E55A9;border: none !important;color:#FFFFFF;font-size: 13px;font-weight: bold;padding: 7px 15px;margin: 10px;' onclick="printthis();">
                       Print
                    </button>
                </center>
            <?php 
...
.contact100-form-title table tr td {
  padding: 0 15px;
}
...
.contact100-form table {
  border: 2px solid #f4f4f4;
}

.contact100-form table td {
  padding: 15px 20px;
...
ul.validate-form-list li label {
  width: 40%;
  text-align: left;
}

ul.validate-form-list li .wrap-input100 {
  margin: 10px 20px;
}

ul.validate-form-list li center {
  margin-bottom: 20px;
}
...
.validate-input-checkbox input{
  margin-right: 5px;
}

.validate-input-checkbox label{
  font-weight: bold;
  margin-bottom: 0;
}
...
.contact100-form-btn {
  ...
  border-radius: 21px;
  background: #27a5ef;
  box-shadow: 0 10px 30px 0px rgb(39 165 239 / 50%);
  -moz-box-shadow: 0 10px 30px 0px rgb(39 165 239 / 50%);
  -webkit-box-shadow: 0 10px 30px 0px rgb(39 165 239 / 50%);
  -o-box-shadow: 0 10px 30px 0px rgb(39 165 239 / 50%);
  -ms-box-shadow: 0 10px 30px 0px rgb(39 165 239 / 50%);
  -webkit-transition: all 0.4s;
  -o-transition: all 0.4s;
  -moz-transition: all 0.4s;
  transition: all 0.4s;
...
.alert-validate::before {
  ...
  width: calc(100% + 2px);
  height: calc(100% + 2px);
  background-color: rgb(228 60 60 / 10%);
  border: 0px solid #fa4251;
  border-radius: 25px;
  top: -1px;
  left: -1px;
  pointer-events: none;
