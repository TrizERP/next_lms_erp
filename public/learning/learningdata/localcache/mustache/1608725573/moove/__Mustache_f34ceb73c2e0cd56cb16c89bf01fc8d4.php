...
class __Mustache_f34ceb73c2e0cd56cb16c89bf01fc8d4 extends Mustache_Template
{
...
';
        ...
        $buffer .= '</p>© Copyright The Bright College. All Rights Reserved
';
...
';
        $buffer .= $indent . '          <p>© Copyright <a href="https://thebrightcollege.com.au">The Bright College</a>. All Rights Reserved</p>
';
        $buffer .= $indent . '      </div>
';
        $buffer .= $indent . '  </div>
