...
//echo SENAYAN_WEB_ROOT_DIR.'admin/'.MODULES_DIR.'/';die;
// item status rules
...
if($it=="it"){
    $_REQUEST['db_host'] = $db_host;
    $_REQUEST['db_user'] = $db_user;
    $_REQUEST['db_password'] = $db_password;
    $_REQUEST['solution_db'] = $solution_db;
    $_REQUEST['USER_GROUP_ID'] = $USER_GROUP_ID;
    $_REQUEST['school_name'] = $school_name;
    $_REQUEST['USER_GROUP_ID'] = $USER_GROUP_ID;
    $_REQUEST['dyear'] = $dyear;
    $_REQUEST['SUB_INSTITUTE_ID'] = $SUB_INSTITUTE_ID;
    $_SESSION['host'] = $db_host;
    $_SESSION['user_name'] = $db_user;
    $_SESSION['passwd'] = $db_password;
    $_SESSION['library_database'] = $db_library;
    $_SESSION['inte_schema'] = $solution_db;
    $_SESSION['USER_GROUP_ID'] = $USER_GROUP_ID;
    $_SESSION['school_name'] = $school_name;
    $_SESSION['school_logo'] = $school_logo;
    $_SESSION['dyear'] = $dyear;
    $_SESSION['SUB_INSTITUTE_ID'] = $SUB_INSTITUTE_ID;
    $host = $db_host;
    $library_database = $db_library;
    $user_name = $db_user;
    $passwd = $db_password;
}else if(isset($_REQUEST['NEW_ERP']) && $_REQUEST['NEW_ERP'] == 1){
    $host = $_REQUEST['db_host'];
    $user_name = $_REQUEST['db_user'];
    $passwd = $_REQUEST['db_password'];
    $library_database = $_REQUEST['db_library'];
    $inte_schema = $_REQUEST['solution_db'];
    ...
    $_SESSION['library_database'] = $library_database;
    $_SESSION['inte_schema'] = $inte_schema;
    $_SESSION['USER_GROUP_ID'] = $USER_GROUP_ID;
    $_SESSION['school_name'] = $school_name;
    $_SESSION['school_logo'] = $school_logo;
    $_SESSION['dyear'] = $dyear;
    ...
    // include_once("$_SERVER[DOCUMENT_ROOT]/$strArray[1]/data.php");
    $host = $_SESSION['host'];
    $user_name = $_SESSION['user_name'];
    $passwd = $_SESSION['passwd'];
    $library_database = $_SESSION['library_database'];
            ...
            $user_data = mysqli_query($sql);
              ...
              if($_REQUEST[hid_frm_clg_wise_dbs_val]==""){
                  echo "<style>
                       ...
                       ";
                  echo "<form name=frm_clg_wise_dbs>";
...
// echo '<pre> library_database '; print_r($library_database);
// echo '<pre> user_name '; print_r($user_name);
// echo '<pre> passwd '; print_r($passwd);
// echo '<pre><pre><pre>';

// echo '<pre> DB_HOST '; print_r(DB_HOST);
// echo '<pre> DB_USERNAME '; print_r(DB_USERNAME);
// echo '<pre> DB_PASSWORD '; print_r(DB_PASSWORD);
...
//$path="http://trizapps.in/schoollib";
//$path="http://$server_id/$apps_name/Products/library/admin";
...
/* CIRCULATION RELATED */
//comment by iresh on 12/1/2011 $sysconf['circulation_receipt'] = false;
/*added by iresh on 12/1/2011 */$sysconf['circulation_receipt'] = true;
...
if ($sysconf['max_upload'] > $post_max_size) {
 //echo  $sysconf['max_upload'] = $post_max_size-1024;
   $sysconf['max_upload'] = $post_max_size;
...
$sysconf['currencies'] = array( array('Ruppee', 'Ruppee'));
...
$sysconf['page_footer'] = ' <strong>Triz Library Automation</strong>';
...
//////////////// added by iresh on 7-5-2011 for global define material resource type ////////////////////////////////////////
$virtual=$dbs->query('SELECT material_resource_id,material_resource_name FROM mst_material_resource_type');
$virtual_name='';
...
$port="465";
$username="pujas985@gmail.com";
$password="pujas985.";
$to_="pujas985@gmail.com";
$toname="Pooja Adani";
/**
 * UCS global settings
 */
//comment by iresh on 12/1/2011 $sysconf['ucs']['enable'] = false;

/*added by iresh on 12/1/2011 */ $sysconf['ucs']['enable'] = false;
// auto delete same record on UCS?

$sysconf['ucs']['auto_delete'] = true;
// auto insert new record to UCS?
//comment by iresh on 12/1/2011$sysconf['ucs']['auto_insert'] = false;

/*added by iresh on 12/1/2011 */$sysconf['ucs']['auto_insert'] = false;
