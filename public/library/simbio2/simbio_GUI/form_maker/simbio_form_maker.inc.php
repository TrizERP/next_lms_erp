...
class simbio_form_maker
{
    ...
    public function addTextField1($str_elmnt_type,$str_elmnt_name, $str_elmnt_label, $str_elmnt_value = '', $str_elmnt_attr = '', $str_elmnt_info = '')
    {
        // create instance
        $_form_element = new simbio_fe_text();
        $_form_element1 = new simbio_fe_text();
        // set form element object properties
        $_form_element->element_type = $str_elmnt_type;
        $_form_element->element_name = $str_elmnt_name;
        $_form_element->element_value = $str_elmnt_value;
        ...
        $str_elmnt_name1="name2";
        $str_elmnt_type1="text";
        $str_elmnt_attr1="";
        
        $_form_element1->element_type = $str_elmnt_type1;
        $_form_element1->element_name = $str_elmnt_name1;
        $_form_element1->element_value = $str_elmnt_value1;
        $_form_element1->element_attr = $str_elmnt_attr1;
        
      
        $this->elements[$str_elmnt_name] = array('label' => $str_elmnt_label, 'element' => $_form_element, 'info' => $str_elmnt_info);
        $this->elements[$str_elmnt_name1] = array('element' => $_form_element1);
        //echo "<pre>";
       // print_r($this->elements[$str_elmnt_name]);
        //echo "<pre>";die;
        
                                                       
    }
    
    public function addTextField2($str_elmnt_type,$str_elmnt_name, $str_elmnt_label, $str_elmnt_value = '', $str_elmnt_attr = '', $str_elmnt_info = '')
    {
        // create instance
        $_form_element = new simbio_fe_text();
        // set form element object properties
        ...
        //$_form_element->element_attr = $str_elmnt_attr;
        $this->elements[$str_elmnt_name] = array('label' => $str_elmnt_label, 'element' => $_form_element, 'info' => $str_elmnt_info);                        
      //  $this->elements[$str_elmnt_name1] = array('element' => $_form_element, 'info' => $str_elmnt_info);
                                                       
    }
 public function addTextManualField($str_elmnt_type,$str_elmnt_name, $str_elmnt_label, $str_elmnt_value = '', $str_elmnt_attr = '', $str_elmnt_info = '')
    {
        // create instance
    
   $this->elements[$str_elmnt_name]="     <tr>
<td class='alterCell' width='20%' valign='top' style='font-weight: bold;'>Member Name*</td>
<td class='alterCell' width='1%' valign='top' style='font-weight: bold;'>:</td>
<td class='alterCell2'><input id='memberName' type='text' onchange='return checkspecialcharacterdynamic(this.name);' style='width: 100%;' value='' name='memberName'/></td><td><input id='memberName' type='text'  onchange='return checkspecialcharacterdynamic(this.name);' style='width: 100%;' value='' name='memberName'/></td></tr>";
