...
class simbio_form_table extends simbio_form_maker
{
    ...
    public $reset_button_attr = 'name="reset" value="Reset Data"';
...
//    public $submit_button_attr = true;
//    public $reset_button_attr = true;
    ...
    public function printOut()
    {
        ...
        $_buttons = '';
        if ($this->with_form_tag) {
            $_buttons = '<table cellspacing="0" cellpadding="3" style="width: 100%; background-color: #105986;">'
