...
class simbio_datagrid extends simbio_table
{
     ...
     * @return  string
     */
    public function createDataGrid_temp($obj_db, $str_db_table = '', $int_num2show = 30, $bool_editable = false)
    {               
...
/*        if (!isset($this->$view_property)) 
        ...
        {
           die('Resource Type not specified yet');
        }
        ...
        if ($this->editable) 
        {
            ...
            if ($this->editable) {
                ...
                if ($this->edit_property) {
                    $_edit_data = $this->edit_property[0].'='.$this->grid_result_rows[$_row][0].'&detail=true&virtual=virtual';
...
//echo $_sql_str;die;
    ...
    {               
        /*echo "obj_db=".$str_db_table;
		print_r($str_db_table);
		die();*/
...
/////////////////////////////////////////iresh add function on 19-2-2011///////////////////////////////////////////////////////////////////////
 ...
 public function createDataGrid1($obj_db, $str_db_table = '', $int_num2show = 30, $bool_editable = false)
    {
      ...
      //  if (!isset($this->edit_property)) $this->edit_property = array('itemID', __('EDIT'));
        ...
        if (empty($this->sql_table)) {
            die('Report Type not specified yet');
        }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    protected function makeOutput($int_num2show = 30)
    {
	    ...
	    $_uncheck_all = __('Uncheck All');
            ...
            if ($this->chbox_property) 
            {
				...
				// print_r($_REQUEST);
				if($this->chbox_form_URL == '/mmiserp/Products/library/admin/modules/circulation/quick_return.php'){
					$_button_grp .= '<td><input type="button" onclick="chboxFormSubmit(\''.$this->table_name.'\', \''.$this->chbox_confirm_msg.'\')" value="Return" class="button" /> '
           ...
           /* $_button_grp .= '<td><input type="button" onclick="chboxFormSubmit(\''.$this->table_name.'\', \''.$this->chbox_confirm_msg.'\')" value="'.$this->chbox_action_button.'" class="button" /> '
            ...
            $_button_grp = '';
            if ($_paging) {
                $_button_grp .= '<table cellspacing="0" cellpadding="5" class="notprinted" style="background-color: #fff; width: 100%;">'
    ...
    /////TEMPORAY CODE
     ...
     public function createDataGrid_Custom($gmd_main,$obj_db, $str_db_table = '', $int_num2show = 30, $bool_editable = false)
    {                        
...
//echo $_sql_str;die;
        ...
        // return the formatted output
        return $this->makeOutput_custom($gmd_main,$int_num2show);
    }
    ...
    protected function makeOutput_custom($gmd_main,$int_num2show = 30)
    {
	    ...
	    $_uncheck_all = __('Uncheck All');
            ...
            $_button_grp .= '<td><input type="button" onclick="chboxFormSubmit(\''.$this->table_name.'\', \''.$this->chbox_confirm_msg.'\')" value="'.$this->chbox_action_button.'" class="button" /> '
                    .'<input type="button" onclick="checkAll(\''.$this->table_name.'\', false)" value="'.$_check_all.'" class="button" /> '
//Added Commented By Parth 8/7/2011
                   /* .'<input type="button" onclick="checkAll(\''.$this->table_name.'\', true)" value="'.$_uncheck_all.'" class="button" /> '*/
//Ended Comment By Parth 8/7/2011
                    .'</td>';
            }
            ...
            $_buffer .= $_button_grp.$this->printTable_custom($gmd_main).$_button_grp;
        }
