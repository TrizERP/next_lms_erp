...
<table width=100% align=left border=0 cellspacing=0 id="mainForm">
	<tr valign=top>
		...
		<tr valign=top>
			<td>
			<ul><li>Catelog(7)<ul>
				<li><a href=<?php echo MODULES_WEB_ROOT_DIR.'bibliography/index.php'; ?>>Book</a></li>
				<li><a href=<?php echo MODULES_WEB_ROOT_DIR.'bibliography/item.php'; ?>>Item</a></li>
				<li><a href=<?php echo MODULES_WEB_ROOT_DIR.'bibliography/z3950.php'; ?>>Z3950 Service</a></li>
				<li><a href=<?php echo MODULES_WEB_ROOT_DIR.'bibliography/upld_marc.php'; ?>>Import MRC File</a></li>
				<li><a href=<?php echo MODULES_WEB_ROOT_DIR.'bibliography/dl_print.php'; ?>>Print</a></li>
			...
			<ul><li>Member Area(2)<ul>
				...
				<li><a href=<?php echo MODULES_WEB_ROOT_DIR.'membership/member_card_generator.php'; ?>>Tools</a></li>						
                         ...
                         <td> 
			<ul><li>Master File(12)<ul>
				<li><a href=<?php echo MODULES_WEB_ROOT_DIR.'master_file/material_resource_type.php'; ?>>Add New Material Resource Type</a></li>
				<li><a href=<?php echo MODULES_WEB_ROOT_DIR.'master_file/publisher.php'; ?>>Add Publisher</a></li>						
				<li><a href=<?php echo MODULES_WEB_ROOT_DIR.'master_file/supplier.php'; ?>>Add Supplier</a></li>
				<li><a href=<?php echo MODULES_WEB_ROOT_DIR.'master_file/author.php'; ?>>Add Author</a></li>				
				<li><a href=<?php echo MODULES_WEB_ROOT_DIR.'master_file/subject_type.php'; ?>>Add Subject</a></li>				
				<li><a href=<?php echo MODULES_WEB_ROOT_DIR.'master_file/standard.php'; ?>>Add Standard/Class</a></li>				
				<li><a href=<?php echo MODULES_WEB_ROOT_DIR.'master_file/location.php'; ?>>Add Book Rack/Shelf</a></li>				
				...
				<li><a href=<?php echo MODULES_WEB_ROOT_DIR.'master_file/label.php'; ?>>Add Label</a></li>				
				<li><a href=<?php echo MODULES_WEB_ROOT_DIR.'master_file/url.php'; ?>>URL check</a></li>									
			</ul></li></ul>
                         </td>
                         <td>
			...
			<ul><li>System(10)<ul>
 			...
 			<td>
			<ul><li>Reporting(19)<ul>
				<li><a href=<?php echo MODULES_WEB_ROOT_DIR.'reporting/index.php'; ?>>Collection Statistic</a></li>
				<li><a href=<?php echo MODULES_WEB_ROOT_DIR.'reporting/loan_report.php'; ?>>Loan Report</a></li>						
