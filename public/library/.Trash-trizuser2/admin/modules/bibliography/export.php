...
<tr>
	<td class="tab_menu_top">
                            <ul class="tabs"> 
				<li>
<a href="<?php echo MODULES_WEB_ROOT_DIR; ?>bibliography/export.php" class="headerText2"><?php echo __('Export Data'); ?></a> </li><li> <a href="<?php echo  MODULES_WEB_ROOT_DIR; ?>bibliography/item_export.php" class="headerText2"><?php echo __('Export Item'); ?></a> </li>
				</ul>
	</td>
</tr>
</table>
