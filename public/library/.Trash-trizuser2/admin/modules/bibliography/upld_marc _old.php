...
while ($gmd_d = $gmd_q->fetch_row()) //while ($gmd_d = $gmd_q->fetch_assoc())
{
...
$ajax = "ajaxFillSelect('" . SENAYAN_WEB_ROOT_DIR . "admin/AJAX_material_type_handler.php', 'mst_gmd', 'gmd_id:gmd_name:material_resource_id', 'gmdID', $('materialresourceid').getValue())";
