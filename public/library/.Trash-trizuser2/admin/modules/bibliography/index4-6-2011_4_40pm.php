...
$sql_gmd="SELECT gmd_code FROM mst_gmd WHERE gmd_id='".$rec_d['gmd_id']."'";
	     $sql_gmd=$dbs->query($sql_gmd);
	     $sql_gmd_type=$sql_gmd->fetch_assoc(); 
 if($sql_gmd_type['gmd_code']=='4')
    {
?>
...
<div class="menuBoxInner biblioIcon">
    ...
    &nbsp; <a href="<?php echo MODULES_WEB_ROOT_DIR; ?>bibliography/virtual_resources.php" class="headerText2"><?php echo __('Virtual Resources List'); ?></a>
    <?php
    // enable UCS?
    if ($sysconf['ucs']['enable']) {
    ?>
...
<fieldset class="menuBox">
<div class="menuBoxInner biblioIcon">
    <?php echo strtoupper(__('Book')); ?> - <a href="<?php echo MODULES_WEB_ROOT_DIR; ?>bibliography/index.php?action=detail" class="headerText2"><?php echo __('Add New Book'); ?></a>
    &nbsp; <a href="<?php echo MODULES_WEB_ROOT_DIR; ?>bibliography/index.php" class="headerText2"><?php echo __('Book List'); ?></a>
    <?php
    // enable UCS?
    if ($sysconf['ucs']['enable']) {
    ?>
...
//print_r($_REQUEST);
   ...
   if (!($can_read AND $can_write)) {
    ...
    // try query
    $itemID = (integer)isset($_POST['itemID'])?$_POST['itemID']:0;
 $_sql_rec_q = sprintf('SELECT b.*, p.publisher_name, pl.place_name,mst.material_sub_name,g.gmd_name FROM biblio AS b
        LEFT JOIN mst_publisher AS p ON b.publisher_id=p.publisher_id
        LEFT JOIN mst_place AS pl ON b.publish_place_id=pl.place_id
  ...
  //  $form->addSelectList('gmdID', __('Material Type'), $gmd_options, $rec_d['gmd_id']);
...
$str_input .= '&nbsp;';
$str_input .= simbio_form_element::selectList('materialsubid', $mst_material_sub_type_options, '', 'style="width: 50%;"');
...
//$str_input .= simbio_form_element::textField('text', 'material_sub_search_str', $rec_d['publisher_name'], 'style="width: 45%;" onkeyup="'.$ajax_exp.'"');
$str_input = simbio_form_element::selectList('gmdID', $gmd_options, $rec_d['gmd_id'],'onchange="'.$ajax_exp.'"');
$str_input .= '&nbsp;';
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    if (isset($_GET['keywords']) AND $_GET['keywords']) {
        ...
        $searchable_fields = array('title', 'author', 'subject', 'isbn', 'publisher','barcode');
