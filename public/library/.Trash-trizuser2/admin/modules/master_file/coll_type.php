...
if (isset($_POST['detail']) OR (isset($_GET['action']) AND $_GET['action'] == 'detail')) {
  ...
  /*added by iresh on 25-1-2011*/  $form->addTextField('text', 'collTypeName', __('Collection Type').'*', $rec_d['coll_type_name'], 'style="width: 140px;" onkeyup="return checkspecialcharacterdynamic(this.name);"');
