...
if (isset($_POST['detail']) OR (isset($_GET['action']) AND $_GET['action'] == 'detail')) {
    ...
    $rec_q = $dbs->query('SELECT st.subject_type_id,st.subject_type_name,t.topic_id,t.topic 
  ...
  /*added by iresh on 25-1-2011 */$form->addTextField('text', 'subject', __('Subject').'*', $rec_d['subject_type_name'], 'style="width: 140;"');
    // subject type
