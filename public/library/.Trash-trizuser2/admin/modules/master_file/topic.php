...
if (isset($_POST['detail']) OR (isset($_GET['action']) AND $_GET['action'] == 'detail')) {
  ...
  /*added by iresh on 25-1-2011 */$form->addTextField('text', 'topic', __('Subject').'*', $rec_d['topic'], 'style="width: 140;" onkeyup="return checkspecialcharacterdynamic(this.name);"');
    // subject type
  ...
  //  $form->addSelectList('subjectType', __('Subject Type'), $subj_type_options, $rec_d['topic_type']);
   ...
   //comment by iresh on 25-1-2011 $form->addTextField('text', 'authList', __('Authority Files'), $rec_d['auth_list'], 'style="width: 30%;"');
    /*added by iresh on 25-1-2011 */$form->addTextField('text', 'authList', __('Authority Files'), $rec_d['auth_list'], 'style="width: 140px;"');
