...
if (isset($_POST['detail']) OR (isset($_GET['action']) AND $_GET['action'] == 'detail')) {
  ...
  /*added by iresh on 25-1-2011*/  $form->addTextField('text', 'itemStatusID', __('Item Status Code').'*', $rec_d['item_status_id'], 'style="width: 140px;" maxlength="3" onkeyup="return checkspecialcharacterdynamic(this.name);"');
   ...
   /*added by iresh on 25-1-2011*/  $form->addTextField('text', 'itemStatus', __('Item Status Name').'*', $rec_d['item_status_name'], 'style="width: 140px;" onkeyup="return checkspecialcharacterdynamic(this.name);"');
    // item status rules
	$rules = array();
	if ($rec_d['no_loan']) {
