...
//added by Parth 8/7/2011
	...
	if($checkflag==1)
	{
		...
		while($rownew = $rec_name->fetch_assoc())
		{
		 ...
		 utility::jsAlert(__('You can not Delete publisher Type '.$publisher_name_set));
	}
	else
	{
...
if (isset($_POST['detail']) OR (isset($_GET['action']) AND $_GET['action'] == 'detail')) {
   ...
   /*added by iresh on 25-1-2011*/ $form->addTextField('text', 'publisherName', __('Publisher Name').'*', $rec_d['publisher_name'], 'style="width: 140px;"');
