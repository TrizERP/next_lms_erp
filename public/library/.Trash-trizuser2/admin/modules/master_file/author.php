...
$checkflag = 0;
	...
	if($checkflag==1)
	{
		...
		while($rownew = $rec_name->fetch_assoc())
		{
		 ...
		 utility::jsAlert(__('You can not Delete Material Type '.$author_name_set));
	}
	else
	{
...
$visibility = 'makeVisible';
    ...
    /* added by iresh on 25-1-2011 added by Parth on 8/7/2011*/$form->addTextField('text', 'authorName', __('Author Name').'*', $rec_d['author_name'], 'style="width: 140px;" onkeyup="return checkspecialcharacterdynamic(this.name);"');
    // authority type
...
//echo $auth_type;
   ...
   /* added by iresh on 25-1-2011*/ $form->addTextField('text', 'authList', __('Authority Files'), $rec_d['auth_list'], 'style="width: 140px;" onkeyup="return checkspecialcharacterdynamic(this.name);"');
