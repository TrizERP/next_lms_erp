...
$form->addSelectList('gmdCode', __('Material Resource Type').'*',$sql_material_resource, $rec_d['material_resource_id'], 'style="width: 140px;" maxlength="30"');
    ...
    /*added by iresh on 25-1-2011 added by parth 8/7/2011*/$form->addTextField('text', 'gmdName', __('Material Type').'*', $rec_d['gmd_name'], 'style="width: 140px;" onkeydown="javascript:return checkspecialcharacter();"');
?>
<?php
