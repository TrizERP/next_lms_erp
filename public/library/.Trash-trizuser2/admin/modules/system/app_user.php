...
{
$bradecum .= '<a href='.MODULES_WEB_ROOT_DIR.'system/app_user.php?changecurrent=true&action=detail class="headerText2">Change User Profile</a>';
}
else
{
$bradecum .= '<a href='.MODULES_WEB_ROOT_DIR.'system/app_user.php class="headerText2">System User</a>';
}
//$bradecum .= '<a href='.MODULES_WEB_ROOT_DIR.'system/app_user.php?action=detail class="headerText2">Change User Profile</a>';
echo $bradecum;
        ?>	
	</td>
</tr>
</table>
<?php if (!$changecurrent) {
/* search form */
