...
echo $bradecum;
    ...
    <div id="filterForm">
        ...
        <div class="divRow">
            ...
            <div class="divRowContent">
            <?php 
             //comment by iresh on 25-1-2011  echo simbio_form_element::textField('text', 'author', '', 'style="width: 50%"'); 
           /*added by iresh on 25-1-2011*/ echo simbio_form_element::textField('text', 'author', '', 'style="width: 140px"'); 
            ?>
            </div>
        </div>
        <div class="divRow">
        ...
        <div class="divRow">
          <!--comment by iresh on 25-1-2011  <div class="divRowLabel"><?php echo __('GMD'); ?></div>-->
          <!--added by iresh on 25-1-2011 -->  <div class="divRowLabel"><?php echo __('Material Type'); ?></div>
            <div class="divRowContent">
            <?php
