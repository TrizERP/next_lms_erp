...
$report_d .= '<br/><iframe src='.MODULES_WEB_ROOT_DIR.'reporting/charts_report.php?chart=total_member_by_type height=539px width=800px frameborder=0></iframe>';
...
$bradecum .= '<a href='.MODULES_WEB_ROOT_DIR.'reporting/member_report.php class="headerText2">Membership Report</a>';
echo $bradecum;
        ?>	
	</td>
</tr>
