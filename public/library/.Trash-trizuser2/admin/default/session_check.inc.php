...
if ($unauthorized) {
   ...
   //coment by iresh on 7-2-2011 $msg .= 'top.location.href = \''.SENAYAN_WEB_ROOT_DIR.'index.php?p=login\';'."\n";
  /*added by iresh on 7-2-2011*/   $msg .= 'top.location.href = \''.SENAYAN_WEB_ROOT_DIR.'index.php\';'."\n";
    $msg .= '</script>'."\n";
