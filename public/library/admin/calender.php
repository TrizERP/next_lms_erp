...
?>
<!--right here-->
<?php /*<td width="8px" <?php echo hiLightEvt($month,$i,$year);?>><!--<a href="<?=$_SERVER['PHP_SELF'] . '?month='. $month . '&day=' . $i . '&year=' . $year;?>&v=1">--><a href="JavaScript:newPopup('calForm.php?month=<?=$month . '&day=' . $i . '&year=' . $year;?>&v=1');" style="text-decoration:none;"><?=$i;?></a></td> */?>
