...
if (isset($_POST['keywords']) AND !empty($_POST['keywords'])) 
{
   ...
   $itemID = $dbs->escape_string(urldecode(trim($_POST['keywords'])));
}
else
{
    $keywords = '';
...
if($_POST['keywords']==132 || $_POST['keywords']==131 || $_POST['keywords']==133)
{ 
          ...
          /*  if($rec_d['biblio_id']=='')         
                {*/
                    ...
                    if (isset($result['biblio_id']) || !empty ($result['biblio_id']))                      
                        $rec_d['biblio_id'] = $result['biblio_id']+1;
                    else
                        $rec_d['biblio_id']=1;
					
					$_SESSION['resource_type'] = $_POST['keywords'];
					
					$str_input = '<div class="'.$visibility.'"><a class="notAJAX" href="javascript: openHTMLpop(\''.MODULES_WEB_ROOT_DIR.'bibliography/pop_item.php?inPopUp=true&action=detail&resoure_type='.$_POST['keywords'].'&biblioID='.$rec_d['biblio_id'].'\', 650, 400, \''.__('Items/Copies1').'\')">'.__('Add New Items').'</a></div>';
...
//biblio subtitle
if($_POST['keywords']==130 || $_POST['keywords']==112 || $_POST['keywords']==113 || $_POST['keywords']==116 || $_POST['keywords']==117 || $_POST['keywords']==88 || $_POST['keywords']==84 || $_POST['keywords']==85 || $_POST['keywords']==87  || $_POST['keywords']==115)
{ 
 $form->addTextField('text', 'subTitle', __('Sub Title'), '' , 'rows="1" style="width: 100%;"');
}
if($_POST['keywords']==130 || $_POST['keywords']==112 || $_POST['keywords']==113 || $_POST['keywords']==114  || $_POST['keywords']==117 || $_POST['keywords']==77 || $_POST['keywords']==79 || $_POST['keywords']==80 || $_POST['keywords']==81 || $_POST['keywords']==82 || $_POST['keywords']==83 || $_POST['keywords']==88 || $_POST['keywords']==115)
{
   // biblio series title
...
{
   // biblio series title
    $form->addTextField('text', 'editorName', __('Editor'), '' , 'rows="1" style="width: 50%;"');
}
if($_POST['keywords']==130 || $_POST['keywords']==112 || $_POST['keywords']==113 || $_POST['keywords']==88 || $_POST['keywords']==84 || $_POST['keywords']==85 || $_POST['keywords']==87)
{
  // biblio edition
    $form->addTextField('text', 'edition', __('Edition'), '' , 'style="width: 40%;"');
}
if($_POST['keywords']==130 || $_POST['keywords']==112 || $_POST['keywords']==113 || $_POST['keywords']==114 || $_POST['keywords']==115 || $_POST['keywords']==116 || $_POST['keywords']==117 || $_POST['keywords']==118 || $_POST['keywords']==77 || $_POST['keywords']==79 || $_POST['keywords']==80 || $_POST['keywords']==81 || $_POST['keywords']==82 || $_POST['keywords']==83 || $_POST['keywords']==84 || $_POST['keywords']==85 || $_POST['keywords']==86 || $_POST['keywords']==87 || $_POST['keywords']==89 || $_POST['keywords']==90 || $_POST['keywords']==91 || $_POST['keywords']==92 || $_POST['keywords']==93 || $_POST['keywords']==94 || $_POST['keywords']==95 || $_POST['keywords']==96 || $_POST['keywords']==88 || $_POST['keywords']==97 || $_POST['keywords']==98 || $_POST['keywords']==99 || $_POST['keywords']==100 || $_POST['keywords']==101 || $_POST['keywords']==102 || $_POST['keywords']==104 || $_POST['keywords']==105 || $_POST['keywords']==106 || $_POST['keywords']==68 || $_POST['keywords']==69 || $_POST['keywords']==70 || $_POST['keywords']==71 || $_POST['keywords']==72 || $_POST['keywords']==73 || $_POST['keywords']==74 || $_POST['keywords']==75 || $_POST['keywords']==76)
{
       // biblio keywords
    $form->addTextField('text', 'tags', __('Volume No'), '' , 'style="width: 40%;"');
}
if($_POST['keywords']==130 || $_POST['keywords']==112 || $_POST['keywords']==113 || $_POST['keywords']==88)
{
    // biblio specific detail info/area
    $form->addTextField('textarea', 'specDetailInfo', __('Specific Detail Info'), '' , 'rows="2" style="width: 100%"');
}

if($_POST['keywords']==130 || $_POST['keywords']==112 || $_POST['keywords']==113 || $_POST['keywords']==116 || $_POST['keywords']==117 || $_POST['keywords']==77 || $_POST['keywords']==79 || $_POST['keywords']==80 || $_POST['keywords']==81 || $_POST['keywords']==82 || $_POST['keywords']==83 || $_POST['keywords']==88 || $_POST['keywords']==84 || $_POST['keywords']==85 || $_POST['keywords']==87 || $_POST['keywords']==115)
{
    ...
    //echo $_REQUEST['biblioID'];
          /*  if($rec_d['biblio_id']=='')         
                {*/
                    ...
                    if (isset($result['biblio_id']) || !empty ($result['biblio_id']))                      
						...
						<a class='notAJAX' onclick= javascript:window.open('".MODULES_WEB_ROOT_DIR."bibliography/pop_item.php?inPopUp=true&action=detail&biblioID=".$rec_d['biblio_id']."','mywin','left=20,top=20,width=500,height=700,toolbar=1,resizable=1'); >Add New Items</a>
						
									</div>";*/
						$str_input = '<div class="'.$visibility.'"><a class="notAJAX" href="javascript: openHTMLpop(\''.MODULES_WEB_ROOT_DIR.'bibliography/pop_item.php?inPopUp=true&action=detail&biblioID='.$rec_d['biblio_id'].'\', 600, 500, \''.__('Items/Copies').'\')">'.__('Add New Items').'</a></div>';			
        ...
        $str_input .= '<iframe name="topicIframe" id="topicIframe" class="borderAll" style="width: 100%; height: 80px;" src="'.MODULES_WEB_ROOT_DIR.'bibliography/iframe_topic.php?block=1"></iframe>';
    $form->addAnything(__('Subject(s)'), $str_input);
	
	        $str_input = '<div class="'.$visibility.'"><a class="notAJAX"  href="javascript: openHTMLpop(\''.MODULES_WEB_ROOT_DIR.'bibliography/pop_standard.php?biblioID='.$rec_d['biblio_id'].'\', 1000, 200, \''.__('Standard').'\')">'.__('Add Standard(s)').'</a></div>';
...
*/
if($_POST['keywords']==130 || $_POST['keywords']==112 || $_POST['keywords']==113 || $_POST['keywords']==114 || $_POST['keywords']==118 || $_POST['keywords']==77 || $_POST['keywords']==79 || $_POST['keywords']==80 || $_POST['keywords']==81 || $_POST['keywords']==82 || $_POST['keywords']==83 || $_POST['keywords']==88)
{
...
if($_POST['keywords']==130 || $_POST['keywords']==112 || $_POST['keywords']==113 || $_POST['keywords']==114 || $_POST['keywords']==117 || $_POST['keywords']==77 || $_POST['keywords']==79 || $_POST['keywords']==80 || $_POST['keywords']==81 || $_POST['keywords']==82 || $_POST['keywords']==83 || $_POST['keywords']==88 || $_POST['keywords']==84 || $_POST['keywords']==85 || $_POST['keywords']==87)
{
    // biblio ISBN/ISSN
...
if($_POST['keywords']==130 || $_POST['keywords']==112 || $_POST['keywords']==113  || $_POST['keywords']==116 || $_POST['keywords']==88 || $_POST['keywords']==84 || $_POST['keywords']==85 || $_POST['keywords']==87 || $_POST['keywords']==115)
{    
  // biblio classification
   $form->addTextField('text', 'class', __('Classification No.'), '' , 'style="width: 40%;"');
}
if($_POST['keywords']==130 || $_POST['keywords']==112 || $_POST['keywords']==113 || $_POST['keywords']==114 || $_POST['keywords']==116 || $_POST['keywords']==118 || $_POST['keywords']==77 || $_POST['keywords']==79 || $_POST['keywords']==80 || $_POST['keywords']==81 || $_POST['keywords']==82 || $_POST['keywords']==83 || $_POST['keywords']==88 || $_POST['keywords']==84 || $_POST['keywords']==85 || $_POST['keywords']==87)
{
		...
		$pub_q = $dbs->query("SELECT publisher_id, publisher_name FROM mst_publisher order by publisher_name");
        while ($pub_d = $pub_q->fetch_row()) 
        {
            $publ_options[] = array($pub_d[0], $pub_d[1]);
        }
...
if($_POST['keywords']==130 || $_POST['keywords']==112 || $_POST['keywords']==113 || $_POST['keywords']==116 || $_POST['keywords']==88 || $_POST['keywords']==84 || $_POST['keywords']==85 || $_POST['keywords']==87)
{
    // biblio publish year
    $form->addTextField('text', 'year', __('Publishing Year'), '' , 'style="width: 40%;"');
}
if($_POST['keywords']==130 || $_POST['keywords']==112 || $_POST['keywords']==113  || $_POST['keywords']==114 || $_POST['keywords']==116 || $_POST['keywords']==117 || $_POST['keywords']==77 || $_POST['keywords']==79 || $_POST['keywords']==80 || $_POST['keywords']==81 || $_POST['keywords']==82 || $_POST['keywords']==83 || $_POST['keywords']==88 || $_POST['keywords']==84 || $_POST['keywords']==85 || $_POST['keywords']==87)
{
    // biblio publish place
		...
		$pub_q = $dbs->query("SELECT place_id, place_name FROM mst_place");
        while ($pub_d = $pub_q->fetch_row()) 
        {
            $plc_options[] = array($pub_d[0], $pub_d[1]);
        }
...
if($_POST['keywords']==130 || $_POST['keywords']==112 || $_POST['keywords']==113 || $_POST['keywords']==114 || $_POST['keywords']==117 || $_POST['keywords']==118 || $_POST['keywords']==77 || $_POST['keywords']==79 || $_POST['keywords']==80 || $_POST['keywords']==81 || $_POST['keywords']==82 || $_POST['keywords']==83 || $_POST['keywords']==88 || $_POST['keywords']==84 || $_POST['keywords']==85 || $_POST['keywords']==87 || $_POST['keywords']==115)
{ 
    // biblio topics
          //$str_input = '<div class="'.$visibility.'"><a class="notAJAX"  href="javascript: openHTMLpop(\''.MODULES_WEB_ROOT_DIR.'bibliography/pop_topic.php\', 900, 200, \''.__('Subjects/Topics').'\')">'.__('Add Subject(s)').'</a></div>';
/*        $str_input = '<div class="'.$visibility.'"><a class="notAJAX"  href="javascript: openHTMLpop(\''.MODULES_WEB_ROOT_DIR.'bibliography/pop_topic.php?biblioID='.$rec_d['biblio_id'].'\', 900, 200, \''.__('Subjects/Topics').'\')">'.__('Add Subject(s)').'</a></div>';
        //$str_input .= '<iframe name="topicIframe" id="topicIframe" class="borderAll" style="width: 100%; height: 70px;" src="'.MODULES_WEB_ROOT_DIR.'bibliography/iframe_topic.php?biblioID='.$rec_d['biblio_id'].'block=1"></iframe>';
        $str_input .= '<iframe name="topicIframe" id="topicIframe" class="borderAll" style="width: 100%; height: 70px;" src="'.MODULES_WEB_ROOT_DIR.'bibliography/iframe_topic.php?block=1"></iframe>';
    $form->addAnything(__('1Subject(s)'), $str_input);
	*/
}
if($_POST['keywords']==130 || $_POST['keywords']==112 || $_POST['keywords']==113 || $_POST['keywords']==117 || $_POST['keywords']==88)
{
 // biblio standard
/*        $str_input = '<div class="'.$visibility.'"><a class="notAJAX"  href="javascript: openHTMLpop(\''.MODULES_WEB_ROOT_DIR.'bibliography/pop_standard.php?biblioID='.$rec_d['biblio_id'].'\', 1000, 200, \''.__('Standard').'\')">'.__('Add Standard(s)').'</a></div>';
        $str_input .= '<iframe name="standardIframe" id="standardIframe" class="borderAll" style="width: 100%; height: 70px;" src="'.MODULES_WEB_ROOT_DIR.'bibliography/iframe_standard.php?biblioID='.$rec_d['biblio_id'].'block=1"></iframe>';
...
if($_POST['keywords']==130 || $_POST['keywords']==112 || $_POST['keywords']==113 || $_POST['keywords']==114 || $_POST['keywords']==116 || $_POST['keywords']==117 || $_POST['keywords']==118 || $_POST['keywords']==77 || $_POST['keywords']==79 || $_POST['keywords']==80 || $_POST['keywords']==81 || $_POST['keywords']==82 || $_POST['keywords']==83 || $_POST['keywords']==88 || $_POST['keywords']==84 || $_POST['keywords']==85 || $_POST['keywords']==87)
{    
   /* 
     $freq_q = $dbs->query('SELECT frequency_id, frequency FROM mst_frequency');
        $freq_options[] = array('0', strtoupper(__('--Select Frequency--')));
    ...
    */
       ...
       //$lang_options =  array();        
        ...
        $lang_options[] = array('0', strtoupper(__('--Language--')));
        while ($lang_d = $lang_q->fetch_row()) 
        {
            $lang_options[] = array($lang_d[0], $lang_d[1]);
        }
     $form->addSelectList('languageID', __('Language'),$lang_options,$lang_options[0]);
     //, $rec_d['language_id']
...
if($_POST['keywords']==130 || $_POST['keywords']==112 || $_POST['keywords']==113 || $_POST['keywords']==114 || $_POST['keywords']==117 || $_POST['keywords']==118 || $_POST['keywords']==88 || $_POST['keywords']==84 || $_POST['keywords']==85 || $_POST['keywords']==87 || $_POST['keywords']==115)
{
    // biblio note
...
if($_POST['keywords']==130 || $_POST['keywords']==112 || $_POST['keywords']==113 || $_POST['keywords']==118 || $_POST['keywords']==88 || $_POST['keywords']==84 || $_POST['keywords']==85 || $_POST['keywords']==87)
{
 // biblio review
...
if($_POST['keywords']==130 || $_POST['keywords']==112 || $_POST['keywords']==113 || $_POST['keywords']==115 || $_POST['keywords']==116 || $_POST['keywords']==77 || $_POST['keywords']==79 || $_POST['keywords']==80 || $_POST['keywords']==81 || $_POST['keywords']==82 || $_POST['keywords']==83 || $_POST['keywords']==84 || $_POST['keywords']==85 || $_POST['keywords']==86 || $_POST['keywords']==87 || $_POST['keywords']==89 || $_POST['keywords']==90 || $_POST['keywords']==91 || $_POST['keywords']==92 || $_POST['keywords']==93 || $_POST['keywords']==94 || $_POST['keywords']==95 || $_POST['keywords']==96 || $_POST['keywords']==88 || $_POST['keywords']==97 || $_POST['keywords']==98 || $_POST['keywords']==99 || $_POST['keywords']==100 || $_POST['keywords']==101 || $_POST['keywords']==102 || $_POST['keywords']==104 || $_POST['keywords']==105 || $_POST['keywords']==106 || $_POST['keywords']==68 || $_POST['keywords']==69 || $_POST['keywords']==70 || $_POST['keywords']==71 || $_POST['keywords']==72 || $_POST['keywords']==73 || $_POST['keywords']==74 || $_POST['keywords']==75 || $_POST['keywords']==76)
{
    // biblio file attachment
    $str_input = '<div class="'.$visibility.'"><a class="notAJAX" href="javascript: openHTMLpop(\''.MODULES_WEB_ROOT_DIR.'bibliography/pop_attach.php?biblioID='.$rec_d['biblio_id'].'\', 800, 500, \''.__('File Attachments').'\')">'.__('Add Attachment').'</a></div>';
