                ...
                $bib3=$bib2[0];
                            ...
                            if(in_array($temp,$explode1))
                            {
                                    ...
                                    {                                                                                
                                        ...
                                        where ts.SUB_INSTITUTE_ID='$_SESSION[SUB_INSTITUTE_ID]' AND ts.user_name like '$_POST[member_id]' and material_sub_id=$_POST[material_sub_id] ";                                                                    
                                    }
                                    else
                                    {
                                        $cat_master_data="select category_mast.* from ".$inte_schema.".tblstudent AS ts 
                                        LEFT JOIN category_mast ON ts.user_group_id =category_mast.cat_mast_user 
										where ts.SUB_INSTITUTE_ID='$_SESSION[SUB_INSTITUTE_ID]' AND ts.enrollment_no like '$_POST[member_id]' and material_sub_id=$_REQUEST[material_sub_id] ";                                                                    
