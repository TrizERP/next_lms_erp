...
$barcode_items_margin = 0.2;
$barcode_box_width = 5;
$barcode_box_height = 3;
...
/* measurement in cm */
$card_page_margin = 0;//0.2;
//$card_items_per_row = 2;
$card_items_per_row = 5;
$card_items_margin = 0;//0.1;
//$card_box_width = 12;
$card_box_width = 5;
//$card_box_height = 6;
$card_box_height = 1;//2;
$card_header_text = $page_title;
//$card_photo_width = 3;
//$card_photo_height = 3;
//$card_photo_width = 2;
$card_photo_width = 0;
...
$card_barcode_scale = 60; // barcode scale in percent relative to box width and height
$card_include_field_label = 1; // set 0 if you don't want to show field label in card
$card_border_size = 0; //1 in pixels

// barcode generator print settings
$barcodegen_box_width = 6.5;
$barcodegen_page_margin = 0.0; //0.2
$barcodegen_items_margin = 0.03; //0.05
