...
$materialsubid = $_POST['materialsubid'];
    ...
    foreach ($_POST['zrecord'] as $rec_idx) {
       ...
       // unset($biblio['gmd']);
        // publisher
	$biblio['material_resource_id'] = $materialresourceid;
	$biblio['gmd_id'] = $gmdID;
	$biblio['material_sub_id'] = $materialsubid;
...
if(isset($_GET['host_name']))
 ...
 //echo '<collection xmlns="http://z3950.loc.gov">'."\n";
        ...
        if ($hits > 0) {
		 ...
		 echo '<div class="infoBox">Found following records from Z3950 Server, only 20 listed.</div>';
            // parse XML
            ...
            echo '<tr>';
            echo '<td colspan="3"><input type="submit" name="saveZ" value="Save Records to Database" /></td>';
            echo '</tr>';
		echo '<tr>';
...
$str_input .= '</td><tr><td id="txtHint" class="alterCell2" colspan="3"></td></tr>';

echo "Material Type:- ".$str_input;
		echo  '</table></td>';
		echo '</tr>';	
            // loop records
            $row = 1;
...
$bradecum .= '<a href='.MODULES_WEB_ROOT_DIR.'bibliography/z3950.php class="headerText2">z3950 Service</a>';
echo $bradecum;
        ?>	
	</td>
</tr>
