...
$bradecum .= '<a href='.MODULES_WEB_ROOT_DIR.'bibliography/checkout_item.php class="headerText2">Checkout Items</a>';
echo $bradecum;
        ?>	
	</td>
</tr>
...
$table_spec = 'loan AS l
    LEFT JOIN '.$inte_schema.'.tblstudent AS m ON m.SUB_INSTITUTE_ID='.$_SESSION['SUB_INSTITUTE_ID'].' AND l.member_id=m.enrollment_no
...
$checkout_criteria = ' (l.loan_date is not null AND l.return_date is null) ';
