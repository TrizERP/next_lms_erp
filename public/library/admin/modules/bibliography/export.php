    ...
    if (empty($_POST['fieldSep']) OR empty($_POST['fieldEnc'])) {
        ...
        if ($dbs->error) {
            ...
            if ($all_data_q->num_rows > 0) {
                ...
                header('Content-Disposition: attachment; filename="biblio_export.csv"');
                ...
                utility::jsAlert(gettext('There is no record in bibliographic database yet, Export FAILED!'));
            }
        }
    }
    exit();
...
$bradecum .= '<a href='.MODULES_WEB_ROOT_DIR.'bibliography/export.php class="headerText2">Export Data</a>';
echo $bradecum;
        ?>	
	</td>
</tr>
...
<tr>
	<td class="tab_menu_top">
                            <ul class="tabs"> 
				<li>
<a href="<?php echo MODULES_WEB_ROOT_DIR; ?>bibliography/export.php" class="headerText2"><?php echo gettext('Export Data'); ?></a> </li><!--<li> <a href="<?php echo  MODULES_WEB_ROOT_DIR; ?>bibliography/item_export.php" class="headerText2"><?php //echo __('Export Item'); ?></a> </li>-->
				</ul>
	</td>
</tr>
</table>
...
<div class="menuBoxInner exportIcon">
    <?php echo gettext('EXPORT TOOL'); ?>
    <p class="only_border">&nbsp;</p>
    <?php echo gettext('Export bibliographics data to CSV file'); ?>
</div>
</fieldset>
<?php
