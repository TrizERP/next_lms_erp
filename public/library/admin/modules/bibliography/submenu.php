...
$menu[] = array(gettext('Library Resources'), MODULES_WEB_ROOT_DIR.'bibliography/index.php', gettext('Show Existing Book Data'));
//$menu[] = array(__('Add New Book'), MODULES_WEB_ROOT_DIR.'bibliography/index.php?action=detail&physical=physical', __('Add New Book Data/Catalog'));
//$menu[] = array(__('Add Physical Resources'), MODULES_WEB_ROOT_DIR.'bibliography/index.php?action=detail&physical=physical', __('Add New Book Data/Catalog'));
//$menu[] = array(__('Add Virtual Resources'), MODULES_WEB_ROOT_DIR.'bibliography/virtual_resources.php?action=detail', __('Add Virtual Resources'));
//$menu[] = array('Header', __('Items'));
$menu[] = array(gettext('Books'), MODULES_WEB_ROOT_DIR.'bibliography/item.php', gettext('Show List of Library Items'));
//$menu[] = array(__('Checkout Items'), MODULES_WEB_ROOT_DIR.'bibliography/checkout_item.php', __('Show List of Checkout Items'));
//$menu[] = array('Header', __('Tools'));
//$menu[] = array(__('Z3950 Service'), MODULES_WEB_ROOT_DIR.'bibliography/z3950.php', __('Grab Book Data from Z3950 Web Services'));
$menu[] = array(gettext('Import MARC File'), MODULES_WEB_ROOT_DIR.'bibliography/upld_marc.php', gettext('Import MRC File Data'));
//$menu[] = array(__('P2P Service'), MODULES_WEB_ROOT_DIR.'bibliography/p2p.php', __('Grab Book Data from Other SLiMS Web Services'));
//$menu[] = array(__('Print'), MODULES_WEB_ROOT_DIR.'bibliography/dl_print.php', __('Print Document Labels'));
$menu[] = array(gettext('Print'), MODULES_WEB_ROOT_DIR.'bibliography/item_barcode_generator.php', gettext('Print Document Labels'));
//$menu[] = array(__('Item Barcodes Printing'), MODULES_WEB_ROOT_DIR.'bibliography/item_barcode_generator.php', __('Print Item Barcodes'));
$menu[] = array(gettext('Import'), MODULES_WEB_ROOT_DIR.'bibliography/import.php', gettext('Import Data to Book Database from CSV file'));
...
$menu[] = array(gettext('Export'), MODULES_WEB_ROOT_DIR.'bibliography/export.php', gettext('Export Book Data To CSV format'));
//$menu[] = array(__('Export Item'), MODULES_WEB_ROOT_DIR.'bibliography/item_export.gettext', __gettext('Export Item/Copies data To CSV format'));
$menu[] = array(gettext('Book Verification'), MODULES_WEB_ROOT_DIR.'bibliography/scan_item.php', gettext('Book Verification'));
$menu[] = array(gettext('Book Verification Remarks'), MODULES_WEB_ROOT_DIR.'bibliography/not_scan_item.php', gettext('Book Verification Remarks'));
?>
