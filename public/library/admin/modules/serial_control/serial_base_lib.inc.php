...
class serial
{
    ...
    public function generateKardexes($int_total_expl, $bool_insert_to_DB = true)
    {
        ...
        $_kardex = array();
        //added started and commented by Parth 3/9/2011
        //utility::jsAlert($this->serial_date_start);
        //$_parsed_date = date_parse($this->serial_date_start);
        $_parsed_date = explode("-",$this->serial_date_start);
        /*$_year = $_parsed_date['year'];
        $_month = $_parsed_date['month'];
        $_day = $_parsed_date['day'];*/
        $_year = $_parsed_date[0];
        $_month = $_parsed_date[1];
        $_day = $_parsed_date[2];
        //added ended and commented by Parth 3/9/2011 
