...
$port="465";
$username="parth.kapadia@triz.co.in";
$password="parth123";
$from="jitesh.khilosia@triz.co.in";
$fromname="Jitesh Khilosia";
...
try {
	...
	$body='';
	$body.= "<table border=0 bgcolor=lightgray><tr><td>Book Title</td><td>Date</td><td>Status</td><td>Note</td></tr>";
	//foreach($_SESSION['receipt_record']['loan'] as $loan)
        //{
	   $body .="<tr><td>".$book_title."</td><td>".date('d-m-Y')."</td><td>Available</td><td>Collect Within 2 Days</td></tr>";
	...
	$mail->Subject  = "Reserve Notification Mail";
