...
$bradecum .= '<a href='.MODULES_WEB_ROOT_DIR.'reporting/customs/fines_report.php class="headerText2">Fines Report</a>';
echo $bradecum;
        ?>	
	</td>
</tr>
    ...
    <legend style="font-weight: bold"><?php echo strtoupper(gettext('Fines Report')); ?> - <?php echo gettext('Report Filter'); ?></legend>
    ...
    <!-- filter end -->
    <iframe name="reportView" id="reportView" src="<?php echo $_SERVER['PHP_SELF'].'?reportView=true'; ?>" frameborder="0" style="width: 100%; min-height:250px;"></iframe>
<?php
} else {
    ob_start();
    $fines_data = array();
    ...
    // print out
    echo '<div class="printPageInfo">Fines Count Report for year <strong>'.$selected_year.'</strong> <a class="printReport" onclick="window.print()" href="#">['.gettext('Print Current Page').']</a></div>'."\n";
    echo $output;
