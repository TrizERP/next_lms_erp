...
$bradecum .= '<a href='.MODULES_WEB_ROOT_DIR.'reporting/customs/visitor_list.php class="headerText2">Visitor List</a>';
echo $bradecum;
        ?>	
	</td>
</tr>
    ...
    <div id="filterForm">
        <div class="divRow">
	      ...
	      $member_type_options[] = array('0', strtoupper(__('N/A')));
            ...
            echo simbio_form_element::selectList('membertypeid', $member_type_options, '', 'style="width: 140px"');
            ?>
            </div>
        </div>
        <div class="divRow">
        ...
        <div class="divRow">
            ...
            /*added by iresh on 25-1-2011 */  echo simbio_form_element::textField('text', 'institution', '', 'style="width: 140px"');
             ?>
            </div>
        </div>
        <div class="divRow">
    ...
    <iframe name="reportView" id="reportView" src="<?php echo $_SERVER['PHP_SELF'].'?reportView=true'; ?>" frameborder="0" style="width: 100%; min-height:150px;"></iframe>
<?php
} else {    
    ob_start();
    // table spec
    ...
    $table_spec = 'visitor_count AS vc
        LEFT JOIN ('.$inte_schema.'.tblstudent AS m LEFT JOIN category_user AS mt ON m.user_group_id=mt.user_id)
        ON vc.member_id=m.enrollment_no';
