...
// echo "Connected successfully";
    ...
    $sql = "SELECT i.item_code,b.title,ct.coll_type_name,i.remarks,i.item_status_id,s.item_status_name
            FROM item i
	...
	echo '<input type="hidden" name="excelName" value="book_verification_pending_report" />';		
