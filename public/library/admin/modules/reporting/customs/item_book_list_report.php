...
//added Started By Parth 23/8/2011
    ...
    $reportgrid->setSQLColumn('i.item_code AS \'' . __('Item Code') . '\'', 'b.title AS \'' . __('Title') . '\'', 'ct.coll_type_name AS \'' . __('Collection Type') . '\'', 's.item_status_name AS \'' . __('Item Status') . '\'', 'i.biblio_id');
//added Ended By Parth 23/8/2011
