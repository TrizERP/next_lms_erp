    ...
    <table  align=center>
        <tr>
            <td valign=top>
                ...
                $bradecum .= '</a>->';
                $bradecum .= '<a href=' . MODULES_WEB_ROOT_DIR . 'reporting/customs/item_bool_list_report.php class="headerText2">Item Book List</a>';
                echo $bradecum;
                ?>	
            </td>
        </tr>
...
//added Started By Parth 23/8/2011
    ...
    $reportgrid->setSQLColumn('i.item_code AS \'' . gettext('Item Code') . '\'', 'b.title AS \'' . gettext('Title') . '\'', 'ct.coll_type_name AS \'' . gettext('Collection Type') . '\'', 's.item_status_name AS \'' . gettext('Item Status') . '\'', 'i.biblio_id');
//added Ended By Parth 23/8/2011
...
//added and commented ended 23/8/2011
        $_authors = '';
