...
$bradecum .= '<a href='.MODULES_WEB_ROOT_DIR.'reporting/customs/book_verification_report.php class="headerText2">Books Varified List</a>';
echo $bradecum;
        ?>	
	</td>
</tr>
    ...
    <div id="filterForm">
        <div class="divRow">
           ...
           //comment by iresh on 25-1-2011  echo simbio_form_element::textField('text', 'itemCode', '', 'style="width: 50%"'); 
            ...
            <div class="divRowLabel"><?php echo gettext('Academic Year'); ?></div>
            <div class="divRowContent">
            <?php
            $source_options[] = array('0', gettext('ALL'));
            $source_options[] = array('2019', gettext('2019'));
            $source_options[] = array('2020', gettext('2020'));
            $source_options[] = array('2021', gettext('2021'));
...
// echo "Connected successfully";
    ...
    $sql = "
SELECT i.item_code,b.title,ct.coll_type_name,i.remarks,i.item_status_id,s.item_status_name
FROM item i
LEFT JOIN biblio AS b ON i.biblio_id=b.biblio_id
LEFT JOIN mst_coll_type AS ct ON i.coll_type_id=ct.coll_type_id
LEFT JOIN mst_item_status AS s ON i.item_status_id=s.item_status_id
INNER JOIN item_scan_details AS isd ON isd.item_code COLLATE utf8_general_ci = i.item_code COLLATE utf8_general_ci
WHERE isd.scan_status = 'Yes'
";
	...
	echo '<input type="hidden" name="excelName" value="book_verification_report" />';		
