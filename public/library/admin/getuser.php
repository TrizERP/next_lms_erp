...
{
 // biblio standard
        $str_input = '<div class="'.$visibility.'"><a class="notAJAX"  href="javascript: openHTMLpop(\''.MODULES_WEB_ROOT_DIR.'bibliography/pop_standard.php?biblioID='.$rec_d['biblio_id'].'\', 1100, 200, \''.__('Standard').'\')">'.__('Add Standard(s)').'</a></div>';
...
if($_POST['keywords']==78 || $_POST['keywords']==112 || $_POST['keywords']==113 || $_POST['keywords']==115 || $_POST['keywords']==116 || $_POST['keywords']==77 || $_POST['keywords']==79 || $_POST['keywords']==80 || $_POST['keywords']==81 || $_POST['keywords']==82 || $_POST['keywords']==83 || $_POST['keywords']==84 || $_POST['keywords']==85 || $_POST['keywords']==86 || $_POST['keywords']==87 || $_POST['keywords']==89 || $_POST['keywords']==90 || $_POST['keywords']==91 || $_POST['keywords']==92 || $_POST['keywords']==93 || $_POST['keywords']==94 || $_POST['keywords']==95 || $_POST['keywords']==96 || $_POST['keywords']==88 || $_POST['keywords']==97 || $_POST['keywords']==138 || $_POST['keywords']==98 || $_POST['keywords']==99 || $_POST['keywords']==100 || $_POST['keywords']==101 || $_POST['keywords']==102 || $_POST['keywords']==104 || $_POST['keywords']==105 || $_POST['keywords']==106 || $_POST['keywords']==68 || $_POST['keywords']==69 || $_POST['keywords']==70 || $_POST['keywords']==71 || $_POST['keywords']==72 || $_POST['keywords']==73 || $_POST['keywords']==74 || $_POST['keywords']==75 || $_POST['keywords']==76)
{
    ...
    $str_input = '<div class="'.$visibility.'"><a class="notAJAX" href="javascript: openHTMLpop(\''.MODULES_WEB_ROOT_DIR.'bibliography/pop_attach.php?biblioID='.$rec_d['biblio_id'].'\', 900, 381, \''.__('File Attachments').'\')">'.__('Add Attachment').'</a></div>';
