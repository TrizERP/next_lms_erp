...
if (isset($_GET['gmd_search']) && !empty($_GET['gmd_search']))
{
    // default vars
    $is_adv = false;
    $keywords = '';
...
if (isset($_GET['gmd_search']) && !empty($_GET['gmd_search'])) {
    ...
    // advanced search
    $is_adv = isset($_GET['gmd_search']) || isset($_GET['title']) || isset($_GET['author']) || isset($_GET['isbn'])
