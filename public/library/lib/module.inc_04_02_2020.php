...
class module extends simbio
{
   ...
   /*added by iresh on 11/1/2011 */ 
    public $appended_first = '<li><a class="menu" href="index.php">Home</a></li><!--<li><a class="menu" href="../index.php" title="View OPAC in New Window" target="_blank">Member Area</a></li>-->';
