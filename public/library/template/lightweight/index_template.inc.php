...
<!-- main menu -->
<tr>
<td id="barTop"><strong id="librarySubName"><?php echo $library_subname; ?></strong></td>
</tr>
<!-- main menu end -->

<!-- header -->
<tr>
<td id="mainHeader"><h3 id="libraryName"><?php echo $page_title; ?></h3>
<a class="menu" href="index.php"><?php echo gettext('Home'); ?></a>&nbsp;&nbsp;
<!-- comment by iresh on 11/1/2011 <a class="menu" href="index.php?p=libinfo"><?php echo gettext('Library Information'); ?></a>&nbsp;&nbsp;-->
<a class="menu" href="index.php?p=help"><?php echo gettext('Help on Search'); ?></a>&nbsp;&nbsp;
