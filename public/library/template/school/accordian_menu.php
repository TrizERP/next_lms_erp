...
<?php
           $material='select g.gmd_id AS gmd_id,g.gmd_name AS gmd_name,mr.material_resource_name from mst_gmd AS g 
		    LEFT JOIN mst_material_resource_type AS mr ON mr.material_resource_id=g.material_resource_id
	            where g.material_resource_id='.$row['material_resource_id'].' AND g.active_inactive=1';
