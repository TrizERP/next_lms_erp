...
<?php }?>
<tr>
<td class="tblHead" style="width: 20%;" valign="top"><?php print gettext('Abstract'); ?></td>
<td class="tblContent" style="width: 80%;" valign="top">{abstract}</td>
</tr>
<tr>
<td class="tblHead" style="width: 20%;" valign="top"><?php print gettext('Notes'); ?></td>
...
<tr>
<td class="tblHead" style="width: 20%;" valign="top"><?php print gettext('Connect'); ?></td>
