...
include('app_config.php'); 
	...
	*/
	...
	$course->fullname = $_REQUEST['subject'];	// string,    254, Obrigatorio,          Nome Completo do Curso
	$course->shortname = $_REQUEST['short_name']."-".$_REQUEST['idnumber'];	// string, 100, Obrigatorio, Nome Curto, evite usar espaço, substitua os espaços por traço baixo (underscore)
	$course->categoryid  = $_REQUEST['id'];					// int, 	   10, Obrigatorio, 		 Id da categoria
