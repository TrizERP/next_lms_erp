...
include('app_config.php'); 
	...
	*/
	...
	// $course->fullname = "123Curso teste";	// string,    254, Obrigatorio,          Nome Completo do Curso
	// $course->shortname = "123TESTE!";					// string,    100, Obrigatorio,          Nome Curto, evite usar espaço, substitua os espaços por traço baixo (underscore)
	// $course->id  = 2;					// int, 	   10, Obrigatorio, 		 Id da categoria
	...
	$courses[0] = 2; 
	$params = array('courseids' => $courses);
	// print_r($params );
