...
$sql_grade = " select * from mdl_quiz_grades where quiz='".$quiz_id."' and userid='".$uid."'";
$res=mysql_query($sql_grade);
   if (mysql_num_rows($res)>0)
	{
		/*$sql_update = "update mdl_quiz_grades set grade = '".$i."' ,MODIFIED_DATE=now(),QUESTION_LAYOUT='".$qid."',GIVEN_ANS='".$aid."',ORG_ANS='".$oid."' where quiz='".$quiz_id."' and userid='".$uid."' ";*/
		$sql_update = "update mdl_quiz_grades set grade = '".$marks."' ,MODIFIED_DATE=now(),QUESTION_LAYOUT='".$qid."',GIVEN_ANS='".$aid."',ORG_ANS='".$oid."' where quiz='".$quiz_id."' and userid='".$uid."' ";
   ...
   {
   	/*$result1 = "INSERT INTO mdl_quiz_grades(quiz,userid,grade,MODIFIED_DATE,QUESTION_LAYOUT,GIVEN_ANS,ORG_ANS)VALUES('".$quiz_id."','".$uid."','$i',now(),'".$qid."','".$aid."','".$oid."')";*/
	$result1 = "INSERT INTO mdl_quiz_grades(quiz,userid,grade,MODIFIED_DATE,QUESTION_LAYOUT,GIVEN_ANS,ORG_ANS)VALUES('".$quiz_id."','".$uid."','".$marks."',now(),'".$qid."','".$aid."','".$oid."')";
		//echo "INSERT===>>>".$result1;
		 mysql_query($result1);
	}


$sql = "select grade from mdl_quiz_grades where quiz='".$quiz_id."' and userid='".$uid."'";
//echo $sql."<br>";
