...
$sql_attempt="select (ifnull(max(attempt),0) + 1) as attempt,id,uniqueid from mdl_practice_attempts where quiz='".$ID."' and userid='".$user_id."'";
...
if (mysql_num_rows($res)>0)
{
	...
	$sql_insert="insert into mdl_practice_attempts(uniqueid,quiz,userid,attempt,timestart)VALUES('".$uniqueid."','".$ID."','".$user_id."','".$attempt."',UNIX_TIMESTAMP (NOW()))";
...
where quiz.id in 
			(select id from mdl_quiz where course='".$ID."') 
