    ...
    if (in_array($ext, $allowed)) {
        ...
        foreach ($dataArr as $key => $value) {
            ...
            foreach ($valueFields1 as $kvf => $valueFields) {
                ...
                } else if ($valueFields['field'] == "punchin_time" || $valueFields['field'] == "punchout_time") {
                    $valueQuery .= "'" . date('Y-m-d H:i:s', PHPExcel_Shared_Date::ExcelToPHP($value[$valueFields['field']])) . "',";
                } else {
