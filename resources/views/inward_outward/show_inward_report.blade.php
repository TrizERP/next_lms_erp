    ...
    <div class="container-fluid">
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">Inward Report</h4> 
            </div>
        </div>        
                <div class="card">
...
<script>
    ...
    var table = $('#example').DataTable( {
        ...
        buttons: [ 
            ...
            { extend: 'csv', text: ' CSV', title: 'Inward Report' }, 
            { extend: 'excel', text: ' EXCEL', title: 'Inward Report' }, 
            { extend: 'print', text: ' PRINT', title: 'Inward Report' }, 
            'pageLength' 
        ], 
        }); 
