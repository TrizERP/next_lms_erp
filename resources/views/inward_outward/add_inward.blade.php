                        ...
                        <div class="row">                       
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <div class="input-daterange input-group" id="date-range">
                                    <input type="text" required class="form-control mydatepicker" placeholder="dd/mm/yyyy" value="@if(isset($data->inward_date)){{$data->inward_date}}@endif" name="inward_date" autocomplete="off">
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <input type="text" value="{{$inward_no}}" id='inward_number' required name="inward_number" class="form-control" readonly="readonly">
                            </div>
                            ...
                            <div class="col-md-4 ol-sm-4 col-xs-12">                         
                                ...
                                <input type="file" accept="image/*" name="attachment" @if(isset($data->attachment))data-default-file="/storage/inward/{{$data->attachment}}" @else required @endif id="input-file-now" class="dropify" /> 
                            </div>
