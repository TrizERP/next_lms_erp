    ...
    <div class="container-fluid">
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">Add Inward</h4></div>
        </div>
        <div class="card">
            <div class="panel-body">
                ...
                <div class="col-lg-12 col-sm-12 col-xs-12">
                    ...
                    {{ route('add_inward.update', $data->id) }}
                    @else
                    {{ route('add_inward.store') }}
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <select name="acedemic_year" id="acedemic_year" class="form-control" required>
                                    ...
                                    <option value="2013-2014"
                                            @if(isset($data->acedemic_year))@if("2013-2014" == $data->acedemic_year) selected @endif  @endif>
                                        2013-2014
                                    </option>
                                    <option value="2014-2015"
                                            @if(isset($data->acedemic_year))@if("2014-2015" == $data->acedemic_year) selected @endif  @endif>
                                        2014-2015
                                    </option>
                                    <option value="2015-2016"
                                            @if(isset($data->acedemic_year))@if("2015-2016" == $data->acedemic_year) selected @endif  @endif>
                                        2015-2016
                                    </option>
                                    <option value="2016-2017"
                                            @if(isset($data->acedemic_year))@if("2016-2017" == $data->acedemic_year) selected @endif  @endif>
                                        2016-2017
                                    </option>
                                    <option value="2017-2018"
                                            @if(isset($data->acedemic_year))@if("2017-2018" == $data->acedemic_year) selected @endif  @endif>
                                        2017-2018
                                    </option>
                                    <option value="2018-2019"
                                            @if(isset($data->acedemic_year))@if("2018-2019" == $data->acedemic_year) selected @endif  @endif>
                                        2018-2019
                                    </option>
                                    <option value="2019-2020"
                                            @if(isset($data->acedemic_year))@if("2019-2020" == $data->acedemic_year) selected @endif  @endif>
                                        2019-2020
                                    </option>
                                    <option value="2020-2021" selected="selected"
                                            @if(isset($data->acedemic_year))@if("2020-2021" == $data->acedemic_year) selected @endif  @endif>
                                        2020-2021
                                    </option>

                                    <option value="2020-2021" selected="selected"
                                            @if(isset($data->acedemic_year))@if("2021-2022" == $data->acedemic_year) selected @endif  @endif>
                                        2021-2022
                                    </option>
                                    <option value="2020-2021" selected="selected"
                                            @if(isset($data->acedemic_year))@if("2022-2023" == $data->acedemic_year) selected @endif  @endif>
                                        2022-2023
                                    </option>
                                </select>
                            </div>
-->
                            ...
                            <!-- <input type="text" value="@if(isset($data->inward_number)){{$data->inward_number}}@endif" id='inward_number' required name="inward_number" class="form-control"> -->
                                <input type="text" value="{{$inward_no}}" id='inward_number' required
                                       name="inward_number" class="form-control" readonly="readonly">
                            </div>

                            <div class="col-md-4 form-group">
                                <label>Subject </label>
                                <input type="text" id='title' value="@if(isset($data->title)){{$data->title}}@endif"
                                    ...
                                    <div class="col-md-4 form-group ml-0">
                                        ...
                                        @if($value['field_type'] == 'file')
                                            <input type="{{ $value['field_type'] }}" accept="image/*"
                                                   id="input-file-now" @if($value['required'] == 1) required
                                                   @endif name="{{ $value['field_name'] }}" class="dropify">
                                        @elseif($value['field_type'] == 'date')
                                            <div class="input-daterange input-group">
                                                <input type="text" class="form-control mydatepicker"
                                                       placeholder="dd/mm/yyyy" autocomplete="off"
                                                       id="{{ $value['field_name'] }}"
                                                       @if($value['required'] == 1) required
                                        ...
                                        @else
                                            <input type="{{ $value['field_type'] }}" id="{{ $value['field_name'] }}"
                                                   placeholder="{{ $value['field_message'] }}"
                                                   @if($value['required'] == 1) required
                                                   @endif name="{{ $value['field_name'] }}" class="form-control">
                                        @endif
                                    </div>
                                @endforeach
                            @endif
                            ...
                            <div class="col-md-4 ol-sm-4 col-xs-12">
                                ...
                                <input type="file" accept="image/*" name="attachment"
                                       @if(isset($data->attachment))data-default-file="/storage/inward/{{$data->attachment}}"
