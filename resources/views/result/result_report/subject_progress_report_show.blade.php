    ...
    <div class="container-fluid">
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">Subject Progress Report</h4> 
            </div>
        </div>        
                            ...
                            <tbody>
                                @foreach($all_student as $key => $all_data)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {{App\Helpers\sortStudentName("",$all_data['first_name'],$all_data['middle_name'],$all_data['last_name'])}}
                                        </td>
                                        @if(isset($data['date_arr']))
                                        @foreach($data['date_arr'] as $k => $date_point)
...
<script>
    ...
    var table = $('#example').DataTable( {
        ...
        buttons: [ 
            ...
            { extend: 'csv', text: ' CSV', title: 'Subject Progress Report' }, 
            { extend: 'excel', text: ' EXCEL', title: 'Subject Progress Report' }, 
            { extend: 'print', text: ' PRINT', title: 'Subject Progress Report' }, 
            'pageLength' 
        ], 
        }); 
