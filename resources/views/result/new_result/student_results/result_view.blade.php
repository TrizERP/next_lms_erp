   ...
   $(document).ready(function () {
    ...
    function printDiv(divName) {
        ...
        @if(!in_array(session()->get('sub_institute_id'),[201,202,203,204]))
            ...
            popupWin.document.write('<div style="text-align:center"><h1 style="margin:0px !important;">MULJIBHAI MEHTA INTERNATIONAL SCHOOL</h1><span>GOKUL TOWNSHIP, OFF. AGASHI ROAD, BOLINJ, VIRAR (W), MUMBAI METROPOLITAN REGION,</span><br><span>PALGHAR, PIN – 401 303</span><h3 style="margin:0px !important;">GRAND MARKSHEET ('+acaYear+')</h3></div>');
            @endif
            Object.keys(studentData).forEach(function(studentId) {
                var html = studentData[studentId];
                @if(in_array($data['template'],[12,51,52])) // added for mmis grandmarksheet
