    ...
    <div class="container-fluid">
        <div class="row" style=" margin-top: 25px;">
            <div class="panel-body white-box">
                ...
                <div class="row">
                    <div class="col-sm-5 text-right"><input class="btn btn-warning mb-4" type="button"
                                                            onclick="printDiv('printableArea');" value="Print Paper"/>
                    </div>
                    <div class="col-sm-2 center"></div>
                    <div class="col-sm-5 text-left"><input class="btn btn-danger mb-4" type="button"
                                                           onclick="printMob('printableArea');" value="Print Mobile"/>
                    </div>
                </div>
                                        ...
                                        <table class="report-card ml-4" style="border-collapse:collapse;" width="100%"
                                            ...
                                            <tr>
                                                <td colspan="3" align="center">
                                                    <h3 style="font-size:16;color:black;font-weight: 600;">REPORT CARD
                                                        FOR ACADEMIC SESSION : <?php echo $all_data['year']; ?></h3>
                                                ...
                                                <td colspan="3">
                                                    <table class="aca-year"
                                                        ...
                                                        <tr>
                                                            ...
                                                            ?>
                                                            <th style="text-align: center;">
                                                                <b><?php echo $exam_data['exam']; ?>
                                                                    <br>(<?php echo $exam_data['mark']; ?>)</b></th>
                                                            <?php
                                                            }
                                                            ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <?php }} ?>
                                                            <td align="center">
                                                                <b> {{ number_format($grandGainTotal, 2) }}</b></td>
                                                            <td align="center">
                                                                <b>{{ \App\Helpers\getGrade($gradeScale, $grandSubTotal, $grandGainTotal) }}</b>
                                                            </td>
                                                        </tr>
                                                        <?php
                                                        }
                                            ...
                                            @if(count($footer_data) > 0)
                                                <tr>
                                                    <table style="border:hidden;" width="100%" cellspacing="0"
                                                           cellpadding="0">
                                                        <tr>
                                                            <td colspan="3" class="p-t-10"><b>Class Teacher's Remarks
                                                                    : <?php echo $all_data['teacher_remark']; ?></b>
                                                            </td>
                                                        </tr>
                                                    <!--<tr>
                                                                    <th><b>Result</b></th>
