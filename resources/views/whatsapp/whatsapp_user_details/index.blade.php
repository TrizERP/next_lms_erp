        ...
        <div class="card">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-3 col-xs-3">
                    <a href="{{ route('whatsapp_user_details.create') }}" class="btn btn-info add-new"><i class="fa fa-plus"></i> Whatsapp User Details </a>
                </div>
                @endif
                        ...
                        <table id="example" class="table table-striped">
                            ...
                            @foreach($data['data'] as $key => $data)
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-inline">
                                            <a href="{{ url('whatsapp-user-details/create/'.$data->id)}}" class="btn btn-info btn-outline"><i class="ti-pencil-alt"></i></a>
                                        </div>
