...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div>
                <form action="{{route('verified_report.index')}}" class="row">
                    @csrf
    ...
    $(document).ready(function () {
        var table = $('#example').DataTable({
            ...
            buttons: [
                {
                    extend: 'pdfHtml5',
                    title: 'Book Verification Report',
                ...
                {extend: 'csv', text: ' CSV', title: 'Book Verification Report'},
                {extend: 'excel', text: ' EXCEL', title: 'Book Verification Report'},
                {
                    extend: 'print',
                    text: ' PRINT',
                    title: 'Book Verification Report',
