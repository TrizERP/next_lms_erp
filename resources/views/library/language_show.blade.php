    ...
    <div class="container-fluid">
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">Language Report</h4> 
            </div>
        </div>        
                            ...
                            <tbody>
                                ...
                                @foreach($languages as $key => $language)                                 
                                    <tr>
                                        ...
                                        <td>{{$language->sub_title}}</td>    
                                        <td>{{$language->material_resource_type}}</td>
                                        <td>{{$language->edition}}</td>
                                        <td>{{$language->tags}}</td>
                                        <td>{{$language->vol_no}}</td>
                                        <td>{{$language->author_name}}</td>
                                        <td>{{$language->isbn_issn}}</td>
                                        <td>{{$language->classification}}</td>
                                        <td>{{$language->publisher_name}}</td>
                                        <td>{{$language->publish_year}}</td>
                                        <td>{{$language->publish_place}}</td>
                                        <td>{{$language->pages}}</td>
                                        <td>{{$language->series_title}}</td>
                                        <td>{{$language->call_number}}</td>
                                        <td>{{$language->language}}</td>
                                        <td>{{$language->source}}</td>
                                        <td>{{$language->subject}}</td>
                                        <td>{{$language->price}}</td>
                                        <td>{{$language->notes}}</td>
                                        <td>{{$language->review}}</td>
                                    </tr>
                                @endforeach
                            </tbody>    
                        </table>
