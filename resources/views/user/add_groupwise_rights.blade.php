                                    ...
                                    <table class="table table-bordered table-striped responsive-utilities">
                                        ...
                                        @foreach($groupwisemenuMaster as $key => $value)
                                            <tr style="background-color: #6cd4f3 !important;">
                                                ...
                                                <td style="text-align: center;">
                                                    <div class="checkbox checkbox-success checkbox-circle">
                                                        <input name="add[{{ $value['id'] }}][]" id="add_{{ $value['id'] }}" value="1" platform="add" type="checkbox" >
                                                        <label for="add_{{ $value['id'] }}"> Add </label>
                                                    </div>
                                                </td>
                                                <td style="text-align: center;">
                                                    <div class="checkbox checkbox-success checkbox-circle">
                                                        <input name="edit[{{ $value['id'] }}][]" id="edit_{{ $value['id'] }}" value="1" platform="edit" type="checkbox" >
                                                        <label for="edit_{{ $value['id'] }}"> Edit </label>
                                                    </div>
                                                </td>
                                                <td style="text-align: center;">
                                                    <div class="checkbox checkbox-success checkbox-circle">
                                                        <input name="delete[{{ $value['id'] }}][]" id="delete_{{ $value['id'] }}" platform="delete" value="1" type="checkbox" >
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center;">
                                                    <div class="checkbox checkbox-success checkbox-circle">
                                                        <input name="add[{{ $submenuValue['id'] }}][]" id="add_{{ $submenuValue['id'] }}" platform="add" value="1" type="checkbox" >
                                                        <label for="add_{{ $submenuValue['id'] }}"> Add </label>
                                                    </div>
                                                </td>
                                                <td style="text-align: center;">
                                                    <div class="checkbox checkbox-success checkbox-circle">
                                                        <input name="edit[{{ $submenuValue['id'] }}][]" id="edit_{{ $submenuValue['id'] }}" platform="edit" value="1" type="checkbox" >
                                                        <label for="edit_{{ $submenuValue['id'] }}"> Edit </label>
                                                    </div>
                                                </td>
                                                <td style="text-align: center;">
                                                    <div class="checkbox checkbox-success checkbox-circle">
                                                        <input name="delete[{{ $submenuValue['id'] }}][]" id="delete_{{ $submenuValue['id'] }}" platform="delete" value="1" type="checkbox" >
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;">
                                                        <div class="checkbox checkbox-success checkbox-circle">
                                                            <input name="add[{{ $SubsubmenuValue['id'] }}][]" id="add_{{ $SubsubmenuValue['id'] }}" platform="add" value="1" type="checkbox" >
                                                            <label for="add_{{ $SubsubmenuValue['id'] }}"> Add </label>
                                                        </div>
                                                    </td>
                                                    <td style="text-align: center;">
                                                        <div class="checkbox checkbox-success checkbox-circle">
                                                            <input name="edit[{{ $SubsubmenuValue['id'] }}][]" id="edit_{{ $SubsubmenuValue['id'] }}" platform="edit" value="1" type="checkbox" >
                                                            <label for="edit_{{ $SubsubmenuValue['id'] }}"> Edit </label>
                                                        </div>
                                                    </td>
                                                    <td style="text-align: center;">
                                                        <div class="checkbox checkbox-success checkbox-circle">
                                                            <input name="delete[{{ $SubsubmenuValue['id'] }}][]" id="delete_{{ $SubsubmenuValue['id'] }}" platform="delete" value="1" type="checkbox" >
