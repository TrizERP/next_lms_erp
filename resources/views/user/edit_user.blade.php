                                        ...
                                        <div class="row">
                                            <div class="col-md-4 form-group">
                                                ...
                                                <select name="name_suffix" id="name_suffix" class="form-control" required>
                                                    ...
                                                    <option value="Mr."
                                                        @if (isset($data)) @if ('Mr.' == $data['name_suffix']) selected @endif
                                                        @endif> Mr. </option>
                                                    <option value="Mrs."
                                                        @if (isset($data)) @if ('Mrs.' == $data['name_suffix']) selected @endif
                                                        @endif> Mrs. </option>
                                                    <option value="Miss."
                                                        @if (isset($data)) @if ('Miss.' == $data['name_suffix']) selected @endif
                                                        @endif> Miss. </option>
                                                </select>
                                            </div>
                                            <div class="col-md-4 form-group">
...
@if (isset($data['temp_address'])){{ $data['temp_address'] }}@endif
                                                ...
                                                <div class="col-md-4 form-group" id="stateDiv">
                                                    ...
                                                    <input type="text" name="temp_state" id="temp_state"
                                                        class="form-control"
                                                        @if (isset($data['temp_state'])) value="{{ $data['temp_state'] }}" @endif>
                                                </div>
                                                <div class="col-md-4 form-group" id="cityDiv">
                                                    <label>{{ App\Helpers\get_string('temp_state') }}</label>
                                                    <input type="text" name="temp_city" id="temp_city"
                                                        class="form-control"
                                                        @if (isset($data['temp_city'])) value="{{ $data['temp_city'] }}" @endif>
                                                </div>
                                                <div class="col-md-4 form-group" id="pincodeDiv">
                                                    <label>{{ App\Helpers\get_string('temp_pincode') }}</label>
                                                    <input type="number" id='temp_pincode' name="temp_pincode"
                                                        id="pincode" class="form-control"
                                                        @if (isset($data['temp_pincode'])) value="{{ $data['temp_pincode'] }}" @endif>
                                                </div>
                                            @endif
                                                    ...
                                                    @if (!empty($user_profiles))
                                                        @foreach ($user_profiles as $key => $value)
                                                            <option value="{{ $value['id'] }}"
                                                                @if (isset($data)) @if ($value['id'] == $data['user_profile_id']) selected @endif
                                                                @endif > {{ $value['name'] }}
                                                            </option>
                                                        @endforeach
                                                    @endif
                                            ...
                                            <div class="col-md-4 form-group ml-0 mr-0">
                                                ...
                                                <select id='status' name="status" class="form-control">
                                                    <option value="1"
                                                        @if (isset($data['status'])) @if ($data['status'] == 1) selected @endif
                                                        @endif> No </option>
                                                    <option value="0"
                                                        @if (isset($data['status'])) @if ($data['status'] == 0) selected @endif
                                                        @endif> Yes </option>
                                                </select>
                                            </div>
                                            <div class="col-sm-4 ol-md-4 col-xs-12">
                                                ...
                                                <input type="file" accept="image/*" name="user_image"
                                                    @if (isset($data)) data-default-file="/storage/user/{{ $data['image'] }}" @else required @endif
                                                                    ...
                                                                    @foreach ($data_fields[$value['id']] as $keyData => $valueData)
                                                                        <label class="checkbox-inline">
                                                                            <div class="checkbox checkbox-success">
                                                                                <input type="checkbox"
                                                                                    @if ($valueData['display_value'] == $data[$value['field_name']]) checked @endif
...
@endif
                                                ...
                                                <select id='jobtitle_id' name="jobtitle_id" class="form-control">
                                                    ...
                                                    @foreach ($job_titles as $title)
                                                        @if (isset($data['jobtitle_id']) && $data['jobtitle_id'] == $title->id)
                                                            <option selected value="{{ $title->id }}">
                                                                {{ $title->title }}</option>
                                                        @else
                                                ...
                                                <select id='department_id' name="department_id" class="form-control">
                                                    ...
                                                    @foreach ($departments as $title)
                                                        <option value="{{ $title->id }}"
                                                            @if ($data['department_id'] == $title->id) selected @endif>
                                            ...
                                            <div class="col-md-4 form-group">
                                                @if (isset($masterSetups['Qualification']) && !empty($masterSetups['Qualification']))
                                                    @php
                                                        $options = explode(
                                                            '||',
                                                            $masterSetups['Qualification']['fieldvalue'],
                                                        );
                                                    @endphp
                                                    <label>{{ $masterSetups['Qualification']['fieldname'] }}</label>
                                                    <div class="dropdown">
                                                        <input type="text" id="qualification-input"
                                                            class="form-control"
                                                            value="{{ isset($data['qualification']) ? $data['qualification'] : '' }}"
                                                ...
                                                @else
                                                    ...
                                                    <input type="text" id='qualification' list="qualifications"
                                                    ...
                                                    <datalist id="qualifications" height="100" style="height:100px">
                                                        @if (!empty($qualificationList))
                                                            @foreach ($qualificationList as $key => $value)
                                                                <option value="{{ $value }}"
                                                                    {{ isset($data['qualification']) && $data['qualification'] == $value ? 'selected' : '' }}>
                                                                    {{ $value }}</option>
                                                            @endforeach
                                                        @endif
                                                @endif
                                            ...
                                            <div class="col-md-4 form-group">
                                                @if (isset($masterSetups['Occupations']) && !empty($masterSetups['Occupations']))
                                                    @php
                                                        $options = explode(
                                                            '||',
                                                            $masterSetups['Occupations']['fieldvalue'],
                                                        );
                                                    @endphp
                                                    ...
                                                    <select id="occupation" name="occupation" class="form-control">
                                                        ...
                                                        @foreach ($options as $key => $value)
                                                            <option value="{{ $value }}"
                                                                {{ isset($data['occupation']) && $data['occupation'] == $value ? 'selected' : '' }}>
                                                                {{ $value }}</option>
                                                        @endforeach
                                                    </select>
                                                @else
                                                    <label>Occupation</label>
                                                    <input type="text" id='occupation' list="occupations"
                                            ...
                                            <div class="col-md-4 form-group">
                                                ...
                                                <input type="date" id='probation_period_from'
                                                    name="probation_period_from"
                                            ...
                                            <div class="col-md-4 form-group">
                                                ...
                                                <input type="text" id='noticereason'
                                                    value="{{ $data['noticereason'] }}" name="noticereason"
                                                    class="form-control">
                                            </div>
                                            <div class="col-md-4 form-group">
                                                <label>EL Opening Leave</label>
                                                <input type="text" id='openingleave'
                                                    value="{{ $data['openingleave'] }}" name="openingleave"
                                                    class="form-control">
                                            </div>
                                            ...
                                            <div class="col-md-4 form-group">
                                                ...
                                                <input type="text" id='relieving_reason'
                                                    value="{{ $data['relieving_reason'] }}" name="relieving_reason"
                                                    class="form-control">
                                            </div>
                                            <div class="col-md-4 form-group">
                                                <label>CL Opening Leave</label>
                                                <input type="text" id='CL_opening_leave'
                                                    value="{{ $data['CL_opening_leave'] }}" name="CL_opening_leave"
                                                    class="form-control">
                                            </div>
                                            <div class="col-md-4 form-group">
                                                <label>Total Experience</label>
                                                <input type="text" id='total_experience'
                                                    value="{{ $data['total_experience'] }}" name="total_experience"
                                                    class="form-control">
                                            </div>
                                            ...
                                            <div class="col-md-4 form-group">
                                                ...
                                                <select id='reporting_method' name="reporting_method"
                                                    class="form-control">
                                            ...
                                            <div class="col-md-4 form-group">
                                                ...
                                                <input type="text" id='branch_name'
                                                    value="{{ $data['branch_name'] }}" name="branch_name"
                                                    class="form-control">
                                            </div>
                                            ...
                                            <div class="col-md-4 form-group">
                                                <label>Amount</label>
                                                <input type="text" id='amount' value="{{ $data['amount'] }}"
                                ...
                                <div class="tab-pane p-3" id="section-linemove-6" role="tabpanel">
                                    <form
                                        action="{{ route('add_experience.store', ['id' => $data['id'] ?? 0, 'dataType' => 'experience_detail']) }}"
                                        method="POST">
                                        @csrf
                                        ...
                                        <table class="table" id="experienceDetails">
                                            ...
                                            <tbody>
                                                @forelse($experience_details ?? [] as $experience_detail)
                                                    <tr>
                                                        <td>
                                                            <input type="hidden" name="experience_detail_id[]"
                                                                value="{{ $experience_detail->id }}">
                                                            <input type="text" name="institute_name[]"
                                                                class="form-control"
                                                                value="{{ $experience_detail->institute_name }}">
                                                        </td>
                                                        <td>
                                                            <input type="text" name="designation[]"
                                                                class="form-control"
                                                                value="{{ $experience_detail->designation }}">
                                                        </td>
                                                        <td>
                                                            <input type="date" name="joining_date[]"
                                                                class="form-control"
                                                                value="{{ $experience_detail->joining_date }}">
                                                        </td>
                                                        <td>
                                                            <input type="date" name="leaving_date[]"
                                                                class="form-control"
                                                                value="{{ $experience_detail->leaving_date }}"
                                                                onchange="validateDays(this)">
                                                        </td>
                                                        <td>
                                                            <input type="text" name="experience[]"
                                                                class="form-control"
                                                                value="{{ $experience_detail->experience }}">
                                                        </td>
                                                        <td>
                                                            <input type="text" name="remarks[]" class="form-control"
                                                                value="{{ $experience_detail->remarks }}">
                                                        </td>
                                                        <td>
                                                            <button type="button" class="btn btn-danger"
                                                                onclick="deleteExperience({{ $experience_detail->id }})">
