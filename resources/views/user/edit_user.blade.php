<?php //echo '<pre> '; print_r($subjectSl); die(); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <input type="text" id='first_name'
                                       value="@if(isset($data['first_name'])){{ $data['first_name'] }}@endif" required
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <input type="text" value="@if(isset($data['user_name'])){{ $data['user_name'] }}@endif"
                            ...
                            <div class="col-md-4 form-group">
                                <label>Mobile</label>
                                <input type="text" value="@if(isset($data['mobile'])){{ $data['mobile'] }}@endif"
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <select name="subject_ids[]" id="subject_ids[]" class="form-control" multiple>
                                    ...
                                    @if(!empty($subject_data))
                                        ...
                                        @foreach($standard_data as $key => $std){
                                        @foreach($subject_data as $subj)
                                            <option
                                                value="{{$std['id'].'--'.$subj['id']}}" {{(in_array($subj['id'],$subjectSl)?'selected':'')}} >{{$std['name'].'---'.$subj['subject_name']}}</option>
                                        @endforeach
                                        @endforeach
                                    @endif
                                </select>
                                ...
                                <div class="radio-list">
                                    <label class="radio-inline p-0">
                                        <div class="radio radio-success">
                                            <input type="radio" @if(isset($data))@if("M" == $data['gender']) checked
                                    ...
                                    <label class="radio-inline">
                                        <div class="radio radio-success">
                                            <input type="radio" @if(isset($data))@if("F" == $data['gender']) checked
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <textarea class="form-control" required
                                          name="address">@if(isset($data['address'])){{ $data['address'] }}@endif</textarea>
                            </div>
                            <div class="col-md-4 form-group">
                                <label>City</label>
                                <input type="text" value="@if(isset($data['city'])){{ $data['city'] }}@endif" id='city'
                            ...
                            <div class="col-md-4 form-group">
                                <label>Pincode</label>
                                <input type="number" value="@if(isset($data['pincode'])){{$data['pincode']}}@endif"
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <input type="number" value="@if(isset($data['join_year'])){{$data['join_year']}}@endif"
                                       id='join_year' required name="join_year" class="form-control">
                            </div>
                            <div class="col-md-4 form-group">
                                <label>Password</label>
                                <input type="password"
                                       value="@if(isset($data['password'])){{ $data['password'] }}@endif" id='password'
                                            ...
                                            <select name="{{ $value['field_name'] }}" class="form-control" required
                                                ...
                                                @if(isset($data_fields[$value['id']]))
                                                    @foreach($data_fields[$value['id']] as $keyData => $valueData)
                                                        ...
                                                        @endif
                                                        <option
                                                            value="{{ $valueData['display_value'] }}" {{$selected}}> {{ $valueData['display_text'] }} </option>
                                                    @endforeach
                                                @endif
                                            </select>
