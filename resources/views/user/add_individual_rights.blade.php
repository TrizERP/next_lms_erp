                      ...
                      @if(!isset($data))
                        ...
                        <div class="row">                            
                            <div class="col-md-5 form-group">
                                ...
                                <select name="profile_id" onchange="getProfileWiseUsersData(this.value);clearCheckBoxs();" required id="profile_id" class="form-control">
                            ...
                            <div class="col-md-5 form-group">
                                <label>Users</label>
                                <select name="user_id" onchange="getIndividualRightsData(this.value);" required id="user_id" class="form-control">
                                    ...
                                    <table class="table table-bordered table-striped responsive-utilities">
                                        ...
                                        @foreach($individualmenuMaster as $key => $value)
                                            <tr style="background-color: #6cd4f3 !important;">
                                                ...
                                                <td style="text-align: center;">
                                                    <div class="checkbox checkbox-success checkbox-circle">
                                                        <input name="view[{{ $value['id'] }}][]" id="view_{{ $value['id'] }}" value="1" type="checkbox" platform="view">
                                                        <label for="view_{{ $value['id'] }}"> View </label>
                                                    </div>
                                                </td>
                                                <td style="text-align: center;">
                                                    <div class="checkbox checkbox-success checkbox-circle">
                                                        <input name="add[{{ $value['id'] }}][]" id="add_{{ $value['id'] }}" value="1" type="checkbox" platform="add">
                                                        <label for="add_{{ $value['id'] }}"> Add </label>
                                                    </div>
                                                </td>
                                                <td style="text-align: center;">
                                                    <div class="checkbox checkbox-success checkbox-circle">
                                                        <input name="edit[{{ $value['id'] }}][]" id="edit_{{ $value['id'] }}" value="1" type="checkbox" platform="edit">
                                                        <label for="edit_{{ $value['id'] }}"> Edit </label>
                                                    </div>
                                                </td>
                                                <td style="text-align: center;">
                                                    <div class="checkbox checkbox-success checkbox-circle">
                                                        <input name="delete[{{ $value['id'] }}][]" id="delete_{{ $value['id'] }}" value="1" type="checkbox" platform="delete">
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center;">
                                                    <div class="checkbox checkbox-success checkbox-circle">
                                                        <input name="view[{{ $submenuValue['id'] }}][]" id="view_{{ $submenuValue['id'] }}" value="1" type="checkbox" platform="view">
                                                        <label for="view_{{ $submenuValue['id'] }}"> View </label>
                                                    </div>
                                                </td>
                                                <td style="text-align: center;">
                                                    <div class="checkbox checkbox-success checkbox-circle">
                                                        <input name="add[{{ $submenuValue['id'] }}][]" id="add_{{ $submenuValue['id'] }}" value="1" type="checkbox" platform="add">
                                                        <label for="add_{{ $submenuValue['id'] }}"> Add </label>
                                                    </div>
                                                </td>
                                                <td style="text-align: center;">
                                                    <div class="checkbox checkbox-success checkbox-circle">
                                                        <input name="edit[{{ $submenuValue['id'] }}][]" id="edit_{{ $submenuValue['id'] }}" value="1" type="checkbox" platform="edit">
                                                        <label for="edit_{{ $submenuValue['id'] }}"> Edit </label>
                                                    </div>
                                                </td>
                                                <td style="text-align: center;">
                                                    <div class="checkbox checkbox-success checkbox-circle">
                                                        <input name="delete[{{ $submenuValue['id'] }}][]" id="delete_{{ $submenuValue['id'] }}" value="1" type="checkbox" platform="delete">
                                                        <label for="delete_{{ $submenuValue['id'] }}"> Delete </label>
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center;">
                                                    <div class="checkbox checkbox-success checkbox-circle">
                                                        <input name="view[{{ $SubsubmenuValue['id'] }}][]" id="view_{{ $SubsubmenuValue['id'] }}" value="1" type="checkbox" platform="view">
                                                        <label for="view_{{ $SubsubmenuValue['id'] }}"> View </label>
                                                    </div>
                                                </td>
                                                <td style="text-align: center;">
                                                    <div class="checkbox checkbox-success checkbox-circle">
                                                        <input name="add[{{ $SubsubmenuValue['id'] }}][]" id="add_{{ $SubsubmenuValue['id'] }}" value="1" type="checkbox" platform="add">
                                                        <label for="add_{{ $SubsubmenuValue['id'] }}"> Add </label>
                                                    </div>
                                                </td>
                                                <td style="text-align: center;">
                                                    <div class="checkbox checkbox-success checkbox-circle">
                                                        <input name="edit[{{ $SubsubmenuValue['id'] }}][]" id="edit_{{ $SubsubmenuValue['id'] }}" value="1" type="checkbox" platform="edit">
                                                        <label for="edit_{{ $SubsubmenuValue['id'] }}"> Edit </label>
                                                    </div>
                                                </td>
                                                <td style="text-align: center;">
                                                    <div class="checkbox checkbox-success checkbox-circle">
                                                        <input name="delete[{{ $SubsubmenuValue['id'] }}][]" id="delete_{{ $SubsubmenuValue['id'] }}" value="1" type="checkbox" platform="delete">
                                                        <label for="delete_{{ $SubsubmenuValue['id'] }}"> Delete </label>
                                                    </div>
                                                </td>
                                            </tr>
                                            @endforeach
