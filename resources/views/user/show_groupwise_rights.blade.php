    ...
    <div class="container-fluid">
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">Groupwise Rights</h4>
            </div>
        </div>
        <div class="card">
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-3 col-xs-3">
                    <a href="{{ route('add_groupwise_rights.create') }}" class="btn btn-info add-new">
                        <i class="fa fa-plus"></i> Manage Groupwise Rights
                    </a>
                </div>
