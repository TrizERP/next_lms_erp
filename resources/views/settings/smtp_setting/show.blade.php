            ...
            <div class="panel-body p-0">
                <div class="row">
                    <div class="col-lg-3 col-sm-3 col-xs-3 m-30">
                        <a href="{{ route('smtp_setting.create') }}" class="btn btn-info add-new"><i
                            ...
                            <table id="example" class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-inline">
                                                <a href="{{ route('smtp_setting.edit',$datas->id)}}" class="btn btn-info btn-outline"><i class="ti-pencil-alt"></i></a>
                                            </div>
