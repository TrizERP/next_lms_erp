			...
			<form action="{{ route('fees_head_type_master.index') }}" enctype="multipart/form-data">
				<div class="row">
					<div class="col-md-5 form-group">
						<label>Code</label>
						<input type="text" name="code" placeholder="Please Enter Head Code" @if(isset($data['code']))value="{{$data['code']}}"@endif class="form-control" > 
					</div>
					<div class="col-md-5 form-group">
						<label>Head Title</label>
						<input type="text" name="head_title" placeholder="Please Enter Head Title" @if(isset($data['head_title']))value="{{$data['head_title']}}"@endif class="form-control" > 
					</div>    
						...
						<table id="example" class="table table-striped">
							...
							@if(isset($data['data']))
								...
								<tr>    
									...
									<td>
										<div class="d-inline">											
											<a href="{{ route('fees_head_type_master.edit',$data->id)}}" class="btn btn-info btn-outline">
