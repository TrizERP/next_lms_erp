                            ...
                            <div class="table-responsive">
                                <table id="example" class="table table-striped">
                                    <tr style="border: 1px solid #000;">
                                        <td style="text-align: center;font-weight: inherit;border: 1px;">New Student
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
...
//                                                    $amount_val = "";
                                                ...
                                                <tr>
                                                    ...
                                                    <?php
                                                        // echo ('<pre>');print_r($data['data']['title_arr']);exit;
                                                    ...
                                                    <td style="text-align: center;font-weight: inherit;">
                                                        <input type="text" class="form-control"
                                                            value="<?php echo $amount_val; ?>"
                                                            name="<?php echo 'NewValues[' . $quota_id . '][' . $id . ']'; ?>">
                                                    </td>
                                                    <?php } ?>
                        ...
                        <div class="col-lg-12 col-sm-12 col-xs-12">
                            <div class="table-responsive">
                                <table id="example" class="table table-striped" style="margin-top:40px; ">
                                    <tr style="border: 1px solid #000;">
                                        <td style="text-align: center;font-weight: inherit;border: 1px;">Old Student
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
...
//                                                    $amount_val = 0;
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;font-weight: inherit;">
                                                        <input type="text" class="form-control"
                                                            value="<?php echo $amount_val; ?>"
                                                            name="<?php echo 'OldValues[' . $quota_id . '][' . $id . ']'; ?>">
                                                    </td>
                                                    <?php } ?>
                                                    <td class="total" style="text-align: center;font-weight: inherit;">
