                            ...
                            <div class="table-responsive col-md-12">
                                <table class="table table-stripped" border="0" width="100%">
                                            ...
                                            <table width="100%" border="0" id="fees_head">
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>{{$paid_amt}}</td>
                                                        <td>
                                                            <input type="number" min=0 max={{$paid_amt}} value={{$paid_amt}} name='refund_amount[{{$fees_title_name}}]' id='refund_amount' class='form-control' onchange="calculate_total(this.value);" data-value='refund_amount[{{$fees_title_name}}]'>
                                                        </td>                                                        
                                                    </tr>
                                                <?php 
                                                    } 
                                    ...
                                    <tr>
                                        <td>Refund Remark</td>
                                        <td>
                                            <input type="text" name="refund_remark" id="refund_remark" class="form-control">
                                        </td>
                                        <td>Payment Mode</td>
                                        <td>
                                        ...
                                        <td>Receipt Date</td>
                                        <td><input type="text" name="receiptdate" id="receiptdate" class="form-control mydatepicker" autocomplete="off"></td>
                                    </tr>
                                    <tr class="bnakDetail">
