                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            @if($value['fees_type'] == "REGULAR")
                                                <td><input id="{{$value['id']}}" value="{{$value['receipt_no']}}" name="receipt_no[]" type="checkbox"></td>
                                            @else
                                                <td>-</td>
                                            @endif
                                            ...
                                            <td><button type="button" class="btn btn-info float-right" data-toggle="modal" onclick="javascript:add_data({{$value['id']}},{{$value['student_id']}},'{{$value['receipt_no']}}');">{{$value['receipt_no']}}</button>
                                            ...
                                            @if($value['fees_type'] == "REGULAR")
                                                <td>
                                                    <select name="cancel_type[{{$value['receipt_no']}}]" class="form-control">
                                                ...
                                                <td>
                                                    <input type="text" name="cancel_remark[{{$value['receipt_no']}}]" class="form-control" placeholder="Please enter cancel remark">
                                                </td>
                                            @else
                                                <td>-</td>
                                                <td>-</td>
