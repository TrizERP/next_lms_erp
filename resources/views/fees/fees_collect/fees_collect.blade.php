                        ...
                        <div class="col-md-4 col-lg-4 col-sm-4 col-xs-4">
                            ...
                            <div class="row">
                                <div class="col-md-12 text-center mt-4">                                
                                    <button type="button" class="btn btn-info" data-toggle="modal" id="add_data" onclick="javascript:add_data(<?php echo $data['stu_data']['enrollment']?>,<?php echo $data['stu_data']['student_id']?>);">Paid History</button>
                                </div>
                            </div>
                        </div>
                                        ...
                                        foreach ($data['month_arr'] as $id => $val) {
                                            ...
                                            <td>
                                                <div class="checkbox checkbox-info">
                                                    ...
                                                    @endphp>
                                                    @if( isset($feesDetails[$val]) && $feesDetails[$val] == 0 )
                                                    <input type="hidden" name="months[<?php echo $id; ?>]" value="<?= $id ?>">
                                                    @endif
                                ...
                                <table class="table table-stripped" border="0" width="100%">
                                        ...
                                        <td colspan="5">
                                            <table width="100%" border="0" id="fees_head">
                                                ...
                                                foreach ($data['final_fee_new'] as $id => $val) {  ?>
                                                    <tr>
                                                        <td style="width: 10%"><input type="checkbox" name="" id="" <?= (isset($val['mandatory']) && $val['mandatory']) ? 'checked' : '' ?>></td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input type="text" name="fees_data[fine]" id="cheque_return_charges" class="form-control" value="@if(isset($cheque_return_charges) && $cheque_return_charges>0){{ $cheque_return_charges}};@else {{$data['cheque_return_charges'][0]}} @endif" readonly="readonly">
                                            <input type="hidden" name="hidden_cheque_return_charges" id="hidden_cheque_return_charges" class="form-control" value="@if(isset($cheque_return_charges) && $cheque_return_charges>0){{ $cheque_return_charges}};@else {{$data['cheque_return_charges'][0]}} @endif" >
                                            @else
