    ...
    <div class="container-fluid">
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">Add FrontDesk</h4> </div>
        </div>       
        <div class="card">
            <div class="row">
                ...
                <div class="col-lg-12 col-sm-12 col-xs-12">
                    <form action="{{ route('frontdesk.store') }}" enctype="multipart/form-data" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 form-group">
                                <label>Student </label>
                                <input type="text" oninput="onInput()" id='student' list="studentSearchList" name="STUDENT_ID" onkeyup="getStudents(this.value);" class="form-control" required>
                            ...
                            <div class="col-md-3 form-group">
                                <label>User </label>
                                <input type="text" id='TO_WHOM_MEET' list="userSearchList" name="TO_WHOM_MEET" class="form-control">
                            ...
                            <div class="col-md-3 form-group">
                                ...
                                <input type="file" accept="image/*" name="VISITOR_PHOTO" id="input-file-now" class="dropify" />
                            </div>
                            ...
                            <div class="col-md-3 form-group">
                                ...
                                <div class="input-group clockpicker " data-placement="bottom" data-align="top" data-autoclose="true">
                                    <input type="text" id="in_time" required="" name="IN_TIME" class="form-control" value="">
