    ...
    <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">Complaint </h4> </div>
            </div>
            ...
            <div class="card">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-3 col-xs-3">
                        <a href="{{ route('complaint.create') }}" class="btn btn-info add-new"><i class="fa fa-plus"></i> Add New Complaint</a>
                    </div>
                        ...
                        <table id="example" class="table table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th>Date</th>
                                    <th>Complaint By</th>
                                    <th>Complaint Solution</th>
                                    <th>Complaint Solution By</th>
                                    <th>Action</th>
                                </tr>
                            </thead>
                            <tbody>
