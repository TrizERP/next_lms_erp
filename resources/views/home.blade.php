...
@section('container')
    ...
    <div class="content-main flex-fill">
                    ...
                    <div class="alert alert-success alert-block">
                            ...
                            <div class="px-4 bg-dark mb-3 pb-5 rounded mt-3">
                                <div class="row">
                                    <div class="col-12 text-white pt-4 pb-5">
                                        ...
                                        <h3 class="text-white">Welcome, <span
                                                class="js-greeting">{{ Session::get('name') }}</span></h3>
                        ...
                        @else
                            @if(isset($data['school_setup_data']) && $data['school_setup_data']['expire_date'] != "")
                                <button type="submit"
                                        class="expire_button">{{$data['school_setup_data']['remaining_days']}} days left
                                    for your free trail version
                                </button>
                            @endif
                            ...
                            @if(isset($data['occupied_space_in_MB']) && $data['occupied_space_in_MB'] != "")
                                <div class="progress" style="height: 10px;background-color: rgba(0,0,0,.12);">
                                    <div class="progress-bar progress-bar-striped progress-bar-animated"
                                         role="progressbar" style="width:{{$data['used_space_in_MB']}}"
                                         aria-valuenow="{{$data['used_space_in_MB']}}" aria-valuemin="0"
                                         aria-valuemax="{{$data['occupied_space_in_MB']}}"></div>
                                </div>

                                <div class="card">
                                    <a href="{{ route('used_storage_graph.index') }}"
                                       class="js-greeting card-title">{{$data['used_space_in_MB']}}
                                        of {{$data['occupied_space_in_MB']}} MB used</a>
                                </div>
                            @endif
                                        ...
                                        @if(isset($data['totalStudent']))
                                            <div class="card">
                                                <div class="text-center card-body">
                                                    ...
                                                    <div class="text-overline mb-3 font-weight-bolder">Total Students
                                                    </div>
                                                    <div class="progress">
                                                        <div class="progress-bar bg-success" role="progressbar"
                                                             style="width: 25%"
                                                             aria-valuenow="{{$data['totalStudent']}}" aria-valuemin="0"
                                        ...
                                        @if(isset($data['totalAdmission']))
                                            <div class="card">
                                                <div class="text-center card-body">
                                                    ...
                                                    <div class="text-overline mb-3 font-weight-bolder">Admission
                                                        Inquiry
                                                    </div>
                                                    <div class="progress">
                                                        <div class="progress-bar bg-info" role="progressbar"
                                                             style="width: 78%"
                                                             aria-valuenow="{{$data['totalAdmission']}}"
                                        ...
                                        @if(isset($data['totalFees']))
                                            <div class="card">
                                                <div class="text-center card-body">
                                                    ...
                                                    <div class="text-overline mb-3 font-weight-bolder">Total Income
                                                    </div>
                                                    <div class="progress">
                                                        <div class="progress-bar bg-danger" role="progressbar"
                                                             style="width: 55%" aria-valuenow="{{$data['totalFees']}}"
                                                             aria-valuemin="0" aria-valuemax="100"></div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        @if(isset($data['totalUser']))
                                            <div class="card">
                                                <div class="text-center card-body">
                                                    ...
                                                    <div class="text-overline mb-3 font-weight-bolder">Total Employees
                                                    </div>
                                                    <div class="progress">
                                                        <div class="progress-bar bg-warning" role="progressbar"
                                                             style="width: 87%" aria-valuenow="{{$data['totalUser']}}"
                                                             aria-valuemin="0" aria-valuemax="100"></div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card h-100">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-hover">
                                                        ...
                                                        <tr>
                                                            <th>Standard Name</th>
                                                            <th data-toggle="tooltip" title="Total Admission Enquiry">
                                                                Total Admission Enquiry
                                                            </th>
                                                            <th data-toggle="tooltip" title="Total Admission Form">Total
                                                                Admission Form
                                                            </th>
                                                            <th data-toggle="tooltip"
                                                                title="Total Admission Registration">Total Admission
                                                                Registration
                                                            </th>
                                                        </tr>
                                                        </thead>
                                                        ...
                                                        @if(count($data['admissionBlock']) > 0)
                                                            @foreach($data['admissionBlock'] as $key => $value)
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a href="{{ route('admission_enquiry_report') }}"
                                                                           style="color:black;"><span>{{$value->total_enquiry}}</span></a>
                                                                    </td>
                                                                    <td>
                                                                        <a href="{{ route('admission_registration_report') }}"
                                                                           style="color:black;"><span>{{$value->total_form}}</span></a>
                                                                    </td>
                                                                    <td>
                                                                        <a href="{{ route('admission_without_con_report') }}"
                                                                           style="color:black;"><span>{{$value->total_registration}}</span></a>
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                                                        @else
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-hover">
                                                        ...
                                                        @if(count($data['smsNotificationBlock']) > 0)
                                                            <tr>
                                                                <td><a href="{{ route('send_sms_report.index') }}"
                                                                       style="color:black;"><span>{{$data['smsNotificationBlock']['Total Sms Parents']}}</span></a>
                                                                </td>
                                                                <td><a href="{{ route('send_sms_report.index') }}"
                                                                       style="color:black;"><span>{{$data['smsNotificationBlock']['Total Sms Staff']}}</span></a>
                                                                </td>
                                                                <td><a href="{{ route('send_email_report.index') }}"
                                                                       style="color:black;"><span>{{$data['smsNotificationBlock']['Total Email Parents']}}</span></a>
                                                                </td>
                                                            </tr>
                                                        @else
                                                            <tr>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-hover">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th>Total Remarks</th>
                                                            <th data-toggle="tooltip"
                                                                title="Total Circular Notification"></span>Total
                                                                Circular Notification
                                                            </th>
                                                            <th data-toggle="tooltip"
                                                                title="Total Homework Notification">Total Homework
                                                                Notification
                                                            </th>
                                                        </tr>
                                                        </thead>
                                                        ...
                                                        @if(count($data['academicBlock']) > 0)
                                                            <tr>
                                                                <td>
                                                                    <a href="{{ route('student_homework_report_index') }}"
                                                                       style="color:black;"><span>{{$data['academicBlock']['Total Homework']}}</span></a>
                                                                </td>
                                                                <td><a href="{{ route('circular.index') }}"
                                                                       style="color:black;"><span>{{$data['academicBlock']['Total Circular']}}</span></a>
                                                                </td>
                                                                <td><a href="{{ route('dicipline_report.index') }}"
                                                                       style="color:black;"><span>{{$data['academicBlock']['Total Dicipline']}}</span></a>
                                                                </td>
                                                                <td><a href="#" style="color:black;"><span>@if(isset($data['academicBlock']['Circular Notification']))
                                                                                {{$data['academicBlock']['Circular Notification']}}
                                                                            @else
                                                                                0
                                                                            @endif</span></a></td>
                                                                <td><a href="#" style="color:black;"><span>@if(isset($data['academicBlock']['Homework Notification']))
                                                                                {{$data['academicBlock']['Homework Notification']}}
                                                                            @else
                                                                                0
                                                                            @endif</span></a></td>
                                                            </tr>
                                                        ...
                                                        @if(count($data['parentCommunications']) > 0)
                                                            @foreach($data['parentCommunications'] as $key => $value)
                                                                <tr>
                                                                    ...
                                                                    <td><span>{{$value->message}} [ {{date('d-m-Y h:m:i',strtotime($value->created_at))}} ]</span>
                                                                    </td>
                                                        ...
                                                        @if(count($data['studentBirthdays']) > 0)
                                                            @foreach($data['studentBirthdays'] as $key => $value)
                                                                <tr>
                                                                    <td><span>{{$value->student_name}}</span></td>
                                                                    <td>
                                                                        <span>{{$value->standard_name}} - {{$value->division_name}}</span>
                                                                    </td>
                                                        ...
                                                        @if(count($data['calendarEvents']) > 0)
                                                            @foreach($data['calendarEvents'] as $key => $value)
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <span>{{date('d-M-Y',strtotime($value->school_date))}}</span>
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                                                        @else
        ...
        <!--  @if(Session::get('erpTour') == 0)
            //Session::get('erpTour')['dashboard']
