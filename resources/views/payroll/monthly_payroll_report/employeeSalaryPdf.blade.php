...
<table style="border-collapse: collapse;" border="1" width="100%">
    ...
    <tr>
        <td>Salary Slip of</td><td>{{$employeeData['name']}}</td>
        <td>Emp Code</td><td>{{$employeeData['emp_code']}}</td>
    </tr>
    <tr>
        <td>Designation</td><td>Accounts Assistant</td>
        <td>Date Of Joining</td><td>2021-03-08</td>
    </tr>
    <tr>
        <td>Bank A/C No</td><td>{{$employeeData['bank_no']}}</td>
        <td>Days Present</td><td>{{$employeeData['total_day']}}</td>
    </tr>
    <tr>
        <td>P. F. A/C</td><td>{{$employeeData['pf_no']}}</td>
        <td>Leave without pay</td><td>{{$employeeData['leave_without_pay']}}</td>
    </tr>
    ...
    <tr>
        <td align="center"><b>Particulars</b></td><td align="center" colspan="2"><b>Amount</b></td>
        <td align="center"><b>Particulars</b></td><td align="center"><b>Amount</b></td>
    </tr>
    <tr>
        <td></td><td align="center"><b>Actual</b></td><td align="center"><b>Current</b></td>
        <td></td><td></td>
    </tr>
    <?php
    $actualSalary = 0;
    ...
    @endforeach
    <tr>
        <td>&nbsp;&nbsp;<b>Gross Salary</b></td><td align="right"><b>{{$employeeData['total_actual_payment']}}</b></td><td align="right"><b>{{$employeeData['total_payment']}}</b></td>
        <td>&nbsp;&nbsp;<b>Total Deduction</b></td><td align="right"><b>{{$employeeData['deduction']}}</b></td>
    </tr>
    <tr>
        <td colspan="5">
            &nbsp;&nbsp;
...
</table><h4><center><font color="red">This is a computer generated payslip and does not require signature.</font><center></h4><br><br><br>
