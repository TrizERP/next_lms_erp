                    ...
                    <tbody>
                        ...
                        @if(empty($value['monthlyData']))
                            ...
                            <td>@if(isset($value['monthlyData']->total_day))
                                <a href="{{ rtrim(config('app.url'), '/') }}/monthly-payroll-report/pdf/{{ $value['id'] }}/{{ $data['selMonth'] }}/{{ $data['selYear'] }}?sub_institute_id={{ session()->get('sub_institute_id') }}" target="_blank" download class="btn btn-primary">PDF</a> 
                                @else - @endif </td>
                            @if(!isset($value['monthlyData']->total_day))
                                 <script>
