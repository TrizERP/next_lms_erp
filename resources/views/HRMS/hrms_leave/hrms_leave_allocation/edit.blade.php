    ...
    <div class="container-fluid">
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">Edit Leave Sumary for Designation</h4>
            </div>
        </div>
        ...
        <div class="card">
            ...
            {{method_field('PUT')}}
                ...
                <div class="col-md-4 form-group">
                    ...
                    <select name="leave_type_ids" id="leave_type_ids" class="form-control" required>
                        @foreach($data['leave_types'] as $key=>$value)
                        <option value="{{$key}}" {{($data['editData']->leave_type_id == $key) ? 'Selected' : ''}}>{{$value}}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="col-md-4 form-group">
                   ...
                   <input type="number" name="days" id="days" class="form-control" value="{{($data['editData']->value) ? $data['editData']->value : ''}}" required>
                </div>
