                                ...
                                <!-- END LEAVE APPLICATION --> 
                                 ...
                                 <div class="tab-pane p-3" id="section-linemove-16" role="tabpanel">
                                    ...
                                    <form action="{{ route('add_student.update', [$student_data->id]) }}" enctype="multipart/form-data" method="post">
                                        ...
                                        <div class="col-md-4 form-group">
                                        <label>Area </label>                                        
                                        <select name="values[{{$val['student_id']}}][from_stop]" id="from_stop" class="from_stop form-control" required data-studentid="{{$val['student_id']}}" disabled>
                                            <option value="">--Select--</option>
                                            @php
                                            if(isset($val['area'])){
                                        ...
                                        <div class="col-md-4 form-group">
                                            <label>Van </label>
                                            <select name="values[{{$val['student_id']}}][van-shift]" id="van-shift" data-from_bus="$val['van-shift']" class="from_bus form-control" required data-studentid="{{$val['student_id']}}" disabled>
                                            <option value="">--Select--</option>
                                            @php
