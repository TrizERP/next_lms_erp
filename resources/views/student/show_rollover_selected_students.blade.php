...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <div class="card">            
            ...
            <form action="{{ route('rollover.create') }}">  
                <div class="row" id="form_for_selected_students"> 
                    <div class="col-md-6"> 
                        <div class="col-md-12">
                            ...
                            <input type="text" id="from_institute_name" value="{{$from_institute}}" name="from_institute_name" class="form-control" readonly>
                            ...
                            <input type="hidden" id="new_tables" value="{{$tables}}" name="new_tables" class="form-control">
                            <input type="hidden" id="tblstudent_enrollment" value="{{$tblstudent_enrollment_value}}" name="tblstudent_enrollment" class="form-control">
                        </div>
                        <div class="col-md-12">
                            <label>From Current Year:</label>
                            <input type="text" id="from_current_syear" value="{{$from_current_syear}}" name="from_current_syear" class="form-control" readonly>
                        </div>              
                    ...
                    <div class="col-md-6"> 
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" id="to_next_syear" value="{{$to_next_syear}}" name="to_next_syear" class="form-control" readonly>
                        </div>              
                        <div class="col-md-12">
                            <label>To Academic Section:</label>                            
                            <select name="to_academic_section" id="to_academic_section" class="form-control" onchange="getToStandard(this.value);">
                        ...
                        <div class="col-md-12">
                            ...
                            <select name="to_standard" id="to_standard" class="form-control" onchange="getToDivision(this.value);">
                                <option value="">Select</option>
                ...
                <div class="col-sm-12 form-group mt-3">
                    <center>                            
                        <input type="submit" name="search_students" id="search_students" value="Search Students" class="btn btn-success" >
                    </center>
                </div>             
            </form> 
        </div>
        ...
        @endphp
        <div class="card">
            <span class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Green color indicates that student is already exist in next year.">
                <button class="btn btn-danger" style="pointer-events: none;" type="button" disabled="">Note</button>
            </span>               
            <form method="POST" action="{{ route('rollover.store') }}" id="submit_form_for_selected_students">
                <div class="row mt-5">                    
                        ...
                        <div class="table-responsive">
                            <table class="table table-box table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr {{$colour}}>
                                        <td>
                                            <input id="students" value="{{$data['student_id']}}" name="students[]" type="checkbox" {{$disabled}}>
                                        </td>
                                        <td>{{$j}}</td>
                    ...
                    <div class="col-md-12 form-group">
                        <center>
                        	...
                        	<input type="hidden" name="from_current_syear" @if(isset($finalData['from_current_syear'])) value="{{$finalData['from_current_syear']}}" @endif>
                            ...
                            <input type="hidden" name="to_sub_institute_id" @if(isset($finalData['from_institute_name'])) value="{{$finalData['from_institute_name']}}" @endif>                            
                            <input type="hidden" name="to_next_syear" @if(isset($finalData['to_next_syear'])) value="{{$finalData['to_next_syear']}}" @endif>                            
                            ...
                            <input type="hidden" id="new_tables" @if(isset($finalData['tables'])) value="{{$finalData['tables']}}" @endif name="new_tables"> 
                            <input type="hidden" id="tblstudent_enrollment" @if(isset($finalData['tblstudent_enrollment_value'])) value="{{$finalData['tblstudent_enrollment_value']}}" @endif name="tblstudent_enrollment">
                            <input type="submit" name="submit" value="Rollover Student" class="btn btn-success mt-3" >
                        </center>
                    </div>            
                </div>
            </form>
