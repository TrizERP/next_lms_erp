        ...
        <div class="card">
            ...
            <div class="row">                
                <div class="col-lg-12 col-sm-12 col-xs-12">
                    <form action="{{ route('student_infirmary.store') }}" enctype="multipart/form-data" method="post">    
                    {{ method_field("POST") }}
                    @csrf
                        <div class="row">                        
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <input type="text" id='medical_case_no' name="medical_case_no" class="form-control">
                            </div>
                            <div class="col-md-4 form-group">
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <input type="text" id='medical_close_date' name="medical_close_date" class="form-control mydatepicker" autocomplete="off">
                            </div>
                            <div class="col-md-4 form-group">
                                <label>Health Center </label>
                                <input type="text" id='health_center' name="health_center" class="form-control">
                            </div>
