                ...
                <div class="row">                    
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <select id='status' name="status" class="form-control" required>
                            ...
                            <option value="N" @if(isset($data['submission_status'])) @if($data['submission_status'] == 'N') selected @endif @endif>No</option>
                        </select>
                    </div>
   ...
   $(document).ready(function() {
    var table = $('#example').DataTable( {
        ...
        buttons: [ 
            ...
            { extend: 'print', text: ' PRINT', title: 'Student Homework Submission Report' }, 
            'pageLength' 
        ], 
        }); 
