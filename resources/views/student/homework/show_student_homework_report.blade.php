                ...
                <div class="row">
                    ...
                    <div class="col-md-4 form-group">
                        <select name="typewise" id="typewise" class="form-control">
                            <option value="studentwise" {{ $data['typewise'] == 'studentwise' ? 'selected' : '' }}>Student wise</option>
                            <option value="subjectwise" {{ $data['typewise'] == 'subjectwise' ? 'selected' : '' }}>Subject wise</option>
                        </select>
                    </div>
