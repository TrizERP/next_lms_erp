                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form class="d-inline" action="{{ route('custom_module_table.delete', $data->id)}}" method="post">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn btn-info btn-outline-danger"><i class="ti-trash"  onclick="return confirmDelete();"></i></button>
                                        </form>
                                        <a href="{{ url('custom-module/curd/'.$data->id)}}" class="btn btn-info">CURD</a>
                                    </td>
                                </tr>
                                @php
                                    $j++;
