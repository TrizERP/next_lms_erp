            ...
            <div class="panel-body">
                ...
                <div class="col-lg-12 col-sm-12 col-xs-12">
                    <form action="@if (isset($data['batch_data']))
                          {{ route('batch_master.update',['std_id'=>$data['batch_data']['standard_id'],'div_id'=>$data['batch_data']['division_id']])}}
                          @else
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <select class=" form-control" data-style="form-control" name="division_id" id="division_id">
                            ...
                            <div class="addButtonCheckbox">
                                <div class="row">
                                    <div class="col-md-6 col-10">
                                        ...
                                        <input type="text" id='title[NEW][]' name='title[NEW][]' @if( ! isset($data['batch_data']['titles']) ) required @endif name="title" class="form-control batchname">
                                    </div>
                                    <div class="col-md-1 col-2">
                                        <a href="javascript:void(0);" onclick="addNewRow();" class="btn btn-outline-success mt-md-4"><i class="fa fa-plus"></i></a>
                                    </div>
                                </div>
                            </div>                            
                        </div>
                        ...
                        <div class="row">                                                                                      
                            <div class="col-md-6 form-group ml-0 mr-0">                                                                                      
                                <!-- <div class="col-md-12 form-group" id="title_{{$ids_arr[$key]}}">  -->
                                    <input type="text" id='title[EDIT][{{$ids_arr[$key]}}]' value="{{$val}}" name='title[EDIT][{{$ids_arr[$key]}}]' required name="title" class="form-control batchname">
                                <!-- </div>                                                               -->
                            </div>
                            <div class="col-md-1 form-group ml-0">                            
                                <a href="javascript:void(0);" onclick="removeNewRowAjax({{$ids_arr[$key]}});"><span class="btn btn-outline-danger mt-md-2"><i class="fa fa-minus"></i></span></a>
                            </div>
                        </div>
                        </div>                        
                        <div class="clearfix"></div>
