        ...
        <div class="card">    
            <div class="panel-body">
                ...
                <div class="col-lg-3 col-sm-3 col-xs-3">
                    <a href="{{ route('batch_master.create') }}" class="btn btn-info add-new mb-4"><i class="fa fa-plus"></i> Add New</a>
                </div>
                <br><br><br>
                    ...
                    <table id="batch_list" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>    
                                ...
                                <td>
                                    <div class="d-inline">
                                        <a href="{{ route('batch_master.edit',['std_id'=>$data->standard_id,'div_id'=>$data->division_id])}}" class="btn btn-outline-success"><i class="ti-pencil-alt"></i></a>                                                                                                            
                                    </div>
                                    <form action="{{ route('batch_master.destroy', ['std_id'=>$data->standard_id,'div_id'=>$data->division_id])}}" class="d-inline" method="post">
                                    @csrf
                                    @method('DELETE')
