                        ...
                        <div class="row">                            
                            ...
                            <label>From Date</label>
                                <div class="input-daterange input-group" id="date-range">
                                    <input value="@if(isset($data['from_date'])){{ $data['from_date'] }}@endif" type="text" required class="form-control mydatepicker" placeholder="YYYY/MM/DD" name="from_date" id="from_date" autocomplete="off">
                            ...
                            <label>To Date</label>
                                <div class="input-daterange input-group" id="date-range">
                                    <input value="@if(isset($data['to_date'])){{ $data['to_date'] }}@endif" type="text" required class="form-control mydatepicker" placeholder="YYYY/MM/DD" name="to_date" id="to_date" autocomplete="off">
                                    <span class="input-group-addon"><i class="icon-calender"></i></span> 
                                </div>
                            </div>                        
                            <div class="col-md-4 form-group">
                            ...
                            <div class="col-md-12 form-group">                            
                                <center>                                    
                                    <input type="submit" name="submit" value="Submit" class="btn btn-success" onclick="return validate_dates();" >                                                    
                                </center>
                            </div>
                        </div>
                    </form>                    
                    ...
                    <div class="table-responsive">
                        ...
                        @if( isset($data['proxydata']) )
                            <table id="proxy_list" class="table table-striped">
                                ...
                                <tr>
                                    <td>
                                        <input type="checkbox" class="period" name="proxy_id['{{$val['date']}}/{{$val['timetable_id']}}']" id="proxy_id['{{$val['date']}}/{{$val['timetable_id']}}']">
                                    </td>    
                                    <td>{{$i++}}</td>
                                    <td>{{$val['date']}}</td>
                                    <td>{{$val['week_day']}}</td>
                                    ...
                                    <td>    								
                                        <select class="selectpicker form-control" name="teacher_id['{{$val['date']}}/{{$val['timetable_id']}}']" id="teacher_id['{{$val['date']}}/{{$val['timetable_id']}}']">
                                            <option value="">Select Teacher</option> 
                                ...
                                @if( count($data['proxydata']) > 0 )
                                    <tr align="center">
                                        <td colspan="10">
                                            <center>                                                
                                                <input onclick="return validate_data();" type="submit" name="Save" value="Save" class="btn btn-success" >
                                            </center>
                                        </td>
                                    </tr>
                                @else
