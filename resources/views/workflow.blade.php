                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">												 
                                                    ...
                                                    <select name="wkname" id="wkname" class="custom-select form-control required" onchange="bind_condition_field(this.value);">
														...
														<div style="display:none;" id="schedule_details" class="white-box">
															<div class="form-group">
																...
																<div id="specificdate_div">
																	...
																	<input class="datepicker" id="specific_date" name="specific_date" type="text" placeholder="mm/dd/yyyy">
