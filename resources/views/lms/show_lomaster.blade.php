...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <div class="card">  
            ...
            <div class="@if($sessionData['status_code']==1) alert alert-success alert-block @else alert alert-danger alert-block @endif ">		<button type="button" class="close" data-dismiss="alert">×</button>
                <strong>{{ $sessionData['message'] }}</strong>
            </div>
            @endif
            <div class="row">            
                <div class="col-lg-12 col-sm-3 col-xs-3">                                        
                    <a href="{{ route('lo_master.create') }}" class="btn btn-info add-new"><i class="fa fa-plus"></i> Add LO Master</a>
                </div> 
                        ...
                        <table id="subject_list" class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>    
                                    ...
                                    <td>
                                        <div class="d-inline">                                            
                                            <a href="{{ route('lo_master.edit',['id'=>$lodata->id])}}" class="btn btn-info btn-outline"><i class="ti-pencil-alt"></i></a>
                                        </div>                                        
                                        <form action="{{ route('lo_master.destroy', $lodata->id)}}" method="post" class="d-inline">
                                        @csrf
                                        @method('DELETE')
