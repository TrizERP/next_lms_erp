            ...
            <div class="card-body">
                <form action="{{route('content_master.store')}}" method="post" enctype='multipart/form-data'>
                    ...
                    <div class="mt-2 mb-4 col-md-8"> 
                        <button type="button" class="btn btn-info" data-toggle="modal" onclick="javascript:add_data();"><i class="fa fa-plus mr-2"></i>Add You Tube Video Suggestions</button>                                        
                        <input type="checkbox" id="toggle_basic_advanced" name="toggle_basic_advanced" checked data-toggle="toggle" data-on="Basic" data-off="Advanced" data-onstyle="warning" data-offstyle="danger" onchange="show_basic_advanced_div();">
                    </div>

                    <!--Modal: Add ContentSuggestionModal-->
                    <div class="modal fade right modal-scrolling" id="ContentSuggestionModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="display: none;" aria-hidden="true">
                        <div class="modal-dialog modal-xl modal-side modal-bottom-right modal-notify modal-info" role="document">
                            <!--Content-->
                            <div class="modal-content">
                                        ...
                                        <div class="panel-body">                                               
                                            <div class="row">
                                                <div class="col-md-3 form-group"> 
                                                    ...
                                                    <select id="third_party_content" name="third_party_content" class="form-control">
                                                ...
                                                <div class="col-md-3 form-group mt-4">                                                                                                                                                                    
                                                    <input type="button" id="search" name="search" value="Search" class="btn btn-success" onclick="load_content_data();" />
                                                </div> 
                                ...
                                <div class="modal-footer flex-center justify-content-center">
                                    <input type="button" id="submit" name="submit" value="Save" class="btn btn-success" onclick="get_data_link();" >
                                </div>                              
                            </div>
                            <!--/.Content-->
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-daterange input-group" id="date-range">
                                    <input type="text" class="form-control mydatepicker text-left" placeholder="dd/mm/yyyy" value="@if(isset($data->restrict_date)){{date('d-m-Y', strtotime($data->restrict_date))}}@endif" name="restrict_date" autocomplete="off">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="tags-default">
                                    <input type="text" name="meta_tags" value="LMS,ERP" data-role="tagsinput" placeholder="add tags" /> 
                                </div>                                
                            </div>
                        </div>
                        <div class="col-md-4">
