				...
				<div class="notification-box card">
					...
					<div class="row align-items-center">
						...
						<div class="col-md-3 text-md-right">
							...
							<div class="d-inline">
	                            <a class="btn btn-outline-success" href="{{ route('lmsVirtualClassroom.edit',['id'=>$virtualdata['id'],'std_id'=>$virtualdata['standard_id']])}}">
	                                <i class="ti-pencil-alt"></i>
	                            </a>                                                                                                            
	                            <form class="d-inline" action="{{ route('lmsVirtualClassroom.destroy', $virtualdata['id'] )}}" method="post">
	                                @csrf
	                                @method('DELETE')
							...
							<div class="d-inline ml-1">
								<a href="{{$virtualdata->url}}" class="btn btn-outline-dark" target="_blank">Join<i class="mdi mdi-arrow-right-bold-circle fa-fw"></i></a>
							</div> 
						</div>
					</div>
					<div class="time d-flex text-primary">
						<i class="mdi mdi-video-outline mdi-24px mr-2"><font style="color:red;">@php echo $date2->h.':'.$date2->i.' Hours Remaining'; @endphp</font></i>
					</div>					
				</div>
			@endforeach              
            @endif
