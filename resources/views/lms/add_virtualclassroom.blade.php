                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group" id="event_date_div" style="display: none;">
                                ...
                                <input type="text" class="form-control mydatepicker" placeholder="dd/mm/yyyy" value="@if(isset($data->event_date)){{date('d-m-Y', strtotime($data->event_date))}}@endif" name="event_date" autocomplete="off">
                        ...
                        <div class="col-md-4">
                            <div class="form-group" id="from_time_div" style="display: none;">
                                ...
                                <div class="input-group clockpicker " data-placement="bottom" data-align="top" data-autoclose="true">
                                    <input type="text" id='from_time' name="from_time" class="form-control" value="@if(isset($data->from_time)){{$data->from_time}}@endif">
                        ...
                        <div class="col-md-4">
                            <div class="form-group" id="to_time_div" style="display: none;">
                                <label>To Time</label>
                                <div class="input-group clockpicker " data-placement="bottom" data-align="top" data-autoclose="true">
                                    <input type="text" id='to_time' name="to_time" class="form-control" value="@if(isset($data->to_time)){{$data->to_time}}@endif">
                                    <span class="input-group-addon"><span class="glyphicon glyphicon-time"></span></span>
                                </div>
                            </div>    
                        </div>
