...
-->                    
                    ...
                    <div class="container-fluid mb-5 tab-content">
                        <div class="tab-content" id="myTabContent">
                            ...
                            @endphp
                                <div class="tab-pane fade {{$active_body_tab}}" id="{{$tab_name}}" role="tabpanel" aria-labelledby="{{$tab_name}}-tab">                                
                                <div class="row">                                                                    
                                    ...
                                    <div class="col-12 col-sm-6 col-md-6 col-lg-3 mb-3 mb-md-4">
                                        <div class="card course-box">
                                            ...
                                            <div class="d-flex align-items-start px-3 @if(!empty($booklist_data)) justify-content-between @else justify-content-end @endif">
                                                ...
                                                @endif
                                                <a target="_blank" href="{{ route('subjectwise_graph.show',['subject_id'=>$val['subject_id'],'standard_id'=>$val['standard_id'],'action'=>'subjectwise']) }}" class="d-block">
                                                    <img src="../../../admin_dep/images/graph_icon.png" height="25" class="object-cover h-25">
                                                </a>
                                            </div>
                                            ...
                                            <div class="course-name"><a href="{{ route('chapter_master.index',['standard_id'=>$val['standard_id'],'subject_id'=>$val['subject_id']]) }}">{{$val['subject_name']}}</a><div>{{$val['standard_name']}}</div></div><!-- [ {{$val['standard_name']}} ]-->
