        ...
        <div class="card">
            ...
            <div class="row">                
                <div class="col-lg-12 col-sm-12 col-xs-12">
                    ...
                    {{ route('lo_master.update',['div_id'=>$data['lomaster_data']['id']])}}
                    @else
                        ...
                        @endif  
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <select name="subject" id="subject" class="form-control" required>
                                    ...
                                    <option value="{{$value['subject_id']}}" @if(isset($data['lomaster_data']['subject_id'])) @if($data['lomaster_data']['subject_id']==$value['subject_id']) selected='selected' @endif @endif>{{$value['display_name']}}</option>
                                    @endforeach                      
                                @endif                                                        
                                </select>
                            </div>                            
                            <div class="col-md-4 form-group">
                                ...
                                <select name="chapter" id="chapter" class="form-control" required>
                                    ...
                                    @if(isset($data['lomaster_data']))
                                        ...
                                        <option value="{{$value1['id']}}" @if(isset($data['lomaster_data']['chapter_id'])) @if($data['lomaster_data']['chapter_id']==$value1['id']) selected='selected' @endif @endif>{{$value1['chapter_name']}}</option>
                                        @endforeach                      
                                    @endif                                 
                                </select>
                            </div>                             
                            <div class="col-md-4 form-group">
                                <label>Title</label>
                                <input type="text" id='title' name="title" value="@if(isset($data['lomaster_data']['title'])){{$data['lomaster_data']['title']}}@endif" class="form-control" required>
                            </div>                             
                            <div class="col-md-4 form-group">
                                <label>Short Code</label>
                                <input type="text" id='short_code' name="short_code" value="@if(isset($data['lomaster_data']['short_code'])){{$data['lomaster_data']['short_code']}}@endif" class="form-control" required>
                            </div>                             
                            <div class="col-md-4 form-group">
                                <label>Sort Order</label>
                                <input type="text" id='sort_order' name="sort_order" value="@if(isset($data['lomaster_data']['sort_order'])){{$data['lomaster_data']['sort_order']}}@endif" class="form-control">
                            </div> 
