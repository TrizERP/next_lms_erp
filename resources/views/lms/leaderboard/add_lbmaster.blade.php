                    ...
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">                                
                                ...
                                <select id="module_name" name="module_name" class="cust-select form-control" required onchange="show_div(this.value);">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="points" name="points" placeholder="Points" value="@if(isset($data['lbmaster_data']['points'])){{$data['lbmaster_data']['points']}}@endif" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">                                
                                ...
                                <select id="icon" name="icon" class="form-control fa" required>
                                    <option value="">Select</option>                                    
                                    <option value="xf091" class="fa" style="color:black;font-size:30px;" @if(isset($data['lbmaster_data']['icon'])) @if($data['lbmaster_data']['icon']=="xf091") selected='selected' @endif @endif>&#xf091; - Trophy</option>
                                    <option value="xf005" class="fa" style="color:black;font-size:30px;" @if(isset($data['lbmaster_data']['icon'])) @if($data['lbmaster_data']['icon']=="xf005") selected='selected' @endif @endif>&#xf005; - Star</option>
                                    <option value="xf089" class="fa" style="color:black;font-size:30px;" @if(isset($data['lbmaster_data']['icon'])) @if($data['lbmaster_data']['icon']=="xf089") selected='selected' @endif @endif>&#xf089; - Half Star</option>
                                    <option value="xf118" class="fa" style="color:black;font-size:30px;" @if(isset($data['lbmaster_data']['icon'])) @if($data['lbmaster_data']['icon']=="xf118") selected='selected' @endif @endif>&#xf118; - Good</option>
                                    <option value="xf165" class="fa" style="color:black;font-size:30px;" @if(isset($data['lbmaster_data']['icon'])) @if($data['lbmaster_data']['icon']=="xf165") selected='selected' @endif @endif>&#xf165; - Thumbs down</option>
                                    <option value="xf164" class="fa" style="color:black;font-size:30px;" @if(isset($data['lbmaster_data']['icon'])) @if($data['lbmaster_data']['icon']=="xf164") selected='selected' @endif @endif>&#xf164; - Thumbs up</option>
                                    <option value="xf11a" class="fa" style="color:black;font-size:30px;" @if(isset($data['lbmaster_data']['icon'])) @if($data['lbmaster_data']['icon']=="xf11a") selected='selected' @endif @endif>&#xf11a; - Bad</option>                                    
                                </select>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-2 form-group">
                            <label>Show</label><br>
                            <input type="checkbox" checked value="1" id="show_hide" name="show_hide" @if(isset($data['lbmaster_data']['status'])) @if($data['lbmaster_data']['status'] == 1) checked @endif @endif>
                        </div> 
                    </div> 
