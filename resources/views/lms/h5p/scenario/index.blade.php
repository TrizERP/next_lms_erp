...
<div id="page-wrapper">
    <div class="container-fluid mb-5">
        ...
        <div class="modern-header">
            <div class="header-content">
                ...
                <div class="header-right">
                    ...
                    <div class="header-stats">
                        <a href="{{route('scenario_based.create',['chapter_id' => $data['chapter_id'],'standard_id'=>$data['standard_id'],'subject_id'=>$data['subject_id']])}}" class="text-white">
        ...
        <div class="table-responsive">
            <table id="scenarioTable" class="table table-stripped" style="width:100%">
                <thead>
                    <tr>
                        <th>SR no</th>
                        <th>File</th>
                ...
                <tbody>
                    @if(count($data['scenarioLists']) > 0)
                    @foreach($data['scenarioLists'] as $key => $scenario)
                    <tr>
                        <td>{{ $key + 1 }}</td>
                        <td>
                        ...
                        <td>
                            ...
                            @if(!in_array(session()->get('user_profile_name'),['student','Student','STUDENT']))
                                ...
                                <form action="{{ route('scenario_based.destroy', $scenario->id)}}"
