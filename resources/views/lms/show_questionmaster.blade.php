    ...
    <div class="container-fluid">
        <div class="row bg-title align-items-center justify-content-between">
            ...
            <div class="col-md-3 mb-4 text-md-right">
                <a href="{{ route('question_master.create',['chapter_id' => $_REQUEST['chapter_id'],'topic_id' => $_REQUEST['topic_id']]) }}" class="btn btn-info add-new"><i class="fa fa-plus"></i> Add Question</a>
            </div>
        </div>
                                    ...
                                    <tr>    
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center justify-content-end">
                                                <a class="btn btn-outline-success" href="{{ route('question_master.edit',['id'=>$quesdata->id])}}">
                                                    <i class="ti-pencil-alt"></i>
                                                </a>                                                                                                                                                            
                                                <form class="d-inline" action="{{ route('question_master.destroy', $quesdata->id)}}" method="post" onsubmit="return delete_question({{$quesdata->id}});">
                                                    @csrf
                                                    @method('DELETE')
