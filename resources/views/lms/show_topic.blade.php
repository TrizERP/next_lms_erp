...
<!-- Content main Section -->
                <div class="content-main flex-fill">
                        ...
                        <div class="col-md-6">
                            ...
                            <nav aria-label="breadcrumb">
                               <ol class="breadcrumb bg-transparent p-0">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">{{$data['breadcrum_data']->chapter_name}}</li>
                                </ol>
                            </nav>
                        </div>
                                ...
                                <div class="course-lg-tab d-table mb-4">
                                    <ul class="nav nav-tabs border-0" id="lgTab" role="tablist">
                                        ...
                                        @if(strtoupper($user_profile) == 'LMS TEACHER' || strtoupper($user_profile) == 'TEACHER')
                                            ...
                                            @endphp
                                            <li class="nav-item">
                                                <a class="nav-link active" id="oer" data-toggle="tab" href="#list" role="tab" aria-controls="profile" aria-selected="true"><i class="mdi mdi-format-list-bulleted-square"></i></a>
                                            </li>
                                        @else
                                            @php
                                            ...
                                            @endphp
                                            <li class="nav-item">
                                                <a class="nav-link active" id="my_course" data-toggle="tab" href="#grid" role="tab" aria-controls="home" aria-selected="false"><i class="mdi mdi-grid-large"></i></a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" id="oer" data-toggle="tab" href="#list" role="tab" aria-controls="profile" aria-selected="true"><i class="mdi mdi-format-list-bulleted-square"></i></a>
                                            </li>
                                        @endif
                                        <li>
                                        @if($show_block == 'YES')
                                            <button type="button" class="btn btn-light" data-toggle="modal" onclick="javascript:add_data();"><i class="fa fa-plus"></i> Add New Topic</button>
                                        @endif
                                        </li>
                                    </ul>
                                </div>
                    ...
                    <div class="container-fluid mb-5">
                        <div class="tab-content" id="lgTab">
                            <!--Grid view Display -->
                            <div class="course-grid-tab tab-pane fade {{$gridview_active}}" id="grid" role="tabpanel" aria-labelledby="grid-tab">
                                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                    ...
                                    @foreach($data['topic_data'] as $topickey => $topicvalue)
                                        ...
                                        @endphp
                                        <li class="nav-item">
                                          <a class="nav-link {{$active}}" id="a{{$i}}-tab" data-toggle="pill" href="#a{{$i}}" role="tab" aria-controls="pills-home" aria-selected="{{$selected}}">{{$topicvalue->name}}</a>
                                        </li>
                                    @endforeach                                                                        
                                  ...
                                  <div class="tab-content" id="pills-tabContent">
                                    @foreach($data['topic_data'] as $topickey1 => $topicvalue1) 
                                       @php                                         
                                        ...
                                        $j++; 
                                        @endphp                                       
                                        <div class="tab-pane fade {{$active_content}}" id="a{{$j}}" role="tabpanel" aria-labelledby="a{{$j}}-tab">
                                                        ...
                                                        <div class="video-img-box">
                                                            <div class="video-img">
                                                                ...
                                                                @if($cval['file_type'] == "link")
                                                                    <center>
                                                                        <a target="_blank" href="{{$cval['filename']}}"><img src="../admin_dep/images/clickhere.jpg" style="margin-top:30px;width:100px;height:100px;" /></a>                                                            
                                                                    </center>
                                                                @else
                                                            ...
                                                            <div class="row gutter-10">                                                            
                                                                @if(isset($cval['FLASHCARD']))
                                                                    @foreach($cval['FLASHCARD'] as $fkey => $fval)
                                                                        <div class="col-md-4">
                                                                            <div style="width:100%" onclick="openModal({{$ckey}},{{$fkey}});currentSlide({{$ckey}}{{$fkey}})" class="hover-shadow cursor card py-3 px-2">{{$fval['title']}}</div>                                                                        
                                                                        </div>                                                                   
                                                                    @endforeach
                                                                @endif
                                                            </div>
                            ...
                            <div class="tab-pane fade {{$listview_active}}" id="list" role="tabpanel" aria-labelledby="list-tab">
                                ...
                                @php                                                                                               
                                    ...
                                    $j++;
                                    @endphp
                                    <div class="accordion-card collapsed card px-2 pt-2 border-0 course-box" data-toggle="collapse" href="#collapseExample{{$k}}" role="button" aria-expanded="false" aria-controls="collapseExample">     
                                        @php
                                        $blur_block_style = "";
                                        ...
                                        <div class="row align-items-center" style="{{$blur_block_style}}">
                                            ...
                                            <div class="col-md-8 mb-2 d-md-flex align-items-center justify-content-end">
                                                ...
                                                $booklist_data = DB::select("SELECT * FROM book_list
                                                                        WHERE standard_id = $list_topicvalue->standard_id AND subject_id = $list_topicvalue->subject_id AND chapter_id = $chapter_id AND topic_id = $list_topicvalue->id AND sub_institute_id = $sub_institute_id AND syear = $syear "); 
                                    ...
                                    @foreach($data['content_data'][$list_topicvalue->id] as $ckey => $cval) 
                                        ...
                                        <div class="video-box mb-2" style="{{$blur_content_style}}">
                                            ...
                                            <div class="video-img-box">
                                                <div class="video-img">                                                
                                                    <video controls="true" width="220" height="140" controlsList="nodownload"> 
                                                    ...
                                                    <div class="tab-content">
                                                        @if(isset($cval['FLASHCARD']))
                                                            ...
                                                            @foreach($cval['FLASHCARD'] as $fkey => $fval)
                                                                ...
                                                                <div class="tab-pane {{$tab_active}}" id="mySlides_{{$ckey}}{{$fkey}}" role="tabpanel">
                                                                    ...
                                                                    <div class="mySlides d-block">
                                                                        <div class="front-image w-100 card text-center"><h3>{!!$front_text!!}</h3></div>
                                                                        <div class="back-image w-100 card text-center"><h3>{!!$back_text!!}</h3></div>
                                                                    </div>
                                                                </div>
                                                            @php $f++; @endphp    
                                                            @endforeach
                                                    ...
                                                    <ul class="nav nav-tabs customtab2 border-0 mt-3" role="tablist">
                                                        ...
                                                        @if(isset($cval['FLASHCARD']))
                                                            @foreach($cval['FLASHCARD'] as $fkey => $fval)
                                                                ...
                                                                @endphp
                                                                <li class="nav-item">
                                                                    <a class="nav-link demo cursor {{$li_active}}" data-toggle="tab" href="#mySlides_{{$ckey}}{{$fkey}}" role="tab">{{$fval['title']}}</a>
                                                                </li>
                                                            @php $f++; @endphp    
                                                            @endforeach
                                                        @endif 
                                    ...
                                    <div class="accordion-card collapsed card px-2 pt-2 border-0 course-box" data-toggle="collapse" href="#collapseExample{{$k}}" role="button" aria-expanded="false" aria-controls="collapseExample">     
                                        ...
                                        <div class="row align-items-center" style="{{$blur_block_style}}">
                                            ...
                                            <div class="col-md-8 mb-2 d-md-flex align-items-center justify-content-end">
                                                ...
                                                <a target="_blank" href="{{ route('subjectwise_graph.show',['subject_id'=>$list_topicvalue->subject_id,'topic_id'=> $list_topicvalue->id,'topic_name'=>$list_topicvalue->name,'action'=>'topicwise']) }}">
                                                    <img src="../../../admin_dep/images/graph_icon.png" style="float:right;height:25px;width:25px;margin-top:-12px;margin-right:5px;">
                                                </a> 
                                                <a target="_blank" href="{{ route('lms_teacherResource.index',['standard_id'=>$list_topicvalue->standard_id,'subject_id'=>$list_topicvalue->subject_id,'chapter_id' => $_REQUEST['id'],'topic_id' => $list_topicvalue->id]) }}" class="btn btn-outline-dark  mx-1">Teacher Resource</a>
                                                <a target="_blank" href="{{ route('lms_lessonplan.index',['standard_id'=>$list_topicvalue->standard_id,'subject_id'=>$list_topicvalue->subject_id,'title'=>$lp_title]) }}" class="btn btn-outline-dark  mx-1">Lesson Planning</a>
                                                <a target="_blank" href="{{ route('lmsmapping.index',['topic_id'=>$list_topicvalue->id]) }}" class="btn btn-outline-dark  mx-1">Topic-wise Mapping</a>
                                                <a target="_blank" href="{{ route('content_master.create', ['chapter_id' => $_REQUEST['id'],'topic_id' => $list_topicvalue->id]) }}" class="btn btn-outline-dark mx-1 my-1">Add Content</a>
                                                <a target="_blank" href="{{route('question_master.index', ['chapter_id' => $_REQUEST['id'],'topic_id' => $list_topicvalue->id])}}" class="btn btn-outline-dark mx-1 my-1">Question Answer</a>
                                                <a target="_blank" href="{{ route('virtual_classroom_master.create', ['chapter_id' => $_REQUEST['id'],'topic_id' => $list_topicvalue->id]) }}" class="btn btn-outline-dark  mx-1 my-1">Virtual Classroom</a>
                                                <!-- <a target="_blank" class="btn btn-outline-dark mx-1 my-1">Flash Card</a> -->
                                                @if(strtoupper($user_profile) == 'LMS TEACHER' || strtoupper($user_profile) == 'TEACHER')
                                                <a href="javascript:edit_data('{{route('topic_master.update',$list_topicvalue->id)}}','{{$list_topicvalue->id}}','{{$list_topicvalue->name}}','{{$list_topicvalue->description}}','{{$list_topicvalue->topic_sort_order}}','{{$list_topicvalue->topic_show_hide}}');" class="btn btn-outline-success btn-sm mx-1 my-1"><i class="mdi mdi-pencil-outline"></i></a>
                                                <form action="{{ route('topic_master.destroy', $list_topicvalue->id)}}" method="post" onsubmit="return delete_topic({{$list_topicvalue->id}});">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button onclick="return confirmDelete();" type="submit" class="btn btn-outline-danger btn-sm mx-1 my-1">
                                    ...
                                    @foreach($data['content_data'][$list_topicvalue->id] as $ckey => $cval) 
                                        ...
                                        <div class="video-box mb-2" style="{{$blur_content_style}}">
                                            ...
                                            <div class="time text-secondary d-flex" style="font-size: 20px;">   
                                                ...
                                                <a href="{{ route('content_master.edit',['id'=>$cval['id'],'std_id'=>$cval['standard_id']])}}" class="btn btn-outline-success btn-sm mx-1"><i class="mdi mdi-pencil-outline"></i></a>
                                                <form action="{{ route('content_master.destroy', $cval['id'] )}}" method="post">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button onclick="return confirmDelete();" type="submit" class="btn btn-outline-danger btn-sm mx-1">
                                                    <i class="mdi mdi-delete-outline"></i></button>                                                                                                                                            
                                                </form>
                                            </div>
                                            @endif  
                ...
                <!--Modal: TopicModal-->
                <div class="modal fade right modal-scrolling" id="TopicModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="display: none;" aria-hidden="true">
                                    ...
                                    <div class="white-box">
                                        <div class="panel-body">
                                            ...
                                            <div class="col-lg-12 col-sm-12 col-xs-12">
                                                <input type="hidden" id='hidchapter_id' name='hidchapter_id' value="{{$_REQUEST['id']}}" class="form-control">                                                                                                                                                                                                                                                                 
                                                 <div class="addButtonCheckbox">                            
                                                    ...
                                                    <div class="col-md-12 form-group">
                                                        <label>Show</label><br>
                                                        <input type="checkbox" value="1" id="topic_show_hide" name="topic_show_hide[]">
                                                    </div>                  
