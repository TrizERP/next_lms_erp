                    ...
                    <div class="container-fluid mb-5">
                        <div class="tab-content" id="lgTab">
                            ...
                            <div class="course-grid-tab tab-pane fade {{$gridview_active}}" id="grid" role="tabpanel" aria-labelledby="grid-tab">
                                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                    ...
                                    @foreach($data['topic_data'] as $topickey => $topicvalue)
                                        ...
                                        @endphp
                                        <li class="nav-item">
                                            <a class="nav-link {{$active}}" id="a{{$i}}-tab" data-toggle="pill"
                                               href="#a{{$i}}" role="tab" aria-controls="pills-home"
                            ...
                            @if(strtoupper($user_profile) == 'STUDENT' && strtoupper($user_profile) != 'TEACHER' && strtoupper($user_profile) != 'LMS TEACHER')
                                <div class="tab-pane fade {{$listview_active}}" id="list" role="tabpanel"
                                                    ...
                                                    <div class="col-md-4 mb-2">
                                                        <div class="video-sec-title mb-0">
                                                            <div class="icon-box"><i
                                                                    class="mdi mdi-video-check-outline"></i></div>
                                            ...
                                            <div id="myModal_{{$ckey}}" class="modal flash-card-modal">
                                                ...
                                                <div class="modal-content">
                                                    <div class="container">
                                                        ...
                                                        <ul class="nav nav-tabs customtab2 border-0 mt-3"
                                                            role="tablist">
                                                            @php
                                                                $f = 1;
                                                            @endphp
...
=======
                                                    ...
                                                    @if(strtoupper($user_profile) == 'LMS TEACHER' || strtoupper($user_profile) == 'TEACHER')
                                                        <div class="time text-secondary d-flex"
                                                            ...
                                                            <form
                                                                action="{{ route('content_master.destroy', $cval['id'] )}}"
                                                                method="post">
                                                                @csrf
                                                                @method('DELETE')
                                                                <button onclick="return confirmDelete();" type="submit"
                                                ...
                                                <div class="col-lg-12 col-sm-12 col-xs-12">
                                                    ...
                                                    <div class="addButtonCheckbox">
                                                        <div class="col-md-12 form-group">
                                                            ...
                                                            <input type="text" id='topic_name' required
                                                                   name="topic_name[]" class="form-control">
                                                        </div>
                                                        <div class="col-md-12 form-group">
                                                        ...
                                                        <div class="col-md-12 form-group">
                                                            ...
                                                            <input type="text" id="topic_sort_order"
                                                                   name="topic_sort_order[]" class="form-control">
                                                        </div>
                                                        <div class="col-md-12 form-group">
                                                            <label>Show</label><br>
