                                ...
                                <table id="subject_list" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>    
                                            ...
                                            <td data-toggle="popover" data-content="{{$portfolio['description']}}">{{substr($portfolio['description'],0,30)}} 
                                                <span style="font-size: 28px;color: black;font-weight: bolder;">...</span></td>                                                                                                     
                                            <td>{{$portfolio['type']}}</td>                                                                                                     
                                            <td>@if($portfolio['file_name'] != ""){{$portfolio['file_name']}}@else - @endif</td>
                                            <td>{{$portfolio['created_at']}}</td>                                         
                                            <td>
                                                @if($portfolio['type'] == "coursewise")
                                                <textarea class="form-control" name="feedback[{{$portfolio['id']}}]">{{$portfolio['feedback']}}</textarea>
                                                @endif
                                            </td>                                                                                                 
                                        </tr>
                                        @endforeach
