...
<head>
    <meta charset="UTF-8" />
    <title>Admission Procedure - Hills High School</title>
...
<div style="max-width: 900px; margin: 0 auto; background: #ffffff; padding: 40px; border-radius: 14px; box-shadow: 0 4px 20px rgba(0,0,0,0.1);">
    ...
    <ul style="font-size: 15px; color: #333;">
        ...
        <li>The session duration will be approx.:
            <ul style="padding-left: 20px; margin: 0; font-family: Arial, sans-serif;">
                <li style="font-size:15px; color:#000000; margin-bottom: 8px; list-style-type: disc;">
                    STD 2 TO 5: 1 to 1&#189; hrs approx.
                </li>
                <li style="font-size:15px; color:#000000; list-style-type: disc;">
                    STD 6 TO 9: 2 to 2&#189; hrs approx.
                </li>
            </ul>
        </li>
    </ul>
    ...
    <ul style="font-size: 15px; color: #333;">
        <li>Parents interaction with the Admission Committee will be held at a specific date and time.</li>
        <li><strong>COMPULSORY FOR BOTH MOTHER &amp; FATHER TO BE PRESENT.</strong></li>
        <li>Please bring the child for the interaction.</li>
        <li>Photocopy of last year's (A.Y. 2024-25) Report Card must be submitted on the interaction day.</li>
    </ul>
    ...
    <div style="font-weight: 600; background: #fff3cd; padding: 10px; border-left: 4px solid #ffb300; border-radius: 5px; margin-top: 20px;">
        ...
        If parents or child are unable to attend any session on the allotted date/time, kindly mail at 
        <a href="mailto:admission@hillshigh.com" style="color: #1a73e8;">admission@hillshigh.com</a> to arrange an alternative schedule.
    </div>

    <p style="font-size: 15px; color: #333;">
        Selection of Shift - Morning or Noon will be allotted on a <strong>first-come, first-served</strong> basis.  
        Once seats are filled in one shift, admission will be granted in the other shift only.
    </p>
