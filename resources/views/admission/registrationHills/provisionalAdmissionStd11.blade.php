                                ...
                                <tr>
                                    <td style="text-align:center;">
                                        ...
                                        <h3
                                            ...
                                            PROVISIONAL ADMISSION (Std -11 COMMERCE & ARTS)</h3>
                                    </td>
                                </tr>
                            </table>
                                                ...
                                                <td style="padding-left: 20px;">
                                                    <table width="100%" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td
                                                                style="padding-bottom: 8px; font-size:15px; color:#000000; font-family: Arial, sans-serif;">
                                                                Fee for the year 2026-27 is <b style="color:#943634;">&#x20B9; 87,000/-*</b></td>
                                                        </tr>
                                                        <tr>
                                                            <td style="vertical-align: top; width: 25px;">2)</td>
                                                            <td
                                            ...
                                            <tr>
                                                <td style="padding:15px;">
                                                    <p style="margin:0; font-size:15px; font-family: Arial, sans-serif;">
                                                        You are required to pay provisional fees of <b style="color:#943634;">&#x20B9; 29,000/-</b> at the school office by <b>NEFT / Demand Draft payable to "Hills High School".</b> 
                                                    </p>
