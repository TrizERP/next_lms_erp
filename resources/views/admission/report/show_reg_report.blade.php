    ...
    <div class="container-fluid">
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">Admission Without Confirmation Report</h4> 
            </div>
        </div>
        <div class="card">
            ...
            @endif                    
            <form action="{{ route('admission_without_con_report') }}" enctype="multipart/form-data" method="post">
                {{ method_field("POST") }}
                @csrf
                <div class="row">                    
                    ...
                    <div class="col-md-12">
                        ...
                        <!-- <div class="right-side-toggle filter-button waves-effect waves-light"><span class="mdi mdi-tune"></span></div>    -->
                    </div>
                        ...
                        <table id="example" class="table table-striped">
                            ...
                            <tbody>
                            	@foreach($data['data'] as $key => $value)
                                    <tr>    
                                        @foreach($data['headers'] as $hkey => $header)
                                        @if($header == 'cheque_date' || $header == 'followup_date' || $header == 'created_on')
