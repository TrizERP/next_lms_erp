...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">Admission Registration Receipt</h4>
            </div>
        </div>
        <div class="card">
            <div id="printableArea" class="row">
                <div class="col-lg-12 col-sm-12 col-xs-12">
                    ...
                    ?>
                            <table width="100%">
                                <tr>
                                    <td style="width:50%"><?php echo $data['data']; ?></td>
                                    <td style="width:50%;"><?php echo $data['data']; ?></td>
                                </tr>
                            </table>
                    <?php
    ...
    <center>
        <input type="button" onclick="PrintDiv('printableArea')" value="Print Receipt" class="btn btn-success" />
    </center>
</div>
...
<script>
    function PrintDiv(divName) {
        ...
        popupWin.document.write('<body onload="window.print()">' + divToPrint.innerHTML + '</page></html>');
