                    ...
                    <div class="d-xl-flex d-md-block d-flex flex-wrap align-items-center justify-content-between">
                        ...
                        <div class="dropdown user-dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right mt-3" aria-labelledby="dropdownMenuButton">
                                ...
                                <a class="dropdown-item" href="{{route('change_password.index')}}"><i class="mdi mdi-settings"></i> Change Password</a>
                                ...
                                <a class="dropdown-item" href="{{route('manage_institute.index')}}"><i class="mdi mdi-home-city"></i> Manage Institute</a>
                                @endif
