...
<footer class="footer text-center"> {{ date('Y') }} &copy; Triz Innovation PVT LTD. <a href="{{ route('siteMap') }}">
        Site Map </a> </footer>
                                ...
                                <form class="m-0 p-0 pt-4" action="" method="POST" autocomplete="off">
                                    ...
                                    <div class="row m-0 p-0">
                                        <div class="col-9 m-0 p-1">
                                            <input id="text" class="mw-100 border rounded form-control mb-0"
                                                type="text" name="text" title="Type a message..."
    ...
    $(document).ready(function() {
        ...
        $('.mydatepicker').each(function() {
            ...
            if (selected_date != "" && selected_date != "0000-00-00") {
                ...
                // alert(soni);
                formatted_date = ("0" + (soni.getDate())).slice(-2) + "-" + ("0" + (soni.getMonth() +
                    1)).slice(-2) + "-" + soni.getFullYear();
