                    ...
                    <div class="purple-heading">
                        ...
                        @elseif(!isset($data['confirm']))
                         <form class="form-horizontal new-lg-form" id="loginform" method="POST" action="@if(isset($data['user_type']) && $data['user_type'] == 'Student') {{ route('NewLMS_signup_student') }} @else {{ route('NewLMS_signup') }} @endif
                                ">
                        @else
                            <form class="form-horizontal new-lg-form" id="loginform" method="POST" action="{{route('preload-institute')}}">
                        @endif
                         @csrf
                        <div class="form-group">
                            ...
                            <div class="selct-user-box d-flex align-items-center">
                                <div class="sign-up-radio-design">
                                    ...
                                    <input type="radio" class="form-radio-input" name="user_type" id="exampleRadios1" value="Admin" onclick="show_hide_block(this.value);" required @if(isset($data['user_type']) && $data['user_type'] == 'Admin')
                                                checked @endif>
<!--class="d-none imgbgchk"-->
                        ...
                        @if(isset($data['mobile']))
                        <input type="hidden" name="institute_name_confirm" value="@if(isset($data['institute_name'])){{$data['institute_name']}} @endif">
                        @endif
                        <div class="form-row align-items-center">
                            <div class="col">
                                <div class="form-group">
                                    <label for="text">First Name <span class="red">*</span></label>
                                    <input type="text" class="form-control" name="first_name" placeholder="First Name" value="@if(isset($data['first_name'])){{$data['first_name']}} @endif" required>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="last_name" placeholder="Last Name" value="@if(isset($data['last_name'])){{$data['last_name']}} @endif" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="email">Email Address <span class="red">*</span></label>
                            <input type="email" class="form-control" name="email" placeholder="Email Address" value="@if(isset($data['email'])){{$data['email']}} @endif"  required>
                        </div>
                          ...
                          <div class="radio-list">
                              <label class="radio-inline p-0">
                                  <div class="radio radio-success">
                                      <input type="radio" name="gender" id="male" value="M" @if(isset($data['gender']) && $data['gender'] == 'M')
                              ...
                              <label class="radio-inline">
                                  <div class="radio radio-success">
                                      <input type="radio" name="gender" id="female" value="F"  @if(isset($data['gender']) && $data['gender'] == 'F')
                                                checked @endif required>
                              ...
                              <label class="radio-inline">
                                  <div class="radio radio-success">
                                      <input type="radio" name="gender" id="other" value="O"  @if(isset($data['gender']) && $data['gender'] == 'O')
                                                checked @endif required>
                      ...
                      <div class="form-group  m-t-10">
                        <div class="col-xs-12">
                          <label>Birth Date<span style="color: red;font-size: large;">*</span></label>
                           <input type="text" id='birthdate' required name="birthdate" class="form-control mydatepicker" autocomplete="off" placeholder="Enter Birthdate" value="@if(isset($data['birthdate'])){{$data['birthdate']}} @endif">
                        </div>
                      </div>
                      <div class="form-group  m-t-10" id="institute_name_div">
                        ...
                        <div class="form-group">
                            ...
                            <div class="mobile-number-field">
                                ...
                                <input type="tel" class="form-control" name="mobile" placeholder="Mobile Number" value="@if(isset($data['mobile'])){{$data['mobile']}} @endif" required autocomplete="off">
                            </div>
                        </div>
                        ...
                        <div class="form-group otp-feild" id="otp_feild">
                            <label class="d-flex align-items-center justify-content-between">
                                ...
                                <input type="hidden" name="otp" class="form-control text-center otp-input" placeholder="0" id="otp" required>

                            </label>
                            <div class="otp-number d-flex align-items-center justify-content-between">
                                <input type="number" class="form-control text-center otp-input" placeholder="0" id="otpval" maxlength="1" oninput="handleDigitInput(event, 1)" required>
                                <input type="number" class="form-control text-center otp-input" placeholder="0" id="otpval" maxlength="1" oninput="handleDigitInput(event, 2)" required>
                                <input type="number" class="form-control text-center otp-input" placeholder="0" id="otpval" maxlength="1" oninput="handleDigitInput(event, 3)" required>
                                <input type="number" class="form-control text-center otp-input" placeholder="0" id="otpval" maxlength="1" oninput="handleDigitInput(event, 4)" required>
                                <input type="number" class="form-control text-center otp-input" placeholder="0" id="otpval" maxlength="1" oninput="handleDigitInput(event, 5)" required>
                                <input type="number" class="form-control text-center otp-input" placeholder="0" id="otpval" maxlength="1" oninput="handleDigitInput(event, 6)" required>
                            </div>
                            <div>
                                <!-- 664810 -->
                            </div  id="otp-result">
                            <div class="otp-bottom d-flex align-items-center justify-content-between ">
                                <span class="success-text d-flex align-items-center">We have sent you OTP to your email address</span>
                                <a href="#">Resend OTP</a>
                            </div>
                        </div>
                         @endif
                        ...
                        <button type="submit" class="purple-btn w-100 ">Sign up</button>
                         @elseif(!isset($data['confirm']))
                        <button type="submit" class="purple-btn w-100 " onclick="signup(this.value);">Send OTP</button>
                         @endif
                        
                        <div class="form-bottom-text mb-2">Already have an account? <a href="{{route('login')}}">Log in</a></div>
                        ...
                        <div class="sign-up-success">
                         ...
                         @if(isset($data['confirm']))
                            <div class="preference-details">
                                ...
                                <button class="purple-btn p-19" name="institute_btn">Use Your Institute Data</button>
                              </div>
                            </div>
                        @endif
                        </div>
