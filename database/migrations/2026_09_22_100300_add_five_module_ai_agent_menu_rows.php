...
/**
 * The menu rows the five new `agents.<module>` rights are stored against, plus the same
 ...
 * 2026_09_21_100300 for Admission and Student. This is the sibling for the five modules
 * that now have an AI Stack of their own.
 *
 ...
 * `ai_agents.fees` carries are that decision. Leaving these five ungranted would reproduce
 * the original complaint five modules over, with screens that name a right nobody holds.
 *
 ...
 *
 *   php artisan migrate --path=database/migrations/2026_09_22_100300_add_five_module_ai_agent_menu_rows.php
 */
return new class extends Migration
{
     ...
     * for as `agents.<ai_modules key>`. Sort orders continue from 4, which
     * `ai_agents.students` holds.
     */
    private const CHILDREN = [
        'ai_agents.exam' => ['Exam', 'mdi mdi-clipboard-text-outline', 5],
        'ai_agents.ptm' => ['PTM', 'mdi mdi-calendar-account-outline', 6],
        'ai_agents.hostel' => ['Hostel', 'mdi mdi-bed-outline', 7],
        'ai_agents.student_request' => ['Student request', 'mdi mdi-file-question-outline', 8],
        'ai_agents.circular' => ['Circular', 'mdi mdi-bullhorn-outline', 9],
    ];
    ...
    public function down(): void
    {
        ...
        // Only the five rows this migration introduced. `ai_agents` and its Fees,
