...
return new class extends Migration {
    ...
    public function up()
    {
        Schema::create('admission_enquiry', function (Blueprint $table) {
            ...
            $table->string('mobile_number_father')->nullable();
            $table->string('mobile_number_mother')->nullable();
            ...
            $table->string('fees_amount', 50)->nullable();
            $table->text('fees_remark')->nullable();
