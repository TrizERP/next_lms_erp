    ...
    'h5p_types' => [
        'interactive_video' => [
            ...
            'implementation' => [
                ...
                'module_category' => 'Teaching Content',
        ...
        'course_presentation' => [
            ...
            'implementation' => [
                'status' => 'native',
                'source_table' => 'h5p_course_presentation',
                'child_table' => 'h5p_presentation_slides',
                'child_foreign_key' => 'presentation_id',
                'child_label' => 'slide',
                'columns' => [
                    'id' => 'id',
                    'title' => 'title',
                ...
                'route' => 'h5p_course_presentation.index',
                'module_title' => 'Course Presentation',
                'module_description' => 'Interactive slide-based learning presentations with multimedia and questions.',
                'module_category' => 'Teaching Content',
        ...
        'fill_in_the_blanks' => [
            ...
            'implementation' => [
                'status' => 'native',
                'source_table' => 'h5p_text_activity',
                // Drag the Words, Fill in the Blanks and Mark the Words share
                // one table because H5P itself stores all three the same way:
                // one passage carrying inline `*answer*` markup. `where` is
                // what keeps each type's inventory, counts and node reads its
                // own -- see H5PContentRepository::baseQuery().
                'where' => ['content_type' => 'fill_in_the_blanks'],
                'child_table' => 'h5p_text_activity_blanks',
                'child_foreign_key' => 'text_activity_id',
                'child_label' => 'blank',
                'columns' => [
                    'id' => 'id',
                    'title' => 'title',
                ...
                'route' => 'h5p_blanks.index',
                'module_title' => 'Fill in the Blanks',
                'module_category' => 'Assessment',
                'module_description' => 'Learners type the correct answers into missing blanks.',
                'icon' => 'mdi mdi-form-textbox',
                'sort_order' => 7,
                'h5p_library' => 'H5P.Blanks',
                'category' => 'assessment',
        ...
        'drag_text' => [
            ...
            'description' => 'Drag words into the blanks they belong in within a sentence or paragraph.',
            'pal_use_cases' => ['Practice L2-L3', 'Language grammar and syntax', 'Science term placement'],
            'bloom_from' => 'understand',
            'bloom_to' => 'apply',
            'xapi_events' => ['answered', 'completed'],
            'fluency_trackable' => 'yes',
            ...
            'implementation' => [
                ...
                'route' => 'h5p_drag_text.index',
                'module_title' => 'Drag the Words',
                'module_category' => 'Assessment',
                'module_description' => 'Learners drag words into the correct blanks within a sentence or paragraph.',
                'icon' => 'mdi mdi-cursor-move',
                'sort_order' => 6,
                'h5p_library' => 'H5P.DragText',
                'category' => 'assessment',
                'supports_package_exchange' => true,
            ],
        ],
        ...
        'memory_game' => [
            ...
            'implementation' => [
                'status' => 'native',
                'source_table' => 'h5p_memory_game',
                'child_table' => 'h5p_memory_game_cards',
                'child_foreign_key' => 'memory_game_id',
                'child_label' => 'pair',
                'columns' => [
                    'id' => 'id',
                    'title' => 'title',
                ...
                'route' => 'h5p_memory_game.index',
                'module_title' => 'Memory Game',
                'module_description' => 'Match pairs of cards to improve memory and recall.',
                'module_category' => 'Assessment',
                'icon' => 'mdi mdi-cards',
                'sort_order' => 10,
            ],
        ...
        'image_hotspot' => [
            ...
            'implementation' => [
                ...
                'module_category' => 'Interactive Content',
        ...
        'image_hotspots' => [
            ...
            'description' => 'Create interactive images with clickable hotspots.',
            'pal_use_cases' => ['Art Integrated', 'Science labelling', 'Map and diagram reading', 'Sports technique analysis'],
            'bloom_from' => 'understand',
            'bloom_to' => 'analyze',
            'xapi_events' => ['answered', 'completed', 'progressed'],
            'fluency_trackable' => 'partial',
            'engagement_weight' => 1.15,
            'social_mode' => 'individual',
            'gamification_potential' => 'medium',
            'retry_allowed' => true,
            'offline_compatible' => true,
            ...
            'implementation' => [
                'status' => 'native',
                'source_table' => 'h5p_image_hotspots',
                'child_table' => 'h5p_image_hotspot_points',
                'child_foreign_key' => 'image_hotspots_id',
                'child_label' => 'hotspot',
                'columns' => [
                    'id' => 'id',
                    'title' => 'title',
                ...
                'route' => 'h5p_image_hotspots.index',
                'module_title' => 'Image Hotspots',
                'module_description' => 'Create interactive images with clickable hotspots.',
                'module_category' => 'Interactive Content',
        ...
        'mark_the_words' => [
            ...
            'implementation' => [
                ...
                'route' => 'h5p_mark_the_words.index',
                'module_title' => 'Mark the Words',
                'module_category' => 'Assessment',
                'module_description' => 'Learners identify and mark the correct words within a text passage.',
                'icon' => 'mdi mdi-format-color-highlight',
                'sort_order' => 8,
                'h5p_library' => 'H5P.MarkTheWords',
                'category' => 'assessment',
                'supports_package_exchange' => true,
            ],
        ],
        'arithmetic_quiz' => [
            ...
            'implementation' => [
                'status' => 'native',
                'source_table' => 'h5p_arithmetic_quiz',
                'columns' => [
                    'id' => 'id',
                    'title' => 'title',
                    'body' => 'description',
                ...
                'route' => 'h5p_arithmetic_quiz.index',
                'module_title' => 'Arithmetic Quiz',
                'module_description' => 'Automatically generated arithmetic questions for learner practice.',
                'module_category' => 'Assessment',
    ...
    */
    'pedagogy_tags' => [
        ...
        'activity_based' => [
            ...
            // Drag the Words sits with Drag and Drop and Mark the Words rather
            // than with the typed practice formats below: all three are direct
            // manipulation of things already on the page, which is what this
            // pedagogy is. Without a line here its nodes derive no pedagogy at
            // all and drop out of the §9 coverage matrix -- `pal:h5p-registry-sync
            // --verify` reports exactly that, and reported it for this type.
            'primary_h5p' => ['drag_and_drop', 'drag_text', 'mark_the_words', 'find_the_hotspot'],
