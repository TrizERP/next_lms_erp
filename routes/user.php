...
Route::GET('ajax_groupwiserights', [tblgroupwise_rightsController::class, 'displayGroupwiseRights'])->name('ajax_groupwiserights');
Route::GET('ajax_pasteducation', [tbluserPastEducationController::class, 'addUpdateUserPastEducation'])->name('ajax_pasteducation');
Route::resource('add_individual_rights', tblindividual_rightsController::class);
Route::GET('ajax_profileWiseUsers', [tblindividual_rightsController::Class, 'profileWiseUsers'])->name('ajax_profileWiseUsers');
Route::GET('ajax_individualrights', [tblindividual_rightsController::class, 'displayIndividualRights'])->name('ajax_individualrights');
});
