...
use App\Http\Controllers\fees\online_fees\receipt_reprint_api_controller;
use App\Http\Controllers\fees\online_fees\online_payments_api_controller;
use App\Http\Controllers\fees\online_fees\reconciliation_status_api_controller;
use App\Http\Controllers\fees\fees_audit_log_api_controller;
...
Route::group(['prefix' => 'fees', 'middleware' => ['session', 'menu', 'logRoute','check_permissions']], function () {
    ...
    Route::get('receipt/reprint', [receipt_reprint_api_controller::class, 'reprint'])->middleware('api.session');
    Route::get('online_payments', [online_payments_api_controller::class, 'index'])->middleware('api.session');
    Route::get('online_payments/{id}', [online_payments_api_controller::class, 'show'])->middleware('api.session');
    Route::get('audit_logs', [fees_audit_log_api_controller::class, 'index'])->middleware('api.session');
    Route::get('reconciliation/status', [reconciliation_status_api_controller::class, 'index'])->middleware('api.session');
