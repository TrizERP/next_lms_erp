...
<?php if(!empty($loginpage_favicon)): ?>
  <link rel="icon" type="image/png" sizes="16x16" href=<?php echo e($loginpage_favicon); ?> >
<?php else: ?>             
  <link rel="icon" type="image/png" sizes="16x16" href="../admin_dep/images/icon.png">
<?php endif; ?>
<title>TRIZ-ERP || LOGIN</title>
<!-- Bootstrap Core CSS -->
<!-- <link href="<?php echo e(asset("admin_dep/bootstrap/dist/css/bootstrap.min.css")); ?>" rel="stylesheet"> -->
<!-- animation CSS -->
<!-- <link href="<?php echo e(asset("admin_dep/css/animate.css")); ?>" rel="stylesheet"> -->
<!-- Custom CSS -->
<!-- <link href="<?php echo e(asset("admin_dep/css/style.css")); ?>" rel="stylesheet"> -->
<!-- <link href="<?php echo e(asset("admin_dep/css/triz-style.css")); ?>" rel="stylesheet"> -->
<!-- color CSS -->
<!-- <link href="<?php echo e(asset("admin_dep/css/colors/default.css")); ?>" id="theme"  rel="stylesheet"> -->
<link href="<?php echo e(asset("/admin_dep/css/colors/default.css")); ?>" id="theme" rel="stylesheet">
<link href="<?php echo e(asset("/admin_dep/css/fontawesome.css")); ?>" rel="stylesheet">
<link href="<?php echo e(asset("/admin_dep/css/bootstrap.css")); ?>" rel="stylesheet">
<link href="<?php echo e(asset("/admin_dep/css/bootstrap-select.css")); ?>" rel="stylesheet">
<link href="<?php echo e(asset("/admin_dep/css/docs.css")); ?>" rel="stylesheet">
<link href="<?php echo e(asset("/admin_dep/css/css3.css")); ?>" rel="stylesheet">
<link href="<?php echo e(asset("/admin_dep/css/materialdesignicons.min.css")); ?>" rel="stylesheet">
<link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
<link href="<?php echo e(asset("/admin_dep/css/elements.css")); ?>" rel="stylesheet">
<link href="<?php echo e(asset("/admin_dep/css/style.css")); ?>" rel="stylesheet">
...
<section id="wrapper" class="new-login-register container-fluid">
  <div class="row">
    ...
    <div class="col-md-6">
      <?php if(!empty($loginpage_backgrond)): ?>
          <div class="lg-info-panel h-100 d-flex align-items-center p-3" style="background:url(<?php echo e($loginpage_backgrond); ?>) center;">
      <?php else: ?>
      ...
      <?php endif; ?> 
          <div class="inner-panel">
            <!--<a href="javascript:void(0)" class="p-20 di"><img src="<?php echo e(asset("admin_dep/images/icon.png")); ?>"></a>-->
            <div class="lg-content">
                <?php if(!empty($loginpage_logo)): ?>
                    <?php echo $loginpage_logo; ?>
                ...
                <?php if(!empty($loginpage_title)): ?>
                  <?php echo $loginpage_title; ?>

                <?php else: ?>
                  <h2 class="text-light">Triz Institute of Maximize Learning</h2>                
                <?php endif; ?> 

                <?php if(!empty($loginpage_description)): ?>
                  <?php echo $loginpage_description; ?>
            ...
            <form class="form-horizontal new-lg-form" id="loginform" method="POST" action="/login">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <img src="<?php echo e(asset('captcha/captcha.php')); ?>" width="100%"/>
              ...
              <div class="form-group m-b-0">
                <div class="col-sm-12 text-center h4">
                  <p>Not a member? <a href="<?php echo e(route('signup')); ?>" class="text-primary m-l-5"><b>Signup now</b></a></p>
                </div>
              </div>
              <!-- <div class="row">
...
<script src="<?php echo e(asset("admin_dep/bootstrap/dist/js/bootstrap.min.js")); ?>"></script>
<!-- Menu Plugin JavaScript -->
<script src="<?php echo e(asset("plugins/bower_components/sidebar-nav/dist/sidebar-nav.min.js")); ?>"></script>

<!--slimscroll JavaScript -->
<script src="<?php echo e(asset("admin_dep/js/jquery.slimscroll.js")); ?>"></script>
<!--Wave Effects -->
<script src="<?php echo e(asset("admin_dep/js/waves.js")); ?>"></script>
<!-- Custom Theme JavaScript -->
<script src="<?php echo e(asset("admin_dep/js/custom.min.js")); ?>"></script>
<!--Style Switcher -->
...
<?php /**PATH /var/www/html/triz_erp/resources/views/login.blade.php ENDPATH**/ ?>