...
class map_route_stop_controller extends Controller {
    ...
    public function index(Request $request) {
        ...
        return \App\Helpers\is_mobile($type, "transportation/map_route_stop/show", $school_data, "view");
    }
    ...
    public function getData() {
        $data = map_route_stop::
                ...
                ->select(
                        'transport_stop.stop_name', 'transport_route_stop.id', 'transport_route.route_name',
    ...
    public function create(Request $request) {
        ...
        return \App\Helpers\is_mobile($type, 'transportation/map_route_stop/add', $dataStore, "view");
    }
    ...
    public function store(Request $request) {
        ...
        $type = $request->input('type');
        return \App\Helpers\is_mobile($type, "map_route_stop.index", $res, "redirect");
    }
    ...
    public function edit(Request $request, $id) {
        ...
        return \App\Helpers\is_mobile($type, "transportation/map_route_stop/edit", $data, "view");
    }
