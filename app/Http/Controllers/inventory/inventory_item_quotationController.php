   ...
   public function index(Request $request)
    {        
        ...
        $data = DB::table('inventory_item_quotation_details')
            ...
            ->select('inventory_item_quotation_details.*', 'inventory_item_master.title as item_id','inventory_vendor_master.vendor_name as vendor_id','inventory_requisition_status_master.title as approved_status','tbluser.first_name','tbluser.middle_name','tbluser.last_name')
        ...
        return \App\Helpers\is_mobile($type, "inventory/show_inventory_item_quotation", $item_data, "view");
    ...
    public function create(Request $request) 
    {
        ...
        $itemdata = inventory_item_masterModel::where(['sub_institute_id'=>$sub_institute_id,'syear'=>$syear])->get()->toArray();
    ...
    public function store(Request $request) 
    {
        ...
        $type = $request->input('type');
        return \App\Helpers\is_mobile($type, "add_inventory_item_quotation.index", $message, "redirect");
    ...
    {          
        ...
        $editdata1 = inventory_item_masterModel::where(['sub_institute_id' => $sub_institute_id,'syear' => $syear])->get();
