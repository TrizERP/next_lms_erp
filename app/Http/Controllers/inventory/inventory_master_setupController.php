...
{   
    public function index(Request $request)
    {
        ...
        return \App\Helpers\is_mobile($type, "inventory/show_inventory_master_setup", $inventory_data, "view");
   ...
   public function create(Request $request) {
    ...
    public function store(Request $request) {
       ...
       // $message['id'] = $inventory_id;
        ...
        $type = $request->input('type');
        return \App\Helpers\is_mobile($type, "add_inventory_master_setup.index", $message, "redirect");
    ...
    {  
        ...
        return \App\Helpers\is_mobile($type, "inventory/add_inventory_master_setup", $data, "view");
    }
