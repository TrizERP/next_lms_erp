...
class inventory_vendor_masterController extends Controller
{
    ...
    {        
        ...
        return \App\Helpers\is_mobile($type, "inventory/show_inventory_vendor_master", $item_data, "view");
    ...
    public function store(Request $request) {
        ...
        $type = $request->input('type');
        return \App\Helpers\is_mobile($type, "add_inventory_vendor_master.index", $message, "redirect");
    ...
    {  
        ...
        return \App\Helpers\is_mobile($type, "inventory/add_inventory_vendor_master", $data, "view");
    }
