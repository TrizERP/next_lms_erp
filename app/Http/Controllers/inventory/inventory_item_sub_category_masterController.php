...
class inventory_item_sub_category_masterController extends Controller
{
    public function index(Request $request)
    {
       ...
       // $syear = $request->session()->get('syear');
        ...
        $sub_category = DB::table('inventory_item_sub_category_master')
            ->join('inventory_item_category_master', 'inventory_item_sub_category_master.category_id', '=', 'inventory_item_category_master.id')
            ...
            //,'inventory_item_sub_category_master.syear' =>$syear]
        ...
        return \App\Helpers\is_mobile($type, "inventory/show_inventory_item_sub_category", $sub_category_data, "view");
    ...
    public function store(Request $request) {
        ...
        $type = $request->input('type');
        return \App\Helpers\is_mobile($type, "add_inventory_item_sub_category_master.index", $message, "redirect");
