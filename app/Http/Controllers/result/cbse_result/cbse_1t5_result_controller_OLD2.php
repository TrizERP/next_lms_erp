...
// exit;
    ...
    {
        $str = 'SELECT e.title,em.ExamTitle,IF((e.con_point IS NULL) OR (e.con_point = ""),e.points,e.con_point) AS points ,em.Id
                ...
                foreach ($all_exam as $exam_id => $exam_detail) {
                    ...
                    if (count($all_exam) - 1 != $exam_id) {
                        ...
                        if (isset($marks_arr[$arr_student['student_id']][$subject][$exam_detail['title']])) {
                            ...
                            // $title= $marks_arr[$arr_student['student_id']][$subject][$exam_detail['title']];
                            // foreach($title as $t){
                        ...
                        // }
                        // $r = count(array(array_get($title,"Periodic Test")));
                        ...
                        if ($abFlag == 1) {
                            ...
                            $e_points = number_format($obtained_marks, 2);
                        }
                        // }
