...
class studentTransferController extends Controller
{
    ...
    $student_id = $request->student_id;
        if(!isset($type)){
            ...
            ->selectRaw('tsd.student_id,YEAR(tsd.created_on) as year,CONCAT_WS("",COALESCE(ts.first_name,"-"),COALESCE(ts.middle_name,"-"),COALESCE(ts.last_name,"-")) AS student_name,tsd.document_title,CONCAT("'.$server.'public/student_document/",tsd.file_name) file_name')
