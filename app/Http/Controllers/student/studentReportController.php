...
class studentReportController extends Controller
{
    ...
    public function searchStudent(Request $request)
    {
        ...
        $array = array('standard.name as standard','division.name as division','academic_section.title as grade','tblstudent.id as id');
        ...
        if($request->input('dynamicFields') == '')
        {
            ...
            $searchArr1 = array('enrollment_no','first_name','last_name');
            $replaceArr1 = array('Gr No','First Name','Surname');
