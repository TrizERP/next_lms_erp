...
class studentQuotaController extends Controller
{
    ...
    {   
        ...
        $get_sort_order = DB::select("SELECT (IFNULL(MAX(CAST(s.sort_order AS INT)),0) + 1) AS max_sort_order
                                    FROM student_quota s
    ...
    public function updateData(Request $request)
    {
        ...
        $data = studentQuotaModel::where(['id'=>$id])->update($finalArray);
        return $data;       
    }
}
