...
class bulkStudentController extends Controller {
    ...
    public function searchStudent(Request $request) {
        ...
        $array = array('tblstudent_enrollment.standard_id as standard', 'tblstudent_enrollment.section_id as division', 'tblstudent_enrollment.grade_id as grade', 'tblstudent.id as id');
        //$header = array('student_name' => 'Student Name');
        $header = array('standard' => 'Standard','division' => 'Division','grade' => 'Academic Section','student_name' => 'Student Name');
        $searchArr = array('_');
        $replaceArr = array(' ');
        ...
        $student_quota = tblstudentQuotaModel::where('sub_institute_id',$sub_institute_id)->pluck("title", "id")->toArray();
        ...
        $fieldsData['gender'] = array('F'=>'F','M'=>'M');       
