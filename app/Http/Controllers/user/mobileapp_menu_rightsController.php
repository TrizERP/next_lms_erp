...
class mobileapp_menu_rightsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $Profiles = array('Admin' => 'Admin','Teacher' => 'Teacher','Student' => 'Student');
        $res['status_code'] = "1";
        $res['message'] = "Success";
    ...
    public function create(Request $request)
    {
        ...
        if($profile == 'Student')
        {
            ...
            $mobileapp_menu_data = DB::select("SELECT mh.* 
                                            FROM mobile_homescreen mh
                                            INNER JOIN tbluserprofilemaster up ON up.id = mh.user_profile_id AND up.sub_institute_id = mh.sub_institute_id AND up.name = mh.user_profile_name
                                            WHERE mh.sub_institute_id = '".$sub_institute_id."' AND up.name = '".$profile."' $extra 
    ...
    public function update(Request $request, $id)
    {
        ...
        if($profile == 'Student')
        {
            ...
            if($main_title != $old_main_title)
            {
                ...
                mobile_homescreenModel::where(["main_title" => $old_main_title,"sub_institute_id" => $sub_institute_id])
                ->update($main_data);
            }
            ...
            if($main_title_color_code != $old_main_title_color_code)
            {
                ...
                mobile_homescreenModel::where(["main_title_color_code" => $old_main_title_color_code,"main_title" => $main_title,"sub_institute_id" => $sub_institute_id])
                ->update($main_data);
            }
            ...
            if($main_title_background_image != $old_main_title_background_image)
            {
                ...
                mobile_homescreenModel::where(["main_title_background_image" => $old_main_title_background_image,"main_title" => $main_title,"main_title_color_code" => $main_title_color_code,"sub_institute_id" => $sub_institute_id])
                ->update($main_data);
            }
            ...
            if($main_sort_order != $old_main_sort_order)
            {
                ...
                mobile_homescreenModel::where(["main_sort_order" => $old_main_sort_order,"main_title" => $main_title,"main_title_color_code" => $main_title_color_code,"main_title_background_image" => $main_title_background_image,"sub_institute_id" => $sub_institute_id])
                ->update($main_data);
            }
        ...
        if($profile == 'Admin' || $profile == 'Teacher')
        {
            $get_old_data1 = teacher_mobile_homescreenModel::where(["id" => $id,"sub_institute_id" => $sub_institute_id,'user_profile_name'=>$profile])->get()->toArray();
            ...
            {
                $main_data['main_title'] = $main_title;
                teacher_mobile_homescreenModel::where(["main_title" => $old_main_title1,"sub_institute_id" => $sub_institute_id,'user_profile_name'=>$profile])
                ->update($main_data);
            }
            ...
            {
                $main_data['main_title_color_code'] = $main_title_color_code;
                teacher_mobile_homescreenModel::where(["main_title_color_code" => $old_main_title_color_code1,"main_title" => $main_title,"sub_institute_id" => $sub_institute_id,'user_profile_name'=>$profile])
                ->update($main_data);
            }
            ...
            {
                $main_data['main_title_background_image'] = $main_title_background_image;
                teacher_mobile_homescreenModel::where(["main_title_background_image" => $old_main_title_background_image1,"main_title" => $main_title,"main_title_color_code" => $main_title_color_code,"sub_institute_id" => $sub_institute_id,'user_profile_name'=>$profile])
                ->update($main_data);
            }
            ...
            {
                $main_data['main_sort_order'] = $main_sort_order;
                teacher_mobile_homescreenModel::where(["main_sort_order" => $old_main_sort_order1,"main_title" => $main_title,"main_title_color_code" => $main_title_color_code,"main_title_background_image" => $main_title_background_image,"sub_institute_id" => $sub_institute_id,'user_profile_name'=>$profile])
                ->update($main_data);
            }
            teacher_mobile_homescreenModel::where(["id" => $id,"sub_institute_id" => $sub_institute_id])->update($sub_data);
        }
