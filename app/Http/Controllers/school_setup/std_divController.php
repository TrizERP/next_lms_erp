...
class std_divController extends Controller {
	...
	public function getData(Request $request) {
		...
		$std_data = DB::table('standard')->select('id', 'name')->where(['sub_institute_id' => $sub_institute_id])->get();
		$div_data = DB::table('division')->select('id', 'name')->where(['sub_institute_id' => $sub_institute_id])->get();
		$std_div_map_data = DB::table('std_div_map')->select('standard_id', 'division_id')->where(['sub_institute_id' => $sub_institute_id])->get()->toArray();
		$new_arr = array();
