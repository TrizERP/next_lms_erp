...
class HomeController extends Controller {
	public function getAnalyticsSummary(Request $request) {
		...
		$ch = curl_init();
		curl_setopt($ch, CURLOPT_URL, "https://www.googleapis.com/analytics/v3/data/realtime?ids=ga:206728908&metrics=rt:activeUsers&key=AIzaSyC17j5QD63HR34kVzTyEuyMKgDyF8YaRUY");
