...
class proxyController extends Controller
{
    ...
    public function getproxydata(Request $request)
    {
        ...
        $response = array('data' => '','status' => '0','message' => 'Data Not Found.');
    ...
    public function getproxyperiod(Request $request)
    {
        ...
        ->where(['timetable.sub_institute_id'=>$sub_institute_id,'teacher_id'=>$proxy_teacher_id,'timetable.syear'=>$syear])
        ...
        foreach ($timetable_data as $tkey => $tval) {
            ...
            $daysarr = array('M' => 'Monday','T' => 'Tuesday','W' => 'Wednesday','H' => 'Thursday','F' => 'Friday','S' => 'Saturday');
            foreach ($dates as $key => $val) {
                ...
                'timetable.week_day'=>$tval['week_day'],
                'timetable.syear'=>$syear
                ])
                ->where('timetable.teacher_id', '<>', $proxy_teacher_id)
