...
{        
    ...
    public function getData($request){
        ...
        $data = sub_std_mapModel::select('sub_std_map.*','subject.subject_name','subject.subject_code','standard.name')
    ...
    public function create(Request $request){
         $sub_institute_id = $request->session()->get('sub_institute_id');
         $type = $request->input('type');
         $std_data =  standardModel::where(['sub_institute_id'=>$sub_institute_id])->select('id','name','short_name')->get();
         $sub_data =  subjectModel::where(['sub_institute_id'=>$sub_institute_id])->select('id','subject_name','subject_code')->get();
