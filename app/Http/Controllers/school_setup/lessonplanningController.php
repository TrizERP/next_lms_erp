...
class lessonplanningController extends Controller
{
    ...
    public function getData($request)
    {
        ...
        $data = lessonplanningModel::from("lessonplan as lp")
        ->select('lp.*','s.name as standard_name','d.name as division_name','sub.subject_name',
        'l.lessonplan_reason','l.school_date as lessonplan_date','l.lessonplan_status','l.id as lessonplan_id',
    ...
    {        
        ...
        $wherecondition = array('t.sub_institute_id'=>$sub_institute_id,'t.teacher_id'=>$user_id,'t.syear'=>$syear);
        if($standard_id !="")
        {
            $wherecondition['t.standard_id'] = $standard_id; 
        }
