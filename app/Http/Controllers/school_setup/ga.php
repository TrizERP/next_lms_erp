...
class gapi
{
    ...
    private ?gapiOAuth2 $auth_method = null;
    private array $account_entries = array();
    private array $report_aggregate_metrics = array();
    private array $report_root_parameters = array();
