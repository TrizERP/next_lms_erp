...
class facultywisetimetableController extends Controller
{
    ...
    {                        
        $html = ""; 
        $get_teacher_name = DB::select("SELECT id,CONCAT_WS(' ',first_name,middle_name,last_name) as teacher_name FROM tbluser WHERE id = '".$teacher_id."' AND sub_institute_id = '".$sub_institute_id."' ");  
