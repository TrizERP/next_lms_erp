   ...
   public function index(Request $request)
    {
        ...
        return \App\Helpers\is_mobile($type, "inward_outward/show_place_master", $place_data, "view");
    ...
    public function store(Request $request) {
        ...
        \App\Helpers\ValidateInsertData('place_master',$request);
        ...
        $type = $request->input('type');
        return \App\Helpers\is_mobile($type, "add_place_master.index", $message, "redirect");
    }
    ...
    {    
        ...
        return \App\Helpers\is_mobile($type, "inward_outward/add_place_master", $data, "view");
    }
      
    public function update(Request $request, $id)
    {
       \App\Helpers\ValidateInsertData('place_master', 'update'); 
