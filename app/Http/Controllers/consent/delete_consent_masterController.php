...
class delete_consent_masterController extends Controller
{
	...
	public function create(Request $request) {
		...
		$sql = "SELECT CM.ID AS CHECKBOX,CM.*,s.enrollment_no, CONCAT_WS(' ',s.first_name,s.middle_name,s.last_name) AS FULL_NAME,
		s.mobile AS SMS_NO, SG.title AS GRADE_ID, CONCAT_WS('/',CS.name,SS.name) AS STANDARD, 
