...
class hostel_building_masterController extends Controller
{
    public function index(Request $request)
    {
        ...
        $building = DB::table('hostel_building_master')
            ...
            ->select('hostel_building_master.*', 'hostel_type_master.hostel_type as hostel_type_id', 'hostel_master.name as hostel_name')
        ...
        return \App\Helpers\is_mobile($type, "hostel_management/show_hostel_building", $building_data, "view");
    ...
    public function create(Request $request) {
        ...
        // $hostels = hostel_masterModel::where(['sub_institute_id'=>$sub_institute_id])->get()->toArray();
    ...
    public function store(Request $request) {
        ...
        $type = $request->input('type');
        return \App\Helpers\is_mobile($type, "add_hostel_building_master.index", $message, "redirect");
    ...
    {
      // \App\Helpers\ValidateInsertData('hostel_building_master', 'update'); 
