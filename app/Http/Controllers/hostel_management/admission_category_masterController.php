...
class admission_category_masterController extends Controller
{
    public function index(Request $request)
    {
        ...
        return \App\Helpers\is_mobile($type, "hostel_management/show_admission_category", $admission_data, "view");
    ...
    public function getData() {
        $admission_data = admission_category_masterModel::orderBy('id')->get();
        return $admission_data;
    }
    
    public function store(Request $request) {

        \App\Helpers\ValidateInsertData('admission_category_master',$request);
        ...
        $type = $request->input('type');
        return \App\Helpers\is_mobile($type, "add_admission_category_master.index", $message, "redirect");
    ...
    {  
        ...
        return \App\Helpers\is_mobile($type, "hostel_management/add_admission_category_master", $data, "view");
    }
      
    public function update(Request $request, $id)
    {
       \App\Helpers\ValidateInsertData('admission_category_master', 'update'); 
