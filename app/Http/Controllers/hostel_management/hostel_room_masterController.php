...
class hostel_room_masterController extends Controller
{
     public function index(Request $request)
    {
        ...
        return \App\Helpers\is_mobile($type, "hostel_management/show_hostel_room", $room_data, "view");
...
//        \App\Helpers\ValidateInsertData('hostel_building_master',$request);
//        echo '<pre>';
//        print_r($sub_institute_id);
//        die;
        ...
        $type = $request->input('type');
        return \App\Helpers\is_mobile($type, "add_hostel_room_master.index", $message, "redirect");
    ...
    public function hostelWiseRoomList(Request $request)
    {
        ...
        $data = hostel_room_masterModel::select("hostel_room_master.id as id","hostel_room_master.room_name as room_name")
