...
class room_type_masterController extends Controller
{
    public function index(Request $request)
    {
        ...
        return \App\Helpers\is_mobile($type, "hostel_management/show_room_type", $room_data, "view");
    ...
    public function getData() {
        $room_data = room_type_masterModel::orderBy('id')->get();
        return $room_data;
    }
    
    public function store(Request $request) {

        \App\Helpers\ValidateInsertData('room_type_master',$request);
        ...
        $type = $request->input('type');
        return \App\Helpers\is_mobile($type, "add_room_type_master.index", $message, "redirect");
    ...
    {  
        ...
        return \App\Helpers\is_mobile($type, "hostel_management/add_room_type_master", $data, "view");
    }
      
    public function update(Request $request, $id)
    {
       \App\Helpers\ValidateInsertData('room_type_master', 'update'); 
