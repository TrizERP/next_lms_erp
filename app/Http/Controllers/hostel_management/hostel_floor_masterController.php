...
class hostel_floor_masterController extends Controller
{
    public function index(Request $request)
    {
        ...
        return \App\Helpers\is_mobile($type, "hostel_management/show_hostel_floor", $floor_data, "view");
...
//        die;
        ...
        $type = $request->input('type');
        return \App\Helpers\is_mobile($type, "add_hostel_floor_master.index", $message, "redirect");
