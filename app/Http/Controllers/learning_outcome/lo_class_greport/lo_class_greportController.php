...
namespace App\Http\Controllers\learning_outcome\lo_class_greport;

// namespace  App\Http\Controllers\learning_outcome\lo_class_greport\lo_class_greport_controller;
...
class lo_class_greportController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if (isset($request['id'])) {
            ...
            foreach ($sub_dd as $keys => $subject) {
                ...
                // }
                // $all_data[$subject][$value->INDICATOR]['PER'] = number_format($all_data[$subject][$value->INDICATOR]['PER'],2);
                ...
                // echo count($all_final_data[$subject]['GREEN']['lo'])."<br>";
                    // echo $totla_lo."<br>";
                    // echo $all_final_data[$subject]['GREEN']['per']."<br>";
                    // exit;
                } else {
            ...
            return \App\Helpers\is_mobile($type, 'learning_outcome/lo_class_greport/FinalShow', $school_data, 'view');
        } else {
            $school_data['data'] = $this->get_all_dd();
            $type = $request->input('type');
            return \App\Helpers\is_mobile($type, 'learning_outcome/lo_class_greport/show', $school_data, 'view');
        }
    }
    ...
    public function create(Request $request)
    {
        ...
        // return \App\Helpers\is_mobile($type, 'learning_outcome/lo_class_greport/add', $dataStore, 'view');
    }
    ...
    public function store(Request $request)
    {
        ...
        return \App\Helpers\is_mobile($type, 'lo_class_greport.index', $res, 'redirect');
    ...
    public function edit(Request $request, $id)
    {
        ...
        // $allData = lo_class_greport::find($id)->toArray();
        // echo('<pre>');
        // print_r($allData);
        // exit;
        ...
        return \App\Helpers\is_mobile($type, "learning_outcome/lo_class_greport/edit", $data, "view");
    }
