...
// namespace  App\Http\Controllers\learning_outcome\lo_marks_report\lo_marks_report_controller;
...
class lo_marks_reportController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return \App\Helpers\is_mobile($type, 'learning_outcome/lo_marks_report/show', $school_data, 'view');
    }
    ...
    public function create(Request $request)
    {
        ...
        return \App\Helpers\is_mobile($type, 'learning_outcome/lo_marks_report/add', $dataStore, 'view');
    }
    ...
    public function store(Request $request)
    {
        ...
        return \App\Helpers\is_mobile($type, 'lo_marks_report.index', $res, 'redirect');
    ...
    public function edit(Request $request, $id)
    {
        ...
        // $allData = lo_marks_report::find($id)->toArray();
        // echo('<pre>');
        // print_r($allData);
        // exit;
        ...
        return \App\Helpers\is_mobile($type, "learning_outcome/lo_marks_report/edit", $data, "view");
    }
