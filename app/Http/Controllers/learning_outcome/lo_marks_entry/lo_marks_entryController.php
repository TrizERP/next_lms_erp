...
class lo_marks_entryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return is_mobile($type, 'learning_outcome/lo_marks_entry/show', $school_data, 'view');
    }
    ...
    public function create(Request $request)
    {
        ...
        return is_mobile($type, 'learning_outcome/lo_marks_entry/add', $dataStore, 'view');
    }
    ...
    public function store(Request $request)
    {
        ...
        return is_mobile($type, 'lo_marks_entry.index', $res, 'redirect');
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return is_mobile($type, "learning_outcome/lo_marks_entry/edit", $data, "view");
    }
