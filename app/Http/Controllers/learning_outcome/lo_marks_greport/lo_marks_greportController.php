...
// namespace  App\Http\Controllers\learning_outcome\lo_marks_greport\lo_marks_greport_controller;
...
class lo_marks_greportController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if (isset($request['id'])) {
            ...
            // echo ('<pre>');print_r($all_subject_lo);exit;
            ...
            return \App\Helpers\is_mobile($type, 'learning_outcome/lo_marks_greport/FinalShow', $school_data, 'view');
        } else {
            $school_data['data'] = $this->get_all_dd();
            $type = $request->input('type');
            return \App\Helpers\is_mobile($type, 'learning_outcome/lo_marks_greport/show', $school_data, 'view');
        }
    }
    ...
    public function create(Request $request)
    {
        ...
        return \App\Helpers\is_mobile($type, 'learning_outcome/lo_marks_greport/add', $dataStore, 'view');
    }
    ...
    public function store(Request $request)
    {
        ...
        return \App\Helpers\is_mobile($type, 'lo_marks_greport.index', $res, 'redirect');
    ...
    public function edit(Request $request, $id)
    {
        ...
        // $allData = lo_marks_greport::find($id)->toArray();
        // echo('<pre>');
        // print_r($allData);
        // exit;
        ...
        return \App\Helpers\is_mobile($type, "learning_outcome/lo_marks_greport/edit", $data, "view");
    }
