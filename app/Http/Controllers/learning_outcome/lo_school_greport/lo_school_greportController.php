...
class lo_school_greportController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if (isset($request['id'])) {
            ...
            return is_mobile($type, 'learning_outcome/lo_school_greport/FinalShow', $school_data, 'view');
        } else {
            $school_data['data'] = $this->get_all_dd();
            $type = $request->input('type');

            return is_mobile($type, 'learning_outcome/lo_school_greport/show', $school_data, 'view');
        }
    }
    ...
    public function store(Request $request)
    {
        ...
        return is_mobile($type, 'lo_school_greport.index', $res, 'redirect');
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return is_mobile($type, "learning_outcome/lo_school_greport/edit", $data, "view");
    }
