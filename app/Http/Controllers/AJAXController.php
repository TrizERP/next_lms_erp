...
class AJAXController extends Controller
{
    ...
    public function ajaxQuestionListsFunction(Request $request)
    {
        // return $request;    
        $questionType = [];
        ...
        try {
            ...
            */
            ...
            $request->validate([
                ...
                'even_file' => 'required|string',
                'event_param' => 'required|array'
            ]);
            ...
            */
            ...
            $eventFile  = $request->even_file;
            $eventParam = $request->event_param[0] ?? [];
            ...
            */
            ...
            $eventClasses = [
                ...
                'assessment_submitted' => \App\Events\AssessmentSubmitted::class,
                'lesson_completed'     => \App\Events\LessonCompleted::class,
                'xapi_statement'       => \App\Events\XapiStatementReceived::class,
                'career_signal'        => \App\Events\CareerSignalCaptured::class,
                'teacher_override'     => \App\Events\TeacherOverrideRecorded::class,
                'mastery_changed'      => \App\Events\MasteryLevelChanged::class,
            ...
            */
            ...
            if (!isset($eventClasses[$eventName])) {
                ...
                return response()->json([
                    ...
                    'available_events' => array_keys($eventClasses)
                ], 400);
            }
            ...
            */
            ...
            $expectedFile = class_basename($eventClasses[$eventName]);

            if ($eventFile !== $expectedFile) {

                return response()->json([
                    'status' => false,
                    'message' => 'Event file mismatch',
            ...
            */
            ...
            $eventClass = $eventClasses[$eventName];
            ...
            /*
            |--------------------------------------------------------------------------
            | Match Constructor Parameters Dynamically
            |--------------------------------------------------------------------------
            */
            ...
            foreach ($constructor->getParameters() as $param) {
                ...
                */
                ...
                if (array_key_exists($paramName, $eventParam)) {

                    $parameters[] = $eventParam[$paramName];
                }
            ...
            */
            ...
            return response()->json([
                ...
                'event' => [
                    ...
                    'event_class' => $eventFile,
                ],

                'input' => $eventParam,

                'output' => get_object_vars($event)
