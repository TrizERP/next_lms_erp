                        ...
                        <div class="col-12">
                            <div class="white-box">
                                <div class="card-body wizard-content">
                                    <form id="wkform" name="wkform" class="tab-wizard wizard-circle"
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="wkname" id="wkname" disabled
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" name="wkdescription"
                                                                  disabled>{{$data['wk_main']->description}}</textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                <div class="form-group">
													...
													<div class="m-b-10">
                                                        ...
                                                        <div class="radio radio-info">
                                                            ...
                                                            <label for="rd-2"> Until the first time the condition is
                                                                true </label>
                                                        </div>
                                                        <!--div class="radio radio-info">
                                                        ...
                                                        <div class="radio radio-info">
                                                            <input type="radio" name="wkexecute" id="rd-2" value="5"
                                                                   class="execute_radio"
                                                                   @if(isset($data['wk_main']->execute_id) && $data['wk_main']->execute_id == "5") checked @endif disabled>
															...
															<div class="form-group">
                                                                ...
                                                                <div id="at_time_div">
                                                                    ...
                                                                    <select name="at_time" id="at_time" disabled>
                                                                        <option value="">Select</option>
                                                                        <option
                                                                            @if(isset($data['wk_main']->at_times) && $data['wk_main']->at_times == 00.00) selected @endif  value="00.00">00.00</option>
																		...
																		<option @if(isset($data['wk_main']->at_times) && $data['wk_main']->at_times == 7.30) selected @endif value="7.30">
                                                                            7.30
                                                                        </option>
                                                                    </select>
                                                                </div>
                                        ...
                                        <section>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div id="mail_data"
                                                         class="col-lg-12 col-sm-12 col-xs-12">                {!! $data['wk_task'] !!}
                                                    </div>
