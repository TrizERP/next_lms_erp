	...
	{        
        ...
        $sql = "
            ...
            FROM (
                ...
                INNER JOIN tblstudent_payment_method_mapping spm ON spm.student_id = se.student_id AND spm.sub_institute_id = '".$sub_institute_id."' AND f.syear = '".$syear."' AND f.month_id=spm.month_id
                LEFT JOIN fees_collect fc ON fc.student_id = s.id AND fc.term_id = f.month_id AND fc.IS_DELETED = 'N'
