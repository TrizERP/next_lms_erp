...
//        $school_data['data'] = array();
		...
		return \App\Helpers\is_mobile($type, "fees/map_year/show", $school_data, "view");
	}
...
//        $dataStore = array();
		...
		return \App\Helpers\is_mobile($type, 'fees/map_year/add', $dataStore, "view");
	}
...
//        echo "<pre>";
		...
		$type = $request->input('type');
		return \App\Helpers\is_mobile($type, "map_year.index", $res, "redirect");
	}
	...
	public function edit(Request $request, $id) {
		...
		return \App\Helpers\is_mobile($type, "fees/map_year/edit", $data, "view");
	}
