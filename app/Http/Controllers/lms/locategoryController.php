...
class locategoryController extends Controller
{
    ...
    {          
        ...
        $locategoryData = locategoryModel::where(['sub_institute_id' => $sub_institute_id,'chapter_id' => $chapter_id])        
        ->get()->toArray();
        
        return $locategoryData;    
    }
    ...
    {          
        ...
        $locategoryData = locategoryModel::where(
            [
                'sub_institute_id' => $sub_institute_id,
                'subject_id' => $sub_id,
                'standard_id' => $std_id,
