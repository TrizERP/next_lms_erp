...
class topicController extends Controller
{
    ...
    public function getBreadcrum($sub_institute_id,$chapter_id)
    {
        ...
        $breadcrum_data = DB::select("SELECT c.subject_id,s.display_name AS subject_name,c.standard_id,st.name AS standard_name,c.id AS chapter_id,c.chapter_name
        ...
        WHERE ".$where_institute_id." AND c.id = '".$chapter_id."'");
    ...
    public function store(Request $request){
        ...
        {
            $show_hide_val = isset($topic_show_hide[$key]) ? $topic_show_hide[$key] : '';
            $sort_order_val= isset($topic_sort_order[$key]) ? $topic_sort_order[$key] : '';
            $topic_desc_val = isset($topic_desc[$key]) ? $topic_desc[$key] : '';
