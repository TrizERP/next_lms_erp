...
class assignmentSubmissionController extends Controller {
	...
	public function store(Request $request) {
		...
		{			
            ...
            lms_assignmentModel::where(["id" => $student_id, 'syear' => $syear, 'sub_institute_id' => $sub_institute_id,'id' => $assignment_id])
	...
	public function show(Request $request,$id) {
		...
		$data['questionpaper_data'] = lmsOfflineExamModel::select('*','sub_std_map.display_name as subject_name','lms_offline_exam.id as offline_exam_id')             
        ...
        ->where(['lms_offline_exam.assignment_id'=>$id,'lms_offline_exam.student_id'=>$student_id,
