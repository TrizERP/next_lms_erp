...
class lmsPortfolioController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        else if(strtoupper(session()->get('user_profile_name')) == "LMS TEACHER" || strtoupper(session()->get('user_profile_name')) == "TEACHER")
        {
    ...
    public function getData($request){
        ...
        if(strtoupper(session()->get('user_profile_name')) == "STUDENT")
        {
            ...
            ->where(['lms_portfolio.sub_institute_id'=>$sub_institute_id,'lms_portfolio.user_id'=>$user_id,
    ...
    public function show(Request $request,$id)
    {
        ...
        $data['portfolio_data'] = portfolioModel::select('*',db::raw('date_format(created_at,"%d-%m-%Y") as created_at'))
        ->where(['sub_institute_id'=>$sub_institute_id,'user_id'=>$user_id,'user_profile_id'=>$user_profile_id])                      
        ->take(10)
        ->get()->toArray();
    ...
    public function ajax_LMS_ChapterwiseTopic(Request $request)
    {
        ...
        $data = topicModel::whereIn("topic_master.chapter_id",$chapter_ids)
