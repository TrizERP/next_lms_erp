...
class CustomModuleController extends Controller
{
    ...
    public function tableStore(Request $request)
    {
        ...
        $customModuleTable->table_name = str_replace(' ','_',$request->table_name);
    ...
    public function tableDelete(Request $request, $id)
    {
        ...
        if ($id > 0) {
            ...
            if (!empty($table)) {
                DB::statement('DROP TABLE IF EXISTS Z_'. $table->table_name);
            }
    ...
    public function tableColumnCreate(Request $request, $id, $colId = 0)
    {
        ...
        if ($colId) {
            ...
            $data['column_name'] = str_replace(' ','_',$findColumnData['column_name']);
    ...
    public function tableColumnStore(Request $request, $id)
    {
        ...
        $tableColumn->column_name = str_replace(' ','_',$request->column_name);
    ...
    // ";
    // end of darshan code 
    // added by uma 17-08-2024
    $sql = "
    CREATE TABLE Z_{$tableName} (
        {$columns},
        sub_institute_id INT NOT NULL DEFAULT 0,
        created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
