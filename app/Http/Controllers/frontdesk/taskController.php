...
class taskController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $data = "SELECT t.*, CONCAT_WS(' ',u.first_name,u.middle_name,u.last_name) AS ALLOCATOR, 
        ...
        LEFT JOIN tbluser u3 ON t.approved_by = u3.id AND u3.sub_institute_id = '".$sub_institute_id."'
        WHERE t.SYEAR = '".$syear."'";
