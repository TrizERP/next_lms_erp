...
{
    /**
     * cycleNodes() / depths() / walk() / walkWithDepth() and DEPTH_CAP now live in
     * this trait, unchanged. CurriculumGraphBuilder answers the same questions over
     * the same edges read straight from MariaDB, and two copies of a cycle-safe walk
     * are two chances to disagree about which concept comes first.
     */
