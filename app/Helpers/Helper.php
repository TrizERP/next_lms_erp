...
$sub_institute_id = session()->get('sub_institute_id');
       ...
       $lms_condition = getLmsCondition($sub_institute_id, 'academic_section');
        ...
        $grade = '<div class="col-md-' . $col . ' searchSectionDiv">
        ...
        $std = '<div class="col-md-' . $col . ' searchStandardDiv" >
                    <div class="form-group ">
        ...
        $div = ' <div class="col-md-' . $col . ' searchDivisionDiv">
                    <div class="form-group ">
...
if (!function_exists('ClassTeacherSearch')) {
    ...
    function ClassTeacherSearch($stdiv = null)
    {
        ...
        if (!empty($getUserData) && isset($getUserData->allocated_standards) && $getUserData->allocated_standards != '') {
            ...
            $result = DB::table('std_div_map as sdm')
                ...
                ->where('sdm.sub_institute_id', session()->get('sub_institute_id'))
                ->whereIn('sdm.standard_id', $subjectTeacherStdArr)
...
*/            
            ->selectRaw("tc.*,s.*,se.syear,se.student_id,se.grade_id,se.standard_id,se.section_id,se.student_quota,se.roll_no,
                ...
                se.grade_id,d.name as division_name,s.father_name,s.mother_name,ss.SchoolName as school_name,ss.Mobile as school_mobile,s.admission_standard,
