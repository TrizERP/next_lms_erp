...
class SyncONetOccupationDetailWorkActivitySummary extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'sync:o-net-occupation-detail-work-activity-summary';
    ...
    public function handle()
    {
        ...
        foreach ($categories as $key => $category) {
            $occupationDetailLists = ONetOccupationDetailList::where([['resource_title', 'Work Activities'], ['o_net_data_category_id', $key + 1]])->get();
