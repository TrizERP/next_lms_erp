...
class SyncONetOccupationDetailKnowledgeSummary extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'sync:o-net-occupation-detail-knowledge-summary';
    ...
    public function handle()
    {
        ...
        foreach ($categories as $key => $category) {
            $occupationDetailLists = ONetOccupationDetailList::where([['resource_title', 'Knowledge'], ['o_net_data_category_id', $key +1]])->get();
