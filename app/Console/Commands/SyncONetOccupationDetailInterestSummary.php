...
class SyncONetOccupationDetailInterestSummary extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'sync:o-net-occupation-detail-interests-summary';
    ...
    public function handle()
    {
        ...
        foreach ($categories as $key => $category) {
            $occupationDetailLists = ONetOccupationDetailList::where([['resource_title', 'Interests'], ['o_net_data_category_id', $key + 1]])->get();
